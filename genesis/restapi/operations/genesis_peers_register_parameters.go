...
// GenesisPeersRegisterParams contains all the bound params for the genesis peers register operation
...
func (o *GenesisPeersRegisterParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
