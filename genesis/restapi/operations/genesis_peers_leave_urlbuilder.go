...
func (o *GenesisPeersLeaveURL) Build() (*url.URL, error) {
	...
	if peerID != "" {
		...
		return nil, errors.New("PeerID is required on GenesisPeersLeaveURL")
	}
...
func (o *GenesisPeersLeaveURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GenesisPeersLeaveURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GenesisPeersLeaveURL")
	}
