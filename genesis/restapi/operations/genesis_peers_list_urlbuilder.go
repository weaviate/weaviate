...
func (o *GenesisPeersListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GenesisPeersListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GenesisPeersListURL")
	}
