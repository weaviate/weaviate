...
func (o *GenesisPeersRegisterURL) WithBasePath(bp string) *GenesisPeersRegisterURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GenesisPeersRegisterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GenesisPeersRegisterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GenesisPeersRegisterURL")
	}
