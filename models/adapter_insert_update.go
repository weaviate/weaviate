...
// AdapterInsertUpdate adapter insert update
// swagger:model AdapterInsertUpdate
type AdapterInsertUpdate struct {
...
// Validate validates this adapter insert update
func (m *AdapterInsertUpdate) Validate(formats strfmt.Registry) error {
	var res []error
