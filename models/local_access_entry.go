...
const (
	// LocalAccessEntryLocalAccessRoleManager captures enum value "manager"
	LocalAccessEntryLocalAccessRoleManager string = "manager"
	// LocalAccessEntryLocalAccessRoleOwner captures enum value "owner"
	LocalAccessEntryLocalAccessRoleOwner string = "owner"
	// LocalAccessEntryLocalAccessRoleRobot captures enum value "robot"
	LocalAccessEntryLocalAccessRoleRobot string = "robot"
	// LocalAccessEntryLocalAccessRoleUser captures enum value "user"
	LocalAccessEntryLocalAccessRoleUser string = "user"
	// LocalAccessEntryLocalAccessRoleViewer captures enum value "viewer"
