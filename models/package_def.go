...
const (
	// PackageDefAnonMinimalRoleManager captures enum value "manager"
	PackageDefAnonMinimalRoleManager string = "manager"
	// PackageDefAnonMinimalRoleOwner captures enum value "owner"
	PackageDefAnonMinimalRoleOwner string = "owner"
	// PackageDefAnonMinimalRoleUser captures enum value "user"
	PackageDefAnonMinimalRoleUser string = "user"
	// PackageDefAnonMinimalRoleViewer captures enum value "viewer"
