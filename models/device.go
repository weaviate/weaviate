...
type Device struct {
	...
	// Hierarchical component-based modeling of the device.
	...
	// Room that the device is in, if any.
	Room *Room `json:"room,omitempty"`

	// Serial number of a device provided by its manufacturer.
	SerialNumber string `json:"serialNumber,omitempty"`

	// Deprecated, use "components" instead. Device state. This field is writable only by devices.
