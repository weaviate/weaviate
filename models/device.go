...
type Device struct {
	...
	// places hints
	PlacesHints *PlacesHints `json:"placesHints,omitempty"`
...
func (m *Device) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePlacesHints(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *Device) validatePlacesHints(formats strfmt.Registry) error {

	if swag.IsZero(m.PlacesHints) { // not required
		return nil
	}

	if m.PlacesHints != nil {

		if err := m.PlacesHints.Validate(formats); err != nil {
			return err
		}
	}
