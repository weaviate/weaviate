...
class BadValidationResponse(object):
    ...
    def __init__(self, error=None):  # noqa: E501
        """BadValidationResponse - a model defined in Swagger"""  # noqa: E501
        self._error = None
    ...
    @property
    def error(self):
        """Gets the error of this BadValidationResponse.  # noqa: E501


        :return: The error of this BadValidationResponse.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this BadValidationResponse.


        :param error: The error of this BadValidationResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BadValidationResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BadValidationResponse):
            return False
