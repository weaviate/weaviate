...
class AllocateResponse(object):
    ...
    def __init__(self, allocation_id=None):  # noqa: E501
        """AllocateResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def allocation_id(self):
        """Gets the allocation_id of this AllocateResponse.  # noqa: E501

        The UID representing an allocation of a specific number of APU boards.  # noqa: E501

        :return: The allocation_id of this AllocateResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def allocation_id(self, allocation_id):
        """Sets the allocation_id of this AllocateResponse.

        The UID representing an allocation of a specific number of APU boards.  # noqa: E501

        :param allocation_id: The allocation_id of this AllocateResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllocateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllocateResponse):
            return False
