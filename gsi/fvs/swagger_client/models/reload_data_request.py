...
class ReloadDataRequest(object):
    ...
    def __init__(self, allocation_id=None, dataset_id=None, neural_matrix_id=None):  # noqa: E501
        """ReloadDataRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def allocation_id(self):
        """Gets the allocation_id of this ReloadDataRequest.  # noqa: E501
        ...
        :return: The allocation_id of this ReloadDataRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def allocation_id(self, allocation_id):
        """Sets the allocation_id of this ReloadDataRequest.

        The UID representing an allocation of a specific number of APU boards. It is generated using the /allocate endpoint.  # noqa: E501

        :param allocation_id: The allocation_id of this ReloadDataRequest.  # noqa: E501
        :type: str
        """
    ...
    def dataset_id(self, dataset_id):
        """Sets the dataset_id of this ReloadDataRequest.

        The datasetId identifies the specific dataset to search. It is generated using the /import/dataset endpoint.  # noqa: E501

        :param dataset_id: The dataset_id of this ReloadDataRequest.  # noqa: E501
        :type: str
        """
    ...
    def neural_matrix_id(self):
        """Gets the neural_matrix_id of this ReloadDataRequest.  # noqa: E501
        ...
        :return: The neural_matrix_id of this ReloadDataRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def neural_matrix_id(self, neural_matrix_id):
        """Sets the neural_matrix_id of this ReloadDataRequest.

        Neural matrix UID. It is generated using the /import/dataset or /import/neuralMatrix endpoints (using default active neural matrix UID if null passed).  # noqa: E501

        :param neural_matrix_id: The neural_matrix_id of this ReloadDataRequest.  # noqa: E501
        :type: str
        """
        if neural_matrix_id is None:
            raise ValueError("Invalid value for `neural_matrix_id`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReloadDataRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReloadDataRequest):
            return False
