...
class SetNeuralMatrixActiveResponse(object):
    ...
    def __init__(self, dataset=None):  # noqa: E501
        """SetNeuralMatrixActiveResponse - a model defined in Swagger"""  # noqa: E501
        self._dataset = None
    ...
    @property
    def dataset(self):
        """Gets the dataset of this SetNeuralMatrixActiveResponse.  # noqa: E501


        :return: The dataset of this SetNeuralMatrixActiveResponse.  # noqa: E501
        :rtype: object
        """
    ...
    def dataset(self, dataset):
        """Sets the dataset of this SetNeuralMatrixActiveResponse.


        :param dataset: The dataset of this SetNeuralMatrixActiveResponse.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SetNeuralMatrixActiveResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetNeuralMatrixActiveResponse):
            return False
