...
class GetFocusedDatasetResponse(object):
    ...
    def __init__(self, dataset_id=None, neural_matrix_id=None):  # noqa: E501
        """GetFocusedDatasetResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def dataset_id(self):
        """Gets the dataset_id of this GetFocusedDatasetResponse.  # noqa: E501

        The datasetId identifies the specific dataset to search. It is generated using the /import/dataset endpoint..  # noqa: E501

        :return: The dataset_id of this GetFocusedDatasetResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def dataset_id(self, dataset_id):
        """Sets the dataset_id of this GetFocusedDatasetResponse.

        The datasetId identifies the specific dataset to search. It is generated using the /import/dataset endpoint..  # noqa: E501

        :param dataset_id: The dataset_id of this GetFocusedDatasetResponse.  # noqa: E501
        :type: str
        """
    ...
    def neural_matrix_id(self):
        """Gets the neural_matrix_id of this GetFocusedDatasetResponse.  # noqa: E501
        ...
        :return: The neural_matrix_id of this GetFocusedDatasetResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def neural_matrix_id(self, neural_matrix_id):
        """Sets the neural_matrix_id of this GetFocusedDatasetResponse.

        Neural matrix UID. It is generated using the /import/dataset or /import/neuralMatrix endpoints (using default active neural matrix UID if null passed)..  # noqa: E501

        :param neural_matrix_id: The neural_matrix_id of this GetFocusedDatasetResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetFocusedDatasetResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetFocusedDatasetResponse):
            return False
