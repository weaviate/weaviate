...
class ImportNeuralMatrixResponse(object):
    ...
    def __init__(self, neural_matrix_id=None):  # noqa: E501
        """ImportNeuralMatrixResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def neural_matrix_id(self):
        """Gets the neural_matrix_id of this ImportNeuralMatrixResponse.  # noqa: E501
        ...
        :return: The neural_matrix_id of this ImportNeuralMatrixResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def neural_matrix_id(self, neural_matrix_id):
        """Sets the neural_matrix_id of this ImportNeuralMatrixResponse.

        Neural matrix UID. It is generated using the /import/dataset or /import/neuralMatrix endpoints (using default active neural matrix UID if null passed).  # noqa: E501

        :param neural_matrix_id: The neural_matrix_id of this ImportNeuralMatrixResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ImportNeuralMatrixResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportNeuralMatrixResponse):
            return False
