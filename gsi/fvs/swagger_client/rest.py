        ...
        try:
            ...
            if method in ['POST', 'PUT', 'PATCH', 'OPTIONS', 'DELETE']:
                ...
                if re.search('json', headers['Content-Type'], re.IGNORECASE):
                    ...
                    print("JSON", "method=",method, "url=",url, "request_body=",request_body, "preload",_preload_content, "headers",headers )
                    ...
                    print("x-www-form","method=",method, "url=",url, "request_body=",request_body, "preload",_preload_content, "headers",headers )
                    r = self.pool_manager.request(
                        method, url,
                        fields=post_params,
                    ...
                    print("multipart","method=",method, "url=",url, "request_body=",request_body, "preload",_preload_content, "headers",headers )
                    r = self.pool_manager.request(
                        method, url,
                        fields=post_params,
                ...
                # provided in serialized form
                    ...
                    request_body = body
                    print("body_str", "method=",method, "url=",url, "request_body=",request_body, "preload",_preload_content, "headers",headers )
                    r = self.pool_manager.request(
                        method, url,
                        body=request_body,
                        preload_content=_preload_content,
