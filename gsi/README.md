...
* *GEMINI_DATA_DIRECTORY* -This directory must exist and live under "/home/public" (it's currently an FVS requirement.)  This directory is critical for data transfer betweeen Gemini Plugin and the FVS.
