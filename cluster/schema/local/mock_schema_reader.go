...
func (_m *MockSchemaReader) ClassInfo(class string) ClassInfo {
	ret := _m.Called(class)
	...
	var r0 ClassInfo
	if rf, ok := ret.Get(0).(func(string) ClassInfo); ok {
		r0 = rf(class)
	} else {
		r0 = ret.Get(0).(ClassInfo)
	}
...
func (_c *MockSchemaReader_ClassInfo_Call) Return(_a0 ClassInfo) *MockSchemaReader_ClassInfo_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSchemaReader_ClassInfo_Call) RunAndReturn(run func(string) ClassInfo) *MockSchemaReader_ClassInfo_Call {
	_c.Call.Return(run)
	return _c
}

// ClassInfoWithVersion provides a mock function with given fields: ctx, class, version
func (_m *MockSchemaReader) ClassInfoWithVersion(ctx context.Context, class string, version uint64) (ClassInfo, error) {
	...
	var r0 ClassInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, uint64) (ClassInfo, error)); ok {
		return rf(ctx, class, version)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, uint64) ClassInfo); ok {
...
func (_c *MockSchemaReader_ClassInfoWithVersion_Call) Return(_a0 ClassInfo, _a1 error) *MockSchemaReader_ClassInfoWithVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSchemaReader_ClassInfoWithVersion_Call) RunAndReturn(run func(context.Context, string, uint64) (ClassInfo, error)) *MockSchemaReader_ClassInfoWithVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSchemaReader) ShardOwnerWithVersion(ctx context.Context, class string, shard string, version uint64) (string, error) {
...
//   - shard string
//   - version uint64
func (_e *MockSchemaReader_Expecter) ShardOwnerWithVersion(ctx interface{}, class interface{}, shard interface{}, version interface{}) *MockSchemaReader_ShardOwnerWithVersion_Call {
	return &MockSchemaReader_ShardOwnerWithVersion_Call{Call: _e.mock.On("ShardOwnerWithVersion", ctx, class, shard, version)}
}

func (_c *MockSchemaReader_ShardOwnerWithVersion_Call) Run(run func(ctx context.Context, class string, shard string, version uint64)) *MockSchemaReader_ShardOwnerWithVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
