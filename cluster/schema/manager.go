...
func NewSchemaManager(nodeId string, db Indexer, parser Parser, querierManager *querier.QuerierManager, log *logrus.Logger) *SchemaManager {
	return &SchemaManager{
		schema: NewSchema(nodeId, db, querierManager),
		db:     db,
		parser: parser,
		log:    log,
	}
