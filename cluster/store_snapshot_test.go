...
// 	// authzRBAC := authzmocks.NewController(t)
// 	// authzRBAC.On("Snapshot").Return(nil, nil)
// 	// source.store.cfg.AuthzController = authzRBAC
...
// 	// target.store.cfg.AuthzController = authzRBAC
// 	target.store.init()
// 	// authzRBAC.On("Restore", mock.Anything).Return(nil)
...
// 	snapshotter := clustermocks.NewSnapshotter(t)
