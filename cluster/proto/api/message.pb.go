...
const file_api_message_proto_rawDesc = "" +
	...
	"\x1fTYPE_REPLICATION_REPLICA_DELETE\x10\xd3\x01\x12-\n" +
	"(TYPE_REPLICATION_REGISTER_SCHEMA_VERSION\x10\xd4\x01\x12\x1e\n" +
	...
	"\x06leader\x18\x02 \x01(\tR\x06leader\"\x94\a\n" +
	"\fQueryRequest\x12@\n" +
	...
	"$TYPE_GET_REPLICATION_OPERATION_STATE\x10\xcf\x01\x12\x1f\n" +
