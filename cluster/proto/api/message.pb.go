...
const (
	...
	ApplyRequest_TYPE_DISTRIBUTED_TASK_CANCELLED         ApplyRequest_Type = 301
	ApplyRequest_TYPE_DISTRIBUTED_TASK_NODE_FINISHED     ApplyRequest_Type = 302
)
...
var (
	ApplyRequest_Type_name = map[int32]string{
		...
		301: "TYPE_DISTRIBUTED_TASK_CANCELLED",
		302: "TYPE_DISTRIBUTED_TASK_NODE_FINISHED",
	}
	ApplyRequest_Type_value = map[string]int32{
		...
		"TYPE_DISTRIBUTED_TASK_CANCELLED":         301,
		"TYPE_DISTRIBUTED_TASK_NODE_FINISHED":     302,
	}
)
...
type AddDistributedTaskRequest struct {
	...
	TaskPayload           []byte                 `protobuf:"bytes,3,opt,name=task_payload,json=taskPayload,proto3" json:"task_payload,omitempty"`
	SubmittedAtUnixMillis int64                  `protobuf:"varint,4,opt,name=submittedAtUnixMillis,proto3" json:"submittedAtUnixMillis,omitempty"` // TODO: consider using native time type
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *AddDistributedTaskRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *AddDistributedTaskRequest) GetTaskType() string {
	if x != nil {
		return x.TaskType
	}
	return ""
...
func (x *AddDistributedTaskRequest) GetTaskPayload() []byte {
	if x != nil {
...
type DistributedTaskFinishedByTheNodeRequest struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	TaskId               string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	TaskType             string                 `protobuf:"bytes,2,opt,name=task_type,json=taskType,proto3" json:"task_type,omitempty"`
	NodeId               string                 `protobuf:"bytes,3,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	FinishedAtUnixMillis int64                  `protobuf:"varint,4,opt,name=finishedAtUnixMillis,proto3" json:"finishedAtUnixMillis,omitempty"` // TODO: consider using native time type
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}

func (x *DistributedTaskFinishedByTheNodeRequest) Reset() {
	*x = DistributedTaskFinishedByTheNodeRequest{}
	mi := &file_api_message_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DistributedTaskFinishedByTheNodeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DistributedTaskFinishedByTheNodeRequest) ProtoMessage() {}

func (x *DistributedTaskFinishedByTheNodeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_message_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DistributedTaskFinishedByTheNodeRequest.ProtoReflect.Descriptor instead.
func (*DistributedTaskFinishedByTheNodeRequest) Descriptor() ([]byte, []int) {
	return file_api_message_proto_rawDescGZIP(), []int{17}
}

func (x *DistributedTaskFinishedByTheNodeRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *DistributedTaskFinishedByTheNodeRequest) GetTaskType() string {
	if x != nil {
		return x.TaskType
	}
	return ""
...
func (x *DistributedTaskFinishedByTheNodeRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *DistributedTaskFinishedByTheNodeRequest) GetFinishedAtUnixMillis() int64 {
	if x != nil {
...
type CancelDistributedTaskRequest struct {
	...
	TaskId                string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	TaskType              string                 `protobuf:"bytes,2,opt,name=task_type,json=taskType,proto3" json:"task_type,omitempty"`
	CancelledAtUnixMillis int64                  `protobuf:"varint,4,opt,name=cancelledAtUnixMillis,proto3" json:"cancelledAtUnixMillis,omitempty"` // TODO: consider using native time type
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *CancelDistributedTaskRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *CancelDistributedTaskRequest) GetTaskType() string {
	if x != nil {
		return x.TaskType
	}
	return ""
...
const file_api_message_proto_rawDesc = "" +
	...
	"\x1fTYPE_DISTRIBUTED_TASK_CANCELLED\x10\xad\x02\x12(\n" +
	"#TYPE_DISTRIBUTED_TASK_NODE_FINISHED\x10\xae\x02\"A\n" +
	...
	"\x06status\x18\x02 \x01(\tR\x06status\"\xaa\x01\n" +
	"\x19AddDistributedTaskRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1b\n" +
	"\ttask_type\x18\x02 \x01(\tR\btaskType\x12!\n" +
	"\ftask_payload\x18\x03 \x01(\fR\vtaskPayload\x124\n" +
	"\x15submittedAtUnixMillis\x18\x04 \x01(\x03R\x15submittedAtUnixMillis\"\xac\x01\n" +
	"'DistributedTaskFinishedByTheNodeRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1b\n" +
	"\ttask_type\x18\x02 \x01(\tR\btaskType\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\tR\x06nodeId\x122\n" +
	"\x14finishedAtUnixMillis\x18\x04 \x01(\x03R\x14finishedAtUnixMillis\"\x8a\x01\n" +
	"\x1cCancelDistributedTaskRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x1b\n" +
	"\ttask_type\x18\x02 \x01(\tR\btaskType\x124\n" +
	"\x15cancelledAtUnixMillis\x18\x04 \x01(\x03R\x15cancelledAtUnixMillis2\x8d\x04\n" +
...
var file_api_message_proto_goTypes = []any{
	...
	(*DistributedTaskFinishedByTheNodeRequest)(nil), // 21: weaviate.internal.cluster.DistributedTaskFinishedByTheNodeRequest
