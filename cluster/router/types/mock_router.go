...
func (_m *MockRouter) WaitForUpdate(ctx context.Context, version uint64) error {
...
// MockRouter_WaitForUpdate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitForUpdate'
type MockRouter_WaitForUpdate_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - version uint64
func (_e *MockRouter_Expecter) WaitForUpdate(ctx interface{}, version interface{}) *MockRouter_WaitForUpdate_Call {
	return &MockRouter_WaitForUpdate_Call{Call: _e.mock.On("WaitForUpdate", ctx, version)}
}

func (_c *MockRouter_WaitForUpdate_Call) Run(run func(ctx context.Context, version uint64)) *MockRouter_WaitForUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRouter_WaitForUpdate_Call) Return(_a0 error) *MockRouter_WaitForUpdate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRouter_WaitForUpdate_Call) RunAndReturn(run func(context.Context, uint64) error) *MockRouter_WaitForUpdate_Call {
	_c.Call.Return(run)
	return _c
}
