...
// WaitForReplicationDrain provides a mock function with given fields: ctx, in, opts
func (_m *MockFileReplicationServiceClient) WaitForReplicationDrain(ctx context.Context, in *protocol.WaitForReplicationDrainRequest, opts ...grpc.CallOption) (*protocol.WaitForReplicationDrainResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *protocol.WaitForReplicationDrainResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *protocol.WaitForReplicationDrainRequest, ...grpc.CallOption) (*protocol.WaitForReplicationDrainResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *protocol.WaitForReplicationDrainRequest, ...grpc.CallOption) *protocol.WaitForReplicationDrainResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*protocol.WaitForReplicationDrainResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *protocol.WaitForReplicationDrainRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockFileReplicationServiceClient_WaitForReplicationDrain_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitForReplicationDrain'
type MockFileReplicationServiceClient_WaitForReplicationDrain_Call struct {
	*mock.Call
}

// WaitForReplicationDrain is a helper method to define mock.On call
//   - ctx context.Context
//   - in *protocol.WaitForReplicationDrainRequest
//   - opts ...grpc.CallOption
func (_e *MockFileReplicationServiceClient_Expecter) WaitForReplicationDrain(ctx interface{}, in interface{}, opts ...interface{}) *MockFileReplicationServiceClient_WaitForReplicationDrain_Call {
	return &MockFileReplicationServiceClient_WaitForReplicationDrain_Call{Call: _e.mock.On("WaitForReplicationDrain",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockFileReplicationServiceClient_WaitForReplicationDrain_Call) Run(run func(ctx context.Context, in *protocol.WaitForReplicationDrainRequest, opts ...grpc.CallOption)) *MockFileReplicationServiceClient_WaitForReplicationDrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*protocol.WaitForReplicationDrainRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockFileReplicationServiceClient_WaitForReplicationDrain_Call) Return(_a0 *protocol.WaitForReplicationDrainResponse, _a1 error) *MockFileReplicationServiceClient_WaitForReplicationDrain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockFileReplicationServiceClient_WaitForReplicationDrain_Call) RunAndReturn(run func(context.Context, *protocol.WaitForReplicationDrainRequest, ...grpc.CallOption) (*protocol.WaitForReplicationDrainResponse, error)) *MockFileReplicationServiceClient_WaitForReplicationDrain_Call {
	_c.Call.Return(run)
	return _c
}
