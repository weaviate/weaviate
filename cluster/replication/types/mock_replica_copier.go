...
// WaitForReplicationDrain provides a mock function with given fields: ctx, srcNodeId, indexName, shardName, deadline
func (_m *MockReplicaCopier) WaitForReplicationDrain(ctx context.Context, srcNodeId string, indexName string, shardName string, deadline time.Duration) error {
	ret := _m.Called(ctx, srcNodeId, indexName, shardName, deadline)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, time.Duration) error); ok {
		r0 = rf(ctx, srcNodeId, indexName, shardName, deadline)
	} else {
		r0 = ret.Error(0)
	}
...
// MockReplicaCopier_WaitForReplicationDrain_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WaitForReplicationDrain'
type MockReplicaCopier_WaitForReplicationDrain_Call struct {
	*mock.Call
}
...
func (_e *MockReplicaCopier_Expecter) WaitForReplicationDrain(ctx interface{}, srcNodeId interface{}, indexName interface{}, shardName interface{}, deadline interface{}) *MockReplicaCopier_WaitForReplicationDrain_Call {
	return &MockReplicaCopier_WaitForReplicationDrain_Call{Call: _e.mock.On("WaitForReplicationDrain", ctx, srcNodeId, indexName, shardName, deadline)}
}

func (_c *MockReplicaCopier_WaitForReplicationDrain_Call) Run(run func(ctx context.Context, srcNodeId string, indexName string, shardName string, deadline time.Duration)) *MockReplicaCopier_WaitForReplicationDrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockReplicaCopier_WaitForReplicationDrain_Call) Return(_a0 error) *MockReplicaCopier_WaitForReplicationDrain_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockReplicaCopier_WaitForReplicationDrain_Call) RunAndReturn(run func(context.Context, string, string, string, time.Duration) error) *MockReplicaCopier_WaitForReplicationDrain_Call {
	_c.Call.Return(run)
	return _c
}
