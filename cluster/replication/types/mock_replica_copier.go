...
// CopyReplicaFiles provides a mock function with given fields: ctx, opID, sourceNode, sourceCollection, sourceShard, schemaVersion
func (_m *MockReplicaCopier) CopyReplicaFiles(ctx context.Context, opID strfmt.UUID, sourceNode string, sourceCollection string, sourceShard string, schemaVersion uint64) error {
	ret := _m.Called(ctx, opID, sourceNode, sourceCollection, sourceShard, schemaVersion)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, strfmt.UUID, string, string, string, uint64) error); ok {
		r0 = rf(ctx, opID, sourceNode, sourceCollection, sourceShard, schemaVersion)
	} else {
		r0 = ret.Error(0)
	}
...
//   - sourceShard string
//   - schemaVersion uint64
func (_e *MockReplicaCopier_Expecter) CopyReplicaFiles(ctx interface{}, opID interface{}, sourceNode interface{}, sourceCollection interface{}, sourceShard interface{}, schemaVersion interface{}) *MockReplicaCopier_CopyReplicaFiles_Call {
	return &MockReplicaCopier_CopyReplicaFiles_Call{Call: _e.mock.On("CopyReplicaFiles", ctx, opID, sourceNode, sourceCollection, sourceShard, schemaVersion)}
}

func (_c *MockReplicaCopier_CopyReplicaFiles_Call) Run(run func(ctx context.Context, opID strfmt.UUID, sourceNode string, sourceCollection string, sourceShard string, schemaVersion uint64)) *MockReplicaCopier_CopyReplicaFiles_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(strfmt.UUID), args[2].(string), args[3].(string), args[4].(string), args[5].(uint64))
	})
	return _c
}
...
func (_c *MockReplicaCopier_CopyReplicaFiles_Call) RunAndReturn(run func(context.Context, strfmt.UUID, string, string, string, uint64) error) *MockReplicaCopier_CopyReplicaFiles_Call {
	_c.Call.Return(run)
	return _c
}
