...
// ForceDeleteReplicationsByIds provides a mock function with given fields: ctx, uuids
func (_m *MockManager) ForceDeleteReplicationsByIds(ctx context.Context, uuids []strfmt.UUID) error {
	ret := _m.Called(ctx, uuids)

	if len(ret) == 0 {
		panic("no return value specified for ForceDeleteReplicationsByIds")
	}
...
// MockManager_ForceDeleteReplicationsByIds_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ForceDeleteReplicationsByIds'
type MockManager_ForceDeleteReplicationsByIds_Call struct {
	*mock.Call
}

// ForceDeleteReplicationsByIds is a helper method to define mock.On call
//   - ctx context.Context
//   - uuids []strfmt.UUID
func (_e *MockManager_Expecter) ForceDeleteReplicationsByIds(ctx interface{}, uuids interface{}) *MockManager_ForceDeleteReplicationsByIds_Call {
	return &MockManager_ForceDeleteReplicationsByIds_Call{Call: _e.mock.On("ForceDeleteReplicationsByIds", ctx, uuids)}
}

func (_c *MockManager_ForceDeleteReplicationsByIds_Call) Run(run func(ctx context.Context, uuids []strfmt.UUID)) *MockManager_ForceDeleteReplicationsByIds_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]strfmt.UUID))
	})
	return _c
...
func (_c *MockManager_ForceDeleteReplicationsByIds_Call) Return(_a0 error) *MockManager_ForceDeleteReplicationsByIds_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockManager_ForceDeleteReplicationsByIds_Call) RunAndReturn(run func(context.Context, []strfmt.UUID) error) *MockManager_ForceDeleteReplicationsByIds_Call {
	_c.Call.Return(run)
	return _c
}
