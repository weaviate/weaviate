...
// ForceDeleteReplicationsByReplicationId provides a mock function with given fields: ctx, uuid
func (_m *MockManager) ForceDeleteReplicationsByReplicationId(ctx context.Context, uuid strfmt.UUID) error {
	ret := _m.Called(ctx, uuid)

	if len(ret) == 0 {
		panic("no return value specified for ForceDeleteReplicationsByReplicationId")
	}
...
// MockManager_ForceDeleteReplicationsByReplicationId_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ForceDeleteReplicationsByReplicationId'
type MockManager_ForceDeleteReplicationsByReplicationId_Call struct {
	*mock.Call
}

// ForceDeleteReplicationsByReplicationId is a helper method to define mock.On call
//   - ctx context.Context
//   - uuid strfmt.UUID
func (_e *MockManager_Expecter) ForceDeleteReplicationsByReplicationId(ctx interface{}, uuid interface{}) *MockManager_ForceDeleteReplicationsByReplicationId_Call {
	return &MockManager_ForceDeleteReplicationsByReplicationId_Call{Call: _e.mock.On("ForceDeleteReplicationsByReplicationId", ctx, uuid)}
}

func (_c *MockManager_ForceDeleteReplicationsByReplicationId_Call) Run(run func(ctx context.Context, uuid strfmt.UUID)) *MockManager_ForceDeleteReplicationsByReplicationId_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(strfmt.UUID))
	})
	return _c
...
func (_c *MockManager_ForceDeleteReplicationsByReplicationId_Call) Return(_a0 error) *MockManager_ForceDeleteReplicationsByReplicationId_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockManager_ForceDeleteReplicationsByReplicationId_Call) RunAndReturn(run func(context.Context, strfmt.UUID) error) *MockManager_ForceDeleteReplicationsByReplicationId_Call {
	_c.Call.Return(run)
	return _c
}
