...
type Service struct {
	...
	grpcClientMaxCallRecvMsgSize int
	log                          *logrus.Logger
}

func New(ms members, ex executor, address string, l *logrus.Logger, grpcClientMaxCallRecvMsgSize int) *Service {
	return &Service{
		members:                      ms,
		executor:                     ex,
		address:                      address,
		log:                          l,
		grpcClientMaxCallRecvMsgSize: grpcClientMaxCallRecvMsgSize,
	}
}
...
func (s *Service) Open() error {
	...
	s.grpcServer = grpc.NewServer(
		grpc.MaxRecvMsgSize(s.grpcClientMaxCallRecvMsgSize),
	)
