...
func NewFinder(className string,
	...
	return &Finder{
		...
		finderStream: finderStream{
			repairer: repairer{
				class:                   className,
				propagateObjectDeletion: propagateObjectDeletion,
				client:                  cl,
				logger:                  l,
			},
			log: l,
...
func (f *Finder) GetOne(ctx context.Context,
	...
	c := newReadCoordinator[findOneReply](f, shard,
		f.coordinatorPullBackoffInitialInterval, f.coordinatorPullBackoffMaxElapsedTime, f.propagateObjectDeletion)
