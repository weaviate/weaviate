...
func (_m *Controller) GetRolesForUser(user string, userType models.UserTypes) (map[string][]authorization.Policy, error) {
...
func (_m *Controller) GetUsersForRole(role string, userType models.UserTypes) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(string, models.UserTypes) ([]string, error)); ok {
		return rf(role, userType)
	}
	if rf, ok := ret.Get(0).(func(string, models.UserTypes) []string); ok {
		r0 = rf(role, userType)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
