...
func TestKeyMatch5AuthZ(t *testing.T) {
	tests := []struct {
		...
		{"Class level objects ABC TenantX", authorization.Objects("ABC", "TenantX", "objectY"), conv.CasbinData("ABC", "*"), true},
		...
		{"Tenants level objects Class1 Tenant1", authorization.Objects("Class1", "Tenant1", "ObjectY"), conv.CasbinData("*", "Tenant1"), true},
		...
		{"Objects level ABC Tenant1 abc exact 2", authorization.Objects("ABC", "Tenant1", "abc"), conv.CasbinData("*", "*"), true},
		{"Objects level ABC Tenant1 abc exact 3", authorization.Objects("ABC", "Tenant1", "abc"), conv.CasbinData("ABC", "Tenant1"), true},
		{"Objects level ABCD Tenant1 abc mismatch", authorization.Objects("ABCD", "Tenant1", "abc"), conv.CasbinData("ABC", "Tenant1"), false},
		{"Objects level ABC bar", authorization.Objects("ABC", "bar", "abcd"), conv.CasbinData("*", "bar"), true},
		...
		{"Objects match collection and shard", authorization.Objects("Class1", "Shard1", "Object1"), conv.CasbinData("Class1", "Shard1"), true},
