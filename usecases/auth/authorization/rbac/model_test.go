...
func TestKeyMatch5AuthZ(t *testing.T) {
	tests := []struct {
		...
		{"Class level objects ABC TenantX", authorization.Objects("ABC", "TenantX"), conv.CasbinData("ABC", "*"), true},
		...
		{"Tenants level objects Class1 Tenant1", authorization.Objects("Class1", "Tenant1"), conv.CasbinData("*", "Tenant1"), true},
		...
		// Objects level (object segment is always wildcarded)
		{"Objects level all", authorization.Objects("", ""), conv.CasbinData(".*", ".*"), true},
		{"Objects level ABC Tenant1 wildcard", authorization.Objects("ABC", "Tenant1"), conv.CasbinData("*", "*"), true},
		{"Objects level ABC Tenant1 exact", authorization.Objects("ABC", "Tenant1"), conv.CasbinData("*", "Tenant1"), true},
		{"Objects level ABC Tenant1 exact collection", authorization.Objects("ABC", "Tenant1"), conv.CasbinData("ABC", "Tenant1"), true},
		{"Objects level ABCD Tenant1 mismatch", authorization.Objects("ABCD", "Tenant1"), conv.CasbinData("ABC", "Tenant1"), false},
		{"Objects level ABC bar", authorization.Objects("ABC", "bar"), conv.CasbinData("*", "bar"), true},
		...
		{"Objects match collection and shard", authorization.Objects("Class1", "Shard1"), conv.CasbinData("Class1", "Shard1"), true},
		{"Objects wildcard does not match extended object identifier", authorization.Objects("Class1", "Shard1"), "data/collections/Class1/shards/Shard1/objects/Object1!", false},
