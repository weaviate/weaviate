...
func (_m *MockController) GetRolesForUser(user string) (map[string][]Policy, error) {
	ret := _m.Called(user)
...
//   - user string
func (_e *MockController_Expecter) GetRolesForUser(user interface{}) *MockController_GetRolesForUser_Call {
	return &MockController_GetRolesForUser_Call{Call: _e.mock.On("GetRolesForUser", user)}
}

func (_c *MockController_GetRolesForUser_Call) Run(run func(user string)) *MockController_GetRolesForUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockController_GetRolesForUser_Call) RunAndReturn(run func(string) (map[string][]Policy, error)) *MockController_GetRolesForUser_Call {
	_c.Call.Return(run)
	return _c
}

// GetUsersForRole provides a mock function with given fields: role
func (_m *MockController) GetUsersForRole(role string) ([]string, error) {
	ret := _m.Called(role)
...
//   - role string
func (_e *MockController_Expecter) GetUsersForRole(role interface{}) *MockController_GetUsersForRole_Call {
	return &MockController_GetUsersForRole_Call{Call: _e.mock.On("GetUsersForRole", role)}
}

func (_c *MockController_GetUsersForRole_Call) Run(run func(role string)) *MockController_GetUsersForRole_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockController_GetUsersForRole_Call) RunAndReturn(run func(string) ([]string, error)) *MockController_GetUsersForRole_Call {
	_c.Call.Return(run)
	return _c
}
