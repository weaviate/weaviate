...
func (p *Provider) setSinglePropertyDefaults(prop *models.Property, vectorizer string, targetVector string) {
	if vectorizer == "none" {
		// the class does not use a vectorizer, nothing to do for us
		return
	}
...
func (p *Provider) setSinglePropertyConfigDefaults(prop *models.Property,
	vectorizer string, targetVector string, cc modulecapabilities.ClassConfigurator,
) {
