...
func (_m *MockNodeSelector) Shutdown(timeout time.Duration) error {
...
func (_e *MockNodeSelector_Expecter) Shutdown(timeout interface{}) *MockNodeSelector_Shutdown_Call {
	return &MockNodeSelector_Shutdown_Call{Call: _e.mock.On("Shutdown", timeout)}
}

func (_c *MockNodeSelector_Shutdown_Call) Run(run func(timeout time.Duration)) *MockNodeSelector_Shutdown_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockNodeSelector_Shutdown_Call) RunAndReturn(run func(time.Duration) error) *MockNodeSelector_Shutdown_Call {
	_c.Call.Return(run)
	return _c
}
