...
type VectorConfigParser func(in interface{}, vectorIndexType string, isMultiVector bool, defaultQuantization *configRuntime.DynamicValue[string]) (schemaConfig.VectorIndexConfig, error)
