...
type Sourcer interface { // implemented by the index
	...
	Backupable(ctx context.Context, classes []string) error
	...
	BackupDescriptors(ctx context.Context, bakid string, classes []string,
	) <-chan backup.ClassDescriptor

	ClassExists(name string) bool

	// TODO:
	// func (db *DB) ListBackupable(ctx context.Context, classes []string) error
}
