...
func (f *fakeRemoteClient) VectorDistanceForQuery(ctx context.Context, hostname string, indexName string, shardName string, id strfmt.UUID, docId uint64, targetVectors []string, searchVectors [][]float32, tenant string) ([]float32, error) {
	return nil, nil
}
