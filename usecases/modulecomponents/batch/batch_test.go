...
func TestBatch(t *testing.T) {
	...
	cases := []struct {
		...
		}, skip: []bool{false, false, false, false, true, false}, wantErrors: map[int]error{3: fmt.Errorf("context deadline exceeded while sending batch"), 5: fmt.Errorf("context deadline exceeded while sending batch")}},
