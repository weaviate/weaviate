...
type DistributedTasksConfig struct {
	...
	// SubUnitProgressMinInterval is the minimum time between sub-unit progress updates
	// written to Raft. Defaults to 30s when zero.
	SubUnitProgressMinInterval time.Duration `json:"subUnitProgressMinInterval" yaml:"subUnitProgressMinInterval"`
}
