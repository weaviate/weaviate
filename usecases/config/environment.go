...
func FromEnv(config *Config) error {
	...
	// 0 = clean completed tasks on the next tick. With RUNTIME_REINDEX_ENABLED, 0
	// also refuses every backup before it uploads anything. Unsafe until the cluster is
