...
type WeaviateRuntimeConfig struct {
	...
	ResourceLimitGoMemLimitFromCgroups *runtime.DynamicValue[float64] `json:"resource_limit_go_mem_limit_from_cgroups" yaml:"resource_limit_go_mem_limit_from_cgroups"`
}
