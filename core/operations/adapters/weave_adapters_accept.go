...
type WeaveAdaptersAcceptHandlerFunc func(WeaveAdaptersAcceptParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaveAdaptersAcceptHandlerFunc) Handle(params WeaveAdaptersAcceptParams) middleware.Responder {
	return fn(params)
}
...
type WeaveAdaptersAcceptHandler interface {
	Handle(WeaveAdaptersAcceptParams) middleware.Responder
}
