...
type Property struct {
	...
	// Enum: [word lowercase whitespace field trigram gse kagome_kr kagome_jp]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["word","lowercase","whitespace","field","trigram","gse","kagome_kr","kagome_jp"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
