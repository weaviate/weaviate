...
type Property struct {
	...
	// Whether to include this property in a columnar index for efficient filtered aggregations. Applicable only to properties of data type int, number, date.
...
func (m *Property) validateTextAnalyzer(formats strfmt.Registry) error {
