...
// ContextValidate validate this index status list based on the context it is used
func (m *IndexStatusList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IndexStatusList) contextValidateIndexes(ctx context.Context, formats strfmt.Registry) error {
