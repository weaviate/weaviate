...
func TestNonExistingClassRelaxedCrossValidation(t *testing.T) {
	...
	pdt, err := FindPropertyDataTypeWithRefs(s.ReadOnlyClass, []string{className}, true, ClassName("AnotherNonExistingClass"))
...
func TestNonExistingClassPropertyBelongsTo(t *testing.T) {
	...
	pdt, err := FindPropertyDataTypeWithRefs(s.ReadOnlyClass, []string{className}, false, ClassName(className))
