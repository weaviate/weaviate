...
func TestNonExistingClassRelaxedCrossValidation(t *testing.T) {
	...
	pdt, err := FindPropertyDataTypeWithRefs(&s, []string{className}, true, ClassName("AnotherNonExistingClass"))
...
func TestNonExistingClassPropertyBelongsTo(t *testing.T) {
	...
	pdt, err := FindPropertyDataTypeWithRefs(&s, []string{className}, false, ClassName(className))
