...
// 		class, version, err := ClassFromContext(noCacheCtx, noopGetter, "class1")
// 		assert.Nil(t, class)
...
// 		class, version, err := ClassFromContext(invalidCacheCtx, noopGetter, "class1")
// 		assert.Nil(t, class)
// 		assert.Equal(t, uint64(0), version)
// 		assert.ErrorContains(t, err, "context does not contain classCache")
// 	})
