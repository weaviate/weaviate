...
type GlobalConfig struct {
	...
	AsyncReplicationSchedulerTopologyFrequency *runtime.DynamicValue[time.Duration] `json:"async_replication_scheduler_topology_frequency" yaml:"async_replication_scheduler_topology_frequency"`
