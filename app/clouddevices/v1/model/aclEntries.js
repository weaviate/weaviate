        ...
        try {
          ...
          ACTIONS.validateBodyObject(weaveObject, [], (result) => {
              ...
              case true:
                         ...
                         * Provided body is correct, handle the request
                         */
                  ACTIONS.process('clouddevices.aclEntries.get', (processResult) => {
                        switch (processResult) {
                            case false:
                                deferred.reject('Something processing this request went wrong');
                            default:
        ...
        try {
          ...
          ACTIONS.validateBodyObject(weaveObject, [], (result) => {
              ...
              case true:
                         ...
                         * Provided body is correct, handle the request
                         */
                  ACTIONS.process('clouddevices.aclEntries.patch', (processResult) => {
                        switch (processResult) {
                            case false:
                                deferred.reject('Something processing this request went wrong');
                            default:
        ...
        try {
          ...
          ACTIONS.validateBodyObject(weaveObject, [], (result) => {
              ...
              case true:
                         ...
                         * Provided body is correct, handle the request
                         */
                  ACTIONS.process('clouddevices.aclEntries.update', (processResult) => {
                        switch (processResult) {
                            case false:
                                deferred.reject('Something processing this request went wrong');
                            default:
        ...
        try {
          ...
          ACTIONS.validateBodyObject(weaveObject, [], (result) => {
              ...
              case true:
                         ...
                         * Provided body is correct, handle the request
                         */
                  ACTIONS.process('clouddevices.aclEntries.insert', (processResult) => {
                        switch (processResult) {
                            case false:
                                deferred.reject('Something processing this request went wrong');
                            default:
        ...
        try {
          ...
          ACTIONS.validateBodyObject(weaveObject, [], (result) => {
              ...
              case true:
                         ...
                         * Provided body is correct, handle the request
                         */
                  ACTIONS.process('clouddevices.aclEntries.list', (processResult) => {
                        switch (processResult) {
                            case false:
                                deferred.reject('Something processing this request went wrong');
                            default:
