...
func (m *NvidiaModule) initNearText() error {
	m.searcher = nearText.NewSearcher(m.vectorizer)
	m.graphqlProvider = nearText.New(m.nearTextTransformer)
	return nil
}

func (m *NvidiaModule) Arguments() map[string]modulecapabilities.GraphQLArgument {
	return m.graphqlProvider.Arguments()
}

func (m *NvidiaModule) VectorSearches() map[string]modulecapabilities.VectorForParams[[]float32] {
