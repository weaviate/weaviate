...
func TestBuildURL(t *testing.T) {
	tests := []struct {
		...
		{
			name:            "Vertex AI with default location",
			useGenerativeAI: false,
			apiEndpoint:     "us-central1-aiplatform.googleapis.com",
			projectID:       "my-project",
			modelID:         "gemini-embedding-001",
			location:        "us-central1",
			expectedURL:     "https://us-central1-aiplatform.googleapis.com/v1/projects/my-project/locations/us-central1/publishers/google/models/gemini-embedding-001:predict",
		},
		{
			...
			expectedURL:     "https://asia-southeast1-aiplatform.googleapis.com/v1/projects/my-project/locations/asia-southeast1/publishers/google/models/gemini-embedding-001:predict",
		},
		{
