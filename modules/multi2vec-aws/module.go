...
import (
	...
	"github.com/weaviate/weaviate/modules/multi2vec-aws/clients"
	"github.com/weaviate/weaviate/modules/multi2vec-aws/ent"
	"github.com/weaviate/weaviate/modules/multi2vec-aws/vectorizer"
)

const Name = "multi2vec-aws"
...
func (m *Module) getAWSAccessKey() string {
...
func (m *Module) getAWSSecretAccessKey() string {
