...
func TestClient(t *testing.T) {
	t.Run("when all is fine", func(t *testing.T) {
		...
		res, _, _, err := c.Vectorize(context.Background(), []string{"This is my text"}, fakeClassConfig{classConfig: map[string]interface{}{"Model": "large", "baseURL": server.URL}})
	...
	t.Run("when Weaviate API key is passed using X-Weaviate-Api-Key header", func(t *testing.T) {
		...
		ctxWithValue := context.WithValue(context.Background(),
			"X-Weaviate-Api-Key", []string{"some-key"})
		...
		res, _, _, err := c.Vectorize(ctxWithValue, []string{"This is my text"}, fakeClassConfig{classConfig: map[string]interface{}{"Model": "large", "baseURL": server.URL}})
