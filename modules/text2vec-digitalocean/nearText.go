...
func (m *DigitalOceanModule) initNearText() error {
	m.searcher = nearText.NewSearcher(m.vectorizer)
	m.graphqlProvider = nearText.New(m.nearTextTransformer)
	return nil
}

func (m *DigitalOceanModule) Arguments() map[string]modulecapabilities.GraphQLArgument {
	return m.graphqlProvider.Arguments()
}

func (m *DigitalOceanModule) VectorSearches() map[string]modulecapabilities.VectorForParams[[]float32] {
