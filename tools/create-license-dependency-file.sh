...
echo -e "More information about this file can be found [here](https://github.com/weaviate/weaviate/tree/develop/docs/en/contribute/licenses.md).\n" >> $LICENSEFILE
...
##
LICENSES=$(licenses -a -w github.com/weaviate/weaviate/cmd/weaviate-server)
