...
// This file was generated by go generate ./deprecations at 2021-01-05
...
var ByID = map[string]models.Deprecation{
	"rest-meta-prop": models.Deprecation{
		...
		Status:       "deprecated",
		APIType:      "REST",
		Mitigation:   "Use ?include=<propName>, e.g. ?include=classification for classification meta or ?include=_vector to show the vector position or ?include=_classification,_vector for both. When consuming the response use the additional fields such as _vector, as the meta object in the reponse, such as meta.vector will be removed.",
