...
GOMEMLIMIT=100GiB ASYNC_INDEXING=true ASYNC_INDEXING_BATCH_SIZE=500000 GRPC_MAX_MESSAGE_SIZE=20446800000 QUEUE_SCHEDULER_INTERVAL=60s ./tools/dev/run_dev_server.sh local-cuvs-development 
