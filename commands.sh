...
GOGC=100 GOMEMLIMIT=55GiB ASYNC_INDEXING=true ASYNC_INDEXING_BATCH_SIZE=8741823 GRPC_MAX_MESSAGE_SIZE=20446800000 QUEUE_SCHEDULER_INTERVAL=120s ./tools/dev/run_dev_server.sh local-cuvs-development 
