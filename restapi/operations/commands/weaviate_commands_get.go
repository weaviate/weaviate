...
type WeaviateCommandsGetHandlerFunc func(WeaviateCommandsGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateCommandsGetHandlerFunc) Handle(params WeaviateCommandsGetParams) middleware.Responder {
	return fn(params)
}
...
type WeaviateCommandsGetHandler interface {
	Handle(WeaviateCommandsGetParams) middleware.Responder
}
