...
type WeaviateToolsMapHandlerFunc func(WeaviateToolsMapParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateToolsMapHandlerFunc) Handle(params WeaviateToolsMapParams, principal interface{}) middleware.Responder {
...
type WeaviateToolsMapHandler interface {
	Handle(WeaviateToolsMapParams, interface{}) middleware.Responder
}
