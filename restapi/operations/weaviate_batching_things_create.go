...
type WeaviateBatchingThingsCreateHandlerFunc func(WeaviateBatchingThingsCreateParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateBatchingThingsCreateHandlerFunc) Handle(params WeaviateBatchingThingsCreateParams, principal interface{}) middleware.Responder {
...
type WeaviateBatchingThingsCreateHandler interface {
	Handle(WeaviateBatchingThingsCreateParams, interface{}) middleware.Responder
}
