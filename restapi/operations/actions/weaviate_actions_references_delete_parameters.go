...
func (o *WeaviateActionsReferencesDeleteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WeaviateActionsReferencesDeleteParams) validateID(formats strfmt.Registry) error {
