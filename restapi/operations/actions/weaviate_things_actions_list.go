...
/*WeaviateThingsActionsList swagger:route GET /things/{thingId}/actions actions weaviateThingsActionsList

Get a list of actions based on a thing's uuid (also available as MQTT channel) related to this key.
