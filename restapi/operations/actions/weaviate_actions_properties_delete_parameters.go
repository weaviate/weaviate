...
// WeaviateActionsPropertiesDeleteParams contains all the bound params for the weaviate actions properties delete operation
// typically these are obtained from a http.Request
//
// swagger:parameters weaviate.actions.properties.delete
...
//
// To ensure default values, the struct must have been initialized with NewWeaviateActionsPropertiesDeleteParams() beforehand.
func (o *WeaviateActionsPropertiesDeleteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WeaviateActionsPropertiesDeleteParams) bindActionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WeaviateActionsPropertiesDeleteParams) validateActionID(formats strfmt.Registry) error {
...
func (o *WeaviateActionsPropertiesDeleteParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
