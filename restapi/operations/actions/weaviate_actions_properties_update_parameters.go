...
// WeaviateActionsPropertiesUpdateParams contains all the bound params for the weaviate actions properties update operation
// typically these are obtained from a http.Request
//
// swagger:parameters weaviate.actions.properties.update
...
//
// To ensure default values, the struct must have been initialized with NewWeaviateActionsPropertiesUpdateParams() beforehand.
func (o *WeaviateActionsPropertiesUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WeaviateActionsPropertiesUpdateParams) bindActionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WeaviateActionsPropertiesUpdateParams) validateActionID(formats strfmt.Registry) error {
...
func (o *WeaviateActionsPropertiesUpdateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
