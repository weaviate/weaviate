...
//
// To ensure default values, the struct must have been initialized with NewWeaviateKeysGetParams() beforehand.
...
func (o *WeaviateKeysGetParams) validateKeyID(formats strfmt.Registry) error {
