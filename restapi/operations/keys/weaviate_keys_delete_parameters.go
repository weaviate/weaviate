...
//
// To ensure default values, the struct must have been initialized with NewWeaviateKeysDeleteParams() beforehand.
...
func (o *WeaviateKeysDeleteParams) validateKeyID(formats strfmt.Registry) error {
