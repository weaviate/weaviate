...
//
// To ensure default values, the struct must have been initialized with NewWeaviateKeysChildrenGetParams() beforehand.
...
func (o *WeaviateKeysChildrenGetParams) validateKeyID(formats strfmt.Registry) error {
