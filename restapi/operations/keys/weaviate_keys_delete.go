...
type WeaviateKeysDeleteHandlerFunc func(WeaviateKeysDeleteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateKeysDeleteHandlerFunc) Handle(params WeaviateKeysDeleteParams) middleware.Responder {
	return fn(params)
}
...
type WeaviateKeysDeleteHandler interface {
	Handle(WeaviateKeysDeleteParams) middleware.Responder
}
