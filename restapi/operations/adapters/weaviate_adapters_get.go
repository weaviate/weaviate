...
type WeaviateAdaptersGetHandlerFunc func(WeaviateAdaptersGetParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateAdaptersGetHandlerFunc) Handle(params WeaviateAdaptersGetParams, principal interface{}) middleware.Responder {
...
type WeaviateAdaptersGetHandler interface {
	Handle(WeaviateAdaptersGetParams, interface{}) middleware.Responder
}
