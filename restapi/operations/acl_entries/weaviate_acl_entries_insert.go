...
func NewWeaviateACLEntriesInsert(ctx *middleware.Context, handler WeaviateACLEntriesInsertHandler) *WeaviateACLEntriesInsert {
	return &WeaviateACLEntriesInsert{Context: ctx, Handler: handler}
}

/*WeaviateACLEntriesInsert swagger:route POST /devices/{deviceId}/aclEntries aclEntries weaviateAclEntriesInsert

Inserts a new ACL entry.

*/
type WeaviateACLEntriesInsert struct {
	Context *middleware.Context
	Handler WeaviateACLEntriesInsertHandler
}

func (o *WeaviateACLEntriesInsert) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
