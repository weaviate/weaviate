...
type WeaviateACLEntriesListHandlerFunc func(WeaviateACLEntriesListParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateACLEntriesListHandlerFunc) Handle(params WeaviateACLEntriesListParams, principal interface{}) middleware.Responder {
...
type WeaviateACLEntriesListHandler interface {
	Handle(WeaviateACLEntriesListParams, interface{}) middleware.Responder
}
