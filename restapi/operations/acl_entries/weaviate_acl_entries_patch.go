...
type WeaviateACLEntriesPatchHandlerFunc func(WeaviateACLEntriesPatchParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateACLEntriesPatchHandlerFunc) Handle(params WeaviateACLEntriesPatchParams, principal interface{}) middleware.Responder {
...
type WeaviateACLEntriesPatchHandler interface {
	Handle(WeaviateACLEntriesPatchParams, interface{}) middleware.Responder
}
