...
func NewWeaviateAPI(spec *loads.Document) *WeaviateAPI {
	return &WeaviateAPI{
		...
		ActionsWeaviateThingsActionsCreateHandler: actions.WeaviateThingsActionsCreateHandlerFunc(func(params actions.WeaviateThingsActionsCreateParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsWeaviateThingsActionsCreate has not yet been implemented")
		}),
		ActionsWeaviateThingsActionsListHandler: actions.WeaviateThingsActionsListHandlerFunc(func(params actions.WeaviateThingsActionsListParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation ActionsWeaviateThingsActionsList has not yet been implemented")
		}),
...
type WeaviateAPI struct {
	...
	// ActionsWeaviateThingsActionsCreateHandler sets the operation handler for the weaviate things actions create operation
	ActionsWeaviateThingsActionsCreateHandler actions.WeaviateThingsActionsCreateHandler
	// ActionsWeaviateThingsActionsListHandler sets the operation handler for the weaviate things actions list operation
	ActionsWeaviateThingsActionsListHandler actions.WeaviateThingsActionsListHandler
...
func (o *WeaviateAPI) Validate() error {
	...
	if o.ActionsWeaviateThingsActionsCreateHandler == nil {
		unregistered = append(unregistered, "actions.WeaviateThingsActionsCreateHandler")
	}

	if o.ActionsWeaviateThingsActionsListHandler == nil {
		unregistered = append(unregistered, "actions.WeaviateThingsActionsListHandler")
	}
...
func (o *WeaviateAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/things/{thingId}/actions"] = actions.NewWeaviateThingsActionsCreate(o.context, o.ActionsWeaviateThingsActionsCreateHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/things/{thingId}/actions"] = actions.NewWeaviateThingsActionsList(o.context, o.ActionsWeaviateThingsActionsListHandler)
