...
func NewWeaviateAPI(spec *loads.Document) *WeaviateAPI {
	return &WeaviateAPI{
		...
		LocationsWeaviateLocatinosListHandler: locations.WeaviateLocatinosListHandlerFunc(func(params locations.WeaviateLocatinosListParams) middleware.Responder {
			return middleware.NotImplemented("operation LocationsWeaviateLocatinosList has not yet been implemented")
		}),
		LocationsWeaviateLocationPatchHandler: locations.WeaviateLocationPatchHandlerFunc(func(params locations.WeaviateLocationPatchParams) middleware.Responder {
			return middleware.NotImplemented("operation LocationsWeaviateLocationPatch has not yet been implemented")
		}),
...
type WeaviateAPI struct {
	...
	// LocationsWeaviateLocatinosListHandler sets the operation handler for the weaviate locatinos list operation
	LocationsWeaviateLocatinosListHandler locations.WeaviateLocatinosListHandler
	// LocationsWeaviateLocationPatchHandler sets the operation handler for the weaviate location patch operation
	LocationsWeaviateLocationPatchHandler locations.WeaviateLocationPatchHandler
...
func (o *WeaviateAPI) Validate() error {
	...
	if o.LocationsWeaviateLocatinosListHandler == nil {
		unregistered = append(unregistered, "locations.WeaviateLocatinosListHandler")
	}

	if o.LocationsWeaviateLocationPatchHandler == nil {
		unregistered = append(unregistered, "locations.WeaviateLocationPatchHandler")
	}
...
func (o *WeaviateAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/locations"] = locations.NewWeaviateLocatinosList(o.context, o.LocationsWeaviateLocatinosListHandler)

	if o.handlers["PATCH"] == nil {
		o.handlers["PATCH"] = make(map[string]http.Handler)
	}
	o.handlers["PATCH"]["/locations/{locationId}"] = locations.NewWeaviateLocationPatch(o.context, o.LocationsWeaviateLocationPatchHandler)
