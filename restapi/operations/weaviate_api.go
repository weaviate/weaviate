...
type WeaviateAPI struct {
	...
	// AuthorizedAppsWeaveAuthorizedAppsCheckAPIAccessHandler sets the operation handler for the weave authorized apps check Api access operation
	AuthorizedAppsWeaveAuthorizedAppsCheckAPIAccessHandler authorized_apps.WeaveAuthorizedAppsCheckAPIAccessHandler
	...
	// DevicesWeaveDevicesAddToPlaceHandler sets the operation handler for the weave devices add to place operation
	...
	// DevicesWeaveDevicesSetRoomHandler sets the operation handler for the weave devices set room operation
	...
	// LabelsWeaveLabelsCreateHandler sets the operation handler for the weave labels create operation
	LabelsWeaveLabelsCreateHandler labels.WeaveLabelsCreateHandler
	// LabelsWeaveLabelsDeleteHandler sets the operation handler for the weave labels delete operation
	LabelsWeaveLabelsDeleteHandler labels.WeaveLabelsDeleteHandler
	// LabelsWeaveLabelsGetHandler sets the operation handler for the weave labels get operation
	LabelsWeaveLabelsGetHandler labels.WeaveLabelsGetHandler
	// LabelsWeaveLabelsListHandler sets the operation handler for the weave labels list operation
	LabelsWeaveLabelsListHandler labels.WeaveLabelsListHandler
	// LabelsWeaveLabelsModifyHandler sets the operation handler for the weave labels modify operation
	LabelsWeaveLabelsModifyHandler labels.WeaveLabelsModifyHandler
	...
	// RoomsWeaveRoomsAddLabelHandler sets the operation handler for the weave rooms add label operation
	RoomsWeaveRoomsAddLabelHandler rooms.WeaveRoomsAddLabelHandler
	...
	// RoomsWeaveRoomsRemoveLabelHandler sets the operation handler for the weave rooms remove label operation
	RoomsWeaveRoomsRemoveLabelHandler rooms.WeaveRoomsRemoveLabelHandler
...
func (o *WeaviateAPI) Validate() error {
	...
	if o.AuthorizedAppsWeaveAuthorizedAppsCheckAPIAccessHandler == nil {
		unregistered = append(unregistered, "authorized_apps.WeaveAuthorizedAppsCheckAPIAccessHandler")
	}
	...
	if o.LabelsWeaveLabelsCreateHandler == nil {
		unregistered = append(unregistered, "labels.WeaveLabelsCreateHandler")
	}

	if o.LabelsWeaveLabelsDeleteHandler == nil {
		unregistered = append(unregistered, "labels.WeaveLabelsDeleteHandler")
	}

	if o.LabelsWeaveLabelsGetHandler == nil {
		unregistered = append(unregistered, "labels.WeaveLabelsGetHandler")
	}

	if o.LabelsWeaveLabelsListHandler == nil {
		unregistered = append(unregistered, "labels.WeaveLabelsListHandler")
	}

	if o.LabelsWeaveLabelsModifyHandler == nil {
		unregistered = append(unregistered, "labels.WeaveLabelsModifyHandler")
	}
	...
	if o.RoomsWeaveRoomsAddLabelHandler == nil {
		unregistered = append(unregistered, "rooms.WeaveRoomsAddLabelHandler")
	}
	...
	if o.RoomsWeaveRoomsRemoveLabelHandler == nil {
		unregistered = append(unregistered, "rooms.WeaveRoomsRemoveLabelHandler")
	}
...
func (o *WeaviateAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/authorizedApps/checkApiAccess"] = authorized_apps.NewWeaveAuthorizedAppsCheckAPIAccess(o.context, o.AuthorizedAppsWeaveAuthorizedAppsCheckAPIAccessHandler)
	...
	o.handlers["POST"]["/places/{placeId}/labels/create"] = labels.NewWeaveLabelsCreate(o.context, o.LabelsWeaveLabelsCreateHandler)

	if o.handlers["DELETE"] == nil {
		o.handlers[strings.ToUpper("DELETE")] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/places/{placeId}/labels/{labelId}"] = labels.NewWeaveLabelsDelete(o.context, o.LabelsWeaveLabelsDeleteHandler)

	if o.handlers["GET"] == nil {
		o.handlers[strings.ToUpper("GET")] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/places/{placeId}/labels/{labelId}"] = labels.NewWeaveLabelsGet(o.context, o.LabelsWeaveLabelsGetHandler)

	if o.handlers["GET"] == nil {
		o.handlers[strings.ToUpper("GET")] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/places/{placeId}/labels"] = labels.NewWeaveLabelsList(o.context, o.LabelsWeaveLabelsListHandler)

	if o.handlers["POST"] == nil {
		o.handlers[strings.ToUpper("POST")] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/places/{placeId}/labels/{labelId}/modify"] = labels.NewWeaveLabelsModify(o.context, o.LabelsWeaveLabelsModifyHandler)
	...
	o.handlers["POST"]["/places/{placeId}/rooms/{roomId}/addLabel"] = rooms.NewWeaveRoomsAddLabel(o.context, o.RoomsWeaveRoomsAddLabelHandler)
	...
	o.handlers["POST"]["/places/{placeId}/rooms/{roomId}/removeLabel"] = rooms.NewWeaveRoomsRemoveLabel(o.context, o.RoomsWeaveRoomsRemoveLabelHandler)
