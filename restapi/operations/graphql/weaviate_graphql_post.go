...
type WeaviateGraphqlPostHandlerFunc func(WeaviateGraphqlPostParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateGraphqlPostHandlerFunc) Handle(params WeaviateGraphqlPostParams, principal *models.Principal) middleware.Responder {
...
type WeaviateGraphqlPostHandler interface {
	Handle(WeaviateGraphqlPostParams, *models.Principal) middleware.Responder
}
