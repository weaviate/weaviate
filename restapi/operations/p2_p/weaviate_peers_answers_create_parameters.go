...
//
// To ensure default values, the struct must have been initialized with NewWeaviatePeersAnswersCreateParams() beforehand.
...
func (o *WeaviatePeersAnswersCreateParams) bindAnswerID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if err := o.validateAnswerID(formats); err != nil {
		return err
	}
...
// validateAnswerID carries on validations for parameter AnswerID
func (o *WeaviatePeersAnswersCreateParams) validateAnswerID(formats strfmt.Registry) error {

	if err := validate.FormatOf("answerId", "path", "uuid", o.AnswerID.String(), formats); err != nil {
		return err
	}
	return nil
}
