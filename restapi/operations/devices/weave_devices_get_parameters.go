...
type WeaveDevicesGetParams struct {
	...
	*/
	PrettyPrint *bool
	/*Projection controls which fields of the Device resource are returned.
	  In: query
	*/
	Projection *string
...
func (o *WeaveDevicesGetParams) bindProjection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WeaveDevicesGetParams) validateProjection(formats strfmt.Registry) error {
