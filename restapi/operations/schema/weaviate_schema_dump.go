...
type WeaviateSchemaDumpHandlerFunc func(WeaviateSchemaDumpParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateSchemaDumpHandlerFunc) Handle(params WeaviateSchemaDumpParams, principal interface{}) middleware.Responder {
...
type WeaviateSchemaDumpHandler interface {
	Handle(WeaviateSchemaDumpParams, interface{}) middleware.Responder
}
