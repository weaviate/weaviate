...
type WeaviateThingHistoryGetHandlerFunc func(WeaviateThingHistoryGetParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateThingHistoryGetHandlerFunc) Handle(params WeaviateThingHistoryGetParams, principal *models.Principal) middleware.Responder {
...
type WeaviateThingHistoryGetHandler interface {
	Handle(WeaviateThingHistoryGetParams, *models.Principal) middleware.Responder
}
