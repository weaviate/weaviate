...
func (o *WeaviateThingsPropertiesUpdateURL) WithBasePath(bp string) *WeaviateThingsPropertiesUpdateURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *WeaviateThingsPropertiesUpdateURL) Build() (*url.URL, error) {
	...
	if propertyName != "" {
		...
		return nil, errors.New("PropertyName is required on WeaviateThingsPropertiesUpdateURL")
	}
	...
	if thingID != "" {
		...
		return nil, errors.New("ThingID is required on WeaviateThingsPropertiesUpdateURL")
	}
...
func (o *WeaviateThingsPropertiesUpdateURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *WeaviateThingsPropertiesUpdateURL) String() string {
...
func (o *WeaviateThingsPropertiesUpdateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on WeaviateThingsPropertiesUpdateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on WeaviateThingsPropertiesUpdateURL")
	}
