...
func (o *WeaviateThingsReferencesDeleteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WeaviateThingsReferencesDeleteParams) validateID(formats strfmt.Registry) error {
