...
func (o *WeaviateThingsPatchURL) WithBasePath(bp string) *WeaviateThingsPatchURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *WeaviateThingsPatchURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on WeaviateThingsPatchURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on WeaviateThingsPatchURL")
	}
