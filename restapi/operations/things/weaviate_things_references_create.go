...
type WeaviateThingsReferencesCreateHandlerFunc func(WeaviateThingsReferencesCreateParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateThingsReferencesCreateHandlerFunc) Handle(params WeaviateThingsReferencesCreateParams) middleware.Responder {
	return fn(params)
}
...
type WeaviateThingsReferencesCreateHandler interface {
	Handle(WeaviateThingsReferencesCreateParams) middleware.Responder
}
...
/*WeaviateThingsReferencesCreate swagger:route POST /things/{thingId}/references/{propertyName} things weaviateThingsReferencesCreate
