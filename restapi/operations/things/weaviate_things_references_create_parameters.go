...
func (o *WeaviateThingsReferencesCreateParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WeaviateThingsReferencesCreateParams) validateID(formats strfmt.Registry) error {
