...
type WeaviateThingsReferencesDeleteHandlerFunc func(WeaviateThingsReferencesDeleteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateThingsReferencesDeleteHandlerFunc) Handle(params WeaviateThingsReferencesDeleteParams) middleware.Responder {
	return fn(params)
}
...
type WeaviateThingsReferencesDeleteHandler interface {
	Handle(WeaviateThingsReferencesDeleteParams) middleware.Responder
}
...
/*WeaviateThingsReferencesDelete swagger:route DELETE /things/{thingId}/references/{propertyName} things weaviateThingsReferencesDelete
