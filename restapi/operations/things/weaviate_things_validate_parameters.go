...
// WeaviateThingsValidateParams contains all the bound params for the weaviate things validate operation
...
func (o *WeaviateThingsValidateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
