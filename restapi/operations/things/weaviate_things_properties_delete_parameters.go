...
// WeaviateThingsPropertiesDeleteParams contains all the bound params for the weaviate things properties delete operation
...
func (o *WeaviateThingsPropertiesDeleteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WeaviateThingsPropertiesDeleteParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *WeaviateThingsPropertiesDeleteParams) bindThingID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *WeaviateThingsPropertiesDeleteParams) validateThingID(formats strfmt.Registry) error {
