...
type WeaviateThingsValidateHandlerFunc func(WeaviateThingsValidateParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateThingsValidateHandlerFunc) Handle(params WeaviateThingsValidateParams, principal *models.Principal) middleware.Responder {
...
type WeaviateThingsValidateHandler interface {
	Handle(WeaviateThingsValidateParams, *models.Principal) middleware.Responder
}
