...
// cascadeMergeBaseDigests pin the SHA-256 digests of the ordered result IDs
// the unseeded cascade returns for these fixtures, generated by running
// cascadeResultDigest at merge base 73d07e09e rather than against a
// reimplementation of it. Both switch states must reproduce them.
...
// cascadeDigestValues covers cascadeEdgeValues alongside a deterministic
// random spread.
