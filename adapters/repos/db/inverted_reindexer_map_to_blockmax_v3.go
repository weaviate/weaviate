...
func NewShardInvertedReindexTaskMapToBlockmaxV3(logger logrus.FieldLogger,
...
type mapToBlockmaxConfigV3 struct {
	swapBuckets                   bool
	unswapBuckets                 bool
	tidyBuckets                   bool
	rollback                      bool
...
func (t *ShardReindexTask_MapToBlockmax) OnBeforeLsmInit(ctx context.Context, shard ShardLike) (err error) {
...
func (t *ShardReindexTask_MapToBlockmax) OnAfterLsmInit(ctx context.Context, shard ShardLike) (err error) {
	collectionName := shard.Index().Config.ClassName.String()
	logger := t.logger.WithFields(map[string]any{
		"collection": collectionName,
		"shard":      shard.Name(),
...
func (t *ShardReindexTask_MapToBlockmax) duplicateToIngestBuckets(ctx context.Context,
	logger logrus.FieldLogger, shard ShardLike, props []string,
) error {
	return t.duplicateToBuckets(shard, props, t.ingestBucketName, t.calcPropLenInverted)
}

func (t *ShardReindexTask_MapToBlockmax) duplicateToMapBuckets(ctx context.Context,
	logger logrus.FieldLogger, shard ShardLike, props []string,
) error {
	return t.duplicateToBuckets(shard, props, t.mapBucketName, t.calcPropLenMap)
}

func (t *ShardReindexTask_MapToBlockmax) duplicateToBuckets(shard ShardLike, props []string,
