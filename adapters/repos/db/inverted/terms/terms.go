...
func (t *Terms) ScoreNext(averagePropLength float64, additionalExplanations bool, MinimumOrTokenMatch int) (uint64, float64, []*DocPointerWithScore, bool) {
	...
	if len(t.T)-pos < MinimumOrTokenMatch {
		return 0, 0, docInfos, false
	}
	...
	if matchedTerms < MinimumOrTokenMatch {
