...
func (b *BM25Searcher) wandBlock(
	...
	objects, scores := b.combineResults(ctx, allIds, allScores, allExplanation, termCounts, additional, limit)
...
func (b *BM25Searcher) combineResults(ctx context.Context, allIds [][][]uint64, allScores [][][]float32, allExplanation [][][][]*terms.DocPointerWithScore, queryTerms [][]string, additional additional.Properties, limit int) ([]*storobj.Object, []float32) {
	// combine all results
