...
LBB0_4:
	...
	LONG $0xf9dbbdc5               // vpand	%ymm1, %ymm8, %ymm7
	LONG $0x006de2c4; BYTE $0xff   // vpshufb	%ymm7, %ymm2, %ymm7
	...
	LONG $0xf9dbb5c5               // vpand	%ymm1, %ymm9, %ymm7
	LONG $0x006de2c4; BYTE $0xff   // vpshufb	%ymm7, %ymm2, %ymm7
	LONG $0x713dc1c4; WORD $0x04d1 // vpsrlw	$4, %ymm9, %ymm8
	LONG $0xc1db3dc5               // vpand	%ymm1, %ymm8, %ymm8
	LONG $0x006d42c4; BYTE $0xc0   // vpshufb	%ymm8, %ymm2, %ymm8
	LONG $0xfffcbdc5               // vpaddb	%ymm7, %ymm8, %ymm7
	LONG $0xf8f6c5c5               // vpsadbw	%ymm0, %ymm7, %ymm7
	LONG $0xedd4c5c5               // vpaddq	%ymm5, %ymm7, %ymm5
	LONG $0xf9dbadc5               // vpand	%ymm1, %ymm10, %ymm7
	LONG $0x006de2c4; BYTE $0xff   // vpshufb	%ymm7, %ymm2, %ymm7
	LONG $0x713dc1c4; WORD $0x04d2 // vpsrlw	$4, %ymm10, %ymm8
	LONG $0xc1db3dc5               // vpand	%ymm1, %ymm8, %ymm8
	LONG $0x006d42c4; BYTE $0xc0   // vpshufb	%ymm8, %ymm2, %ymm8
	LONG $0xfffcbdc5               // vpaddb	%ymm7, %ymm8, %ymm7
	LONG $0xf8f6c5c5               // vpsadbw	%ymm0, %ymm7, %ymm7
...
LBB0_23:
	...
	LONG $0xfadbbdc5               // vpand	%ymm2, %ymm8, %ymm7
	LONG $0x0065e2c4; BYTE $0xff   // vpshufb	%ymm7, %ymm3, %ymm7
	LONG $0x713dc1c4; WORD $0x04d0 // vpsrlw	$4, %ymm8, %ymm8
	...
	LONG $0xf9f6c5c5               // vpsadbw	%ymm1, %ymm7, %ymm7
	LONG $0xe4d4c5c5               // vpaddq	%ymm4, %ymm7, %ymm4
	LONG $0xfadbb5c5               // vpand	%ymm2, %ymm9, %ymm7
	LONG $0x0065e2c4; BYTE $0xff   // vpshufb	%ymm7, %ymm3, %ymm7
	LONG $0x713dc1c4; WORD $0x04d1 // vpsrlw	$4, %ymm9, %ymm8
	LONG $0xc2db3dc5               // vpand	%ymm2, %ymm8, %ymm8
	LONG $0x006542c4; BYTE $0xc0   // vpshufb	%ymm8, %ymm3, %ymm8
	...
	LONG $0xf9f6c5c5               // vpsadbw	%ymm1, %ymm7, %ymm7
	LONG $0xedd4c5c5               // vpaddq	%ymm5, %ymm7, %ymm5
	LONG $0xfadbadc5               // vpand	%ymm2, %ymm10, %ymm7
	LONG $0x0065e2c4; BYTE $0xff   // vpshufb	%ymm7, %ymm3, %ymm7
	LONG $0x713dc1c4; WORD $0x04d2 // vpsrlw	$4, %ymm10, %ymm8
	LONG $0xc2db3dc5               // vpand	%ymm2, %ymm8, %ymm8
	LONG $0x006542c4; BYTE $0xc0   // vpshufb	%ymm8, %ymm3, %ymm8
