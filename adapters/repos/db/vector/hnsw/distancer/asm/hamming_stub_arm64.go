...
//go:generate goat ../c/hamming_byte_arm64.c -O3 -e="-mfpu=neon-fp-armv8" -e="-mfloat-abi=hard" -e="--target=arm64" -e="-march=armv8-a+simd+fp"
...
// Hamming calculates the hamming distance between two vectors
// using SIMD instructions.
func HammingByteARM64(x []byte, y []byte) uint32 {
	// switch len(x) {
	// case 2:
	// 	return hamming2(x, y)
	// case 4:
