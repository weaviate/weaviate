...
// Hand-written kernels. The AVX-VNNI VPDPBUSD instructions are BYTE-encoded
// (no VEX mnemonic in the Go assembler); the encoding formula is documented
// with the "Two encodings" note below.
//
...
//     instruction is BYTE-encoded as VEX.66.0F38.W0 50 /r, emitted below
//     as LONG $le32(0xC4, b1, b2, 0x50); BYTE $modrm with
//
//	VPDPBUSD src2, src1, dst (Go operand order):
//	b1    = 0xE2, minus 0x80 if dst >= 8, minus 0x20 if src2 >= 8
//	b2    = (^src1 & 15) << 3, plus 0x05 for YMM or 0x01 for XMM
//	modrm = 0xC0 | (dst & 7) << 3 | (src2 & 7)
