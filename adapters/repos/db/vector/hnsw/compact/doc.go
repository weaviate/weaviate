...
// Package compact manages HNSW commit log storage: reading, writing, merging,
...
// graphs or clusters.
//
// The core goal of compact is on-disk stream merging. The challenge is that
...
// original commit logs still existed, wasting storage. In compact, a snapshot
