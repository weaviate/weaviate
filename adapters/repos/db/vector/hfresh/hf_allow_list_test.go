...
func TestPostingPassesFilterSlice_IgnoresDisallowedVectors(t *testing.T) {
	...
	pm.AddVectorID(ctx, 0, 10, 0)
	pm.AddVectorID(ctx, 0, 11, 0)
	pm.AddVectorID(ctx, 1, 12, 0)
