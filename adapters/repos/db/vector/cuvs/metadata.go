...
func (index *cuvs_index) getMetadataFile() string {
...
func (index *cuvs_index) removeMetadataFile() error {
...
func (index *cuvs_index) initMetadata() error {
	path := filepath.Join(index.rootPath, index.getMetadataFile())
	var err error
...
func (index *cuvs_index) initDimensions() {
...
func (index *cuvs_index) fetchDimensions() (int32, error) {
...
func (index *cuvs_index) calculateDimensions() int32 {
...
func (index *cuvs_index) setDimensions(dimensions int32) error {
	if index.metadata == nil {
		return nil
	}
