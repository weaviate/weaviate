...
func New(cfg Config, uc flatent.UserConfig, store *lsmkv.Store) (*flat, error) {
	...
	if err := index.initBuckets(context.Background(), cfg.MinMMapSize, cfg.MaxWalReuseSize, cfg.AllocChecker, cfg.ImplicitShardLoading); err != nil {
...
func (index *flat) initBuckets(ctx context.Context, minMMapSize int64, minWalThreshold int64, allocchecker memwatch.AllocChecker, implicitShardLoading bool) error {
