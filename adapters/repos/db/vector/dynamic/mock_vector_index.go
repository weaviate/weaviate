...
// SearchByMultiVectorDistance provides a mock function with given fields: ctx, vector, targetDistance, maxLimit, allowList
func (_m *MockVectorIndex) SearchByMultiVectorDistance(ctx context.Context, vector [][]float32, targetDistance float32, maxLimit int64, allowList helpers.AllowList) ([]uint64, []float32, error) {
	ret := _m.Called(ctx, vector, targetDistance, maxLimit, allowList)
	...
	if rf, ok := ret.Get(0).(func(context.Context, [][]float32, float32, int64, helpers.AllowList) ([]uint64, []float32, error)); ok {
		return rf(ctx, vector, targetDistance, maxLimit, allowList)
	}
	if rf, ok := ret.Get(0).(func(context.Context, [][]float32, float32, int64, helpers.AllowList) []uint64); ok {
		r0 = rf(ctx, vector, targetDistance, maxLimit, allowList)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]uint64)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, [][]float32, float32, int64, helpers.AllowList) []float32); ok {
		r1 = rf(ctx, vector, targetDistance, maxLimit, allowList)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]float32)
		}
	...
	if rf, ok := ret.Get(2).(func(context.Context, [][]float32, float32, int64, helpers.AllowList) error); ok {
		r2 = rf(ctx, vector, targetDistance, maxLimit, allowList)
	} else {
		r2 = ret.Error(2)
	}
...
func (_e *MockVectorIndex_Expecter) SearchByMultiVectorDistance(ctx interface{}, vector interface{}, targetDistance interface{}, maxLimit interface{}, allowList interface{}) *MockVectorIndex_SearchByMultiVectorDistance_Call {
	return &MockVectorIndex_SearchByMultiVectorDistance_Call{Call: _e.mock.On("SearchByMultiVectorDistance", ctx, vector, targetDistance, maxLimit, allowList)}
}

func (_c *MockVectorIndex_SearchByMultiVectorDistance_Call) Run(run func(ctx context.Context, vector [][]float32, targetDistance float32, maxLimit int64, allowList helpers.AllowList)) *MockVectorIndex_SearchByMultiVectorDistance_Call {
	_c.Call.Run(func(args mock.Arguments) {
