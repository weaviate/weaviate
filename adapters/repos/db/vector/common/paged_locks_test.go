...
func TestPagedLocks_ParallelLocksAll(t *testing.T) {
	// no asserts
	// ensures parallel LockAll does not fall into deadlock
	count := 10
	sl := NewDefaultPagedLocks()
...
func TestPagedLocks_MixedLocks(t *testing.T) {
	// no asserts
...
func TestPagedLocks(t *testing.T) {
...
func TestPagedRWLocks_ParallelLocksAll(t *testing.T) {
	// no asserts
	// ensures parallel LockAll does not fall into deadlock
	count := 10
	sl := NewDefaultPagedRWLocks()
...
func TestPagedRWLocks_ParallelRLocksAll(t *testing.T) {
	// no asserts
...
func TestPagedRWLocks_ParallelLocksAllAndRLocksAll(t *testing.T) {
	// no asserts
...
func TestPagedRWLocks_MixedLocks(t *testing.T) {
	// no asserts
	// ensures parallel LockAll + RLockAll + Lock + RLock does not fall into deadlock
	count := 1000
	sl := NewPagedRWLocks(10)
...
func TestPagedRWLocks(t *testing.T) {
