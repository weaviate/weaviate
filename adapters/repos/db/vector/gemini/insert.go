...
//GW func (h *hnsw) ValidateBeforeInsert(vector []float32) error {
func (h *gemini) ValidateBeforeInsert(vector []float32) error {
//GW
	//GW
...
//GW
//GWfunc (h *hnsw) Add(id uint64, vector []float32) error {
func (h *gemini) Add(id uint64, vector []float32) error {
//GW
	//GW
...
//GW func (h *hnsw) insertInitialElement(node *vertex, nodeVec []float32) error {
func (h *gemini) insertInitialElement(node *vertex, nodeVec []float32) error {
//GW
	h.Lock()
	defer h.Unlock()
...
//GW func (h *hnsw) insert(node *vertex, nodeVec []float32) error {
func (h *gemini) insert(node *vertex, nodeVec []float32) error {
//GW
	//GW
