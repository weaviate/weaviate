...
//GWfunc (h *hnsw) Delete(id uint64) error {
func (h *gemini) Delete(id uint64) error {
//GW
...
//GW func (h *hnsw) resetIfEmpty() (empty bool, err error) {
func (h *gemini) resetIfEmpty() (empty bool, err error) {
//GW
	h.resetLock.Lock()
	h.Lock()
	defer h.Unlock()
...
//GW
//GW func (h *hnsw) resetIfOnlyNode(needle *vertex, denyList helpers.AllowList) (onlyNode bool, err error) {
func (h *gemini) resetIfOnlyNode(needle *vertex, denyList helpers.AllowList) (onlyNode bool, err error) {
//GW
	h.resetLock.Lock()
	h.Lock()
	defer h.Unlock()
...
//GW func (h *hnsw) resetUnsecured() error {
func (h *gemini) resetUnsecured() error {
//GW
	h.resetCtxCancel()
...
//GW func (h *hnsw) tombstonesAsDenyList() helpers.AllowList {
func (h *gemini) tombstonesAsDenyList() helpers.AllowList {
//GW
...
//GW func (h *hnsw) getEntrypoint() uint64 {
func (h *gemini) getEntrypoint() uint64 {
//GW
	h.RLock()
	defer h.RUnlock()
...
//GW func (h *hnsw) copyTombstonesToAllowList(breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, deleteList helpers.AllowList) {
func (h *gemini) copyTombstonesToAllowList(breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, deleteList helpers.AllowList) {
//GW
	h.resetLock.Lock()
	defer h.resetLock.Unlock()
...
//GW func (h *hnsw) CleanUpTombstonedNodes(stopFunc cyclemanager.StopFunc) error {
func (h *gemini) CleanUpTombstonedNodes(stopFunc cyclemanager.StopFunc) error {
//GW
...
//GW func (h *hnsw) replaceDeletedEntrypoint(deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
func (h *gemini) replaceDeletedEntrypoint(deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
//GW
	h.resetLock.Lock()
	defer h.resetLock.Unlock()
...
//GW
//GWfunc (h *hnsw) reassignNeighborsOf(deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
func (h *gemini) reassignNeighborsOf(deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
//GW
	h.RLock()
	size := len(h.nodes)
	h.RUnlock()
...
//GW
//GWfunc (h *hnsw) reassignNeighbor(neighbor uint64, deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
func (h *gemini) reassignNeighbor(neighbor uint64, deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
//GW
	h.resetLock.Lock()
	defer h.resetLock.Unlock()
...
// up
//GW func (h *hnsw) deleteEntrypoint(node *vertex, denyList helpers.AllowList) error {
func (h *gemini) deleteEntrypoint(node *vertex, denyList helpers.AllowList) error {
//GW
...
//GW func (h *hnsw) findNewGlobalEntrypoint(denyList helpers.AllowList, targetLevel int,
func (h *gemini) findNewGlobalEntrypoint(denyList helpers.AllowList, targetLevel int,
//GW
...
// returns entryPointID, level and whether a change occurred
//GW
//GWfunc (h *hnsw) findNewLocalEntrypoint(denyList helpers.AllowList, targetLevel int,
func (h *gemini) findNewLocalEntrypoint(denyList helpers.AllowList, targetLevel int,
//GW
	oldEntrypoint uint64,
) (uint64, int) {
	if h.getEntrypoint() != oldEntrypoint {
...
//GW func (h *hnsw) isOnlyNode(needle *vertex, denyList helpers.AllowList) bool {
func (h *gemini) isOnlyNode(needle *vertex, denyList helpers.AllowList) bool {
//GW
	h.RLock()
	defer h.RUnlock()
...
//GW func (h *hnsw) isOnlyNodeUnsecured(needle *vertex, denyList helpers.AllowList) bool {
func (h *gemini) isOnlyNodeUnsecured(needle *vertex, denyList helpers.AllowList) bool {
//GW
...
//GW func (h *hnsw) hasTombstone(id uint64) bool {
func (h *gemini) hasTombstone(id uint64) bool {
//GW
...
//GW func (h *hnsw) addTombstone(id uint64) error {
func (h *gemini) addTombstone(id uint64) error {
//GW
...
//GW func (h *hnsw) removeTombstonesAndNodes(deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
func (h *gemini) removeTombstonesAndNodes(deleteList helpers.AllowList, breakCleanUpTombstonedNodes breakCleanUpTombstonedNodesFunc) (ok bool, err error) {
//GW
	for id := range deleteList {
