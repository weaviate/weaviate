...
//GW func (h *hnsw) findAndConnectNeighbors(node *vertex,
func (h *gemini) findAndConnectNeighbors(node *vertex,
//GW
...
//GW
//GW func newNeighborFinderConnector(graph *hnsw, node *vertex, entryPointID uint64,
func newNeighborFinderConnector(graph *gemini, node *vertex, entryPointID uint64,
//GW
