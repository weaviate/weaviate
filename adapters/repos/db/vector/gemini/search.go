...
//GW
//GW func (h *hnsw) searchTimeEF(k int) int {
func (h *gemini) searchTimeEF(k int) int {
//GW
...
//GW func (h *hnsw) autoEfFromK(k int) int {
func (h *gemini) autoEfFromK(k int) int {
//GW
...
//GW func (h *hnsw) SearchByVector(vector []float32, k int, allowList helpers.AllowList) ([]uint64, []float32, error) {
func (h *gemini) SearchByVector(vector []float32, k int, allowList helpers.AllowList) ([]uint64, []float32, error) {
//GW
...
//GW func (h *hnsw) SearchByVectorDistance(vector []float32, targetDistance float32, maxLimit int64,
func (h *gemini) SearchByVectorDistance(vector []float32, targetDistance float32, maxLimit int64,
//GW
...
//GW func (h *hnsw) searchLayerByVector(queryVector []float32,
func (h *gemini) searchLayerByVector(queryVector []float32,
//GW
...
//GW func (h *hnsw) insertViableEntrypointsAsCandidatesAndResults(
func (h *gemini) insertViableEntrypointsAsCandidatesAndResults(
//GW
...
//GW func (h *hnsw) currentWorstResultDistance(results *priorityqueue.Queue,
func (h *gemini) currentWorstResultDistance(results *priorityqueue.Queue,
//GW
...
//GW func (h *hnsw) distanceToNode(distancer distancer.Distancer,
func (h *gemini) distanceToNode(distancer distancer.Distancer,
//GW
	nodeID uint64,
) (float32, bool, error) {
...
//GW func (h *hnsw) handleDeletedNode(docID uint64) {
func (h *gemini) handleDeletedNode(docID uint64) {
//GW
...
//GW func (h *hnsw) knnSearchByVector(searchVec []float32, k int,
func (h *gemini) knnSearchByVector(searchVec []float32, k int,
//GW
