...
// id
type CoordinatesForID func(ctx context.Context, id int64) (*models.GeoCoordinates, error)
...
func (cfid CoordinatesForID) VectorForID(ctx context.Context, id int64) ([]float32, error) {
