...
func NewLazyLoadShard(ctx context.Context, promMetrics *monitoring.PrometheusMetrics,
	...
	shardLoadLimiter ShardLoadLimiter, shardReindexer ShardReindexerV3, implicitShardLoading bool,
) *LazyLoadShard {
	if memMonitor == nil {
	...
	return &LazyLoadShard{
		...
		shardLoadLimiter:     shardLoadLimiter,
		implicitShardLoading: implicitShardLoading,
	}
}
...
func (l *LazyLoadShard) Load(ctx context.Context) error {
	...
	shard, err := NewShard(ctx, l.shardOpts.promMetrics, l.shardOpts.name, l.shardOpts.index,
		...
		l.shardOpts.indexCheckpoints, l.shardOpts.shardReindexer, l.implicitShardLoading)
	if err != nil {
...
func (l *LazyLoadShard) initPropertyBuckets(ctx context.Context, eg *enterrors.ErrorGroupWrapper, implicitShardLoading bool, props ...*models.Property) {
	l.mustLoad()
	l.shard.initPropertyBuckets(ctx, eg, implicitShardLoading, props...)
}
