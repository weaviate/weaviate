	...
	if objects != nil {
		for _, class := range objects.Classes {
			...
			idx, err := NewIndex(ctx, IndexConfig{
				...
				HNSWTombstoneDeletionConcurrency:             db.config.HNSWTombstoneDeletionConcurrency,
				HNSWTombstoneDeletionMinPerCycle:             db.config.HNSWTombstoneDeletionMinPerCycle,
				HNSWTombstoneDeletionMaxPerCycle:             db.config.HNSWTombstoneDeletionMaxPerCycle,
