	...
	if objects != nil {
		for _, class := range objects.Classes {
			...
			idx, err := NewIndex(ctx, IndexConfig{
				...
				SegmentIndexPinThreshold:       db.config.SegmentIndexPinThreshold,
				SegmentIndexPinTotalLimit:      db.config.SegmentIndexPinTotalLimit,
				SegmentIndexPinScope:           db.config.SegmentIndexPinScope,
