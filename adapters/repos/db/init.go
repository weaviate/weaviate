	...
	if objects != nil {
		for _, class := range objects.Classes {
			...
			idx, err := NewIndex(ctx, IndexConfig{
				...
				ShardLocalLimitVectorSearchEnabled:           db.config.ShardLocalLimitVectorSearchEnabled,
				ShardLocalLimitObjectListEnabled:             db.config.ShardLocalLimitObjectListEnabled,
				ShardLocalLimitHybridBM25Enabled:             db.config.ShardLocalLimitHybridBM25Enabled,
				ShardLocalLimitSafetyMargin:                  db.config.ShardLocalLimitSafetyMargin,
			},
