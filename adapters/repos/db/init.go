	...
	if objects != nil {
		for _, class := range objects.Classes {
			...
			idx, err := NewIndex(ctx, IndexConfig{
				...
				FullReplicasSearchDebounceFactor:     db.config.FullReplicasSearchDebounceFactor,
				FullReplicasSearchDebounceMinTimeout: db.config.FullReplicasSearchDebounceMinTimeout,
