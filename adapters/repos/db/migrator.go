...
func (m *Migrator) AddClass(ctx context.Context, class *models.Class) error {
	...
	idx, err := NewIndex(ctx,
		IndexConfig{
			...
			HNSWTombstoneDeletionConcurrency:             m.db.config.HNSWTombstoneDeletionConcurrency,
			HNSWTombstoneDeletionMinPerCycle:             m.db.config.HNSWTombstoneDeletionMinPerCycle,
			HNSWTombstoneDeletionMaxPerCycle:             m.db.config.HNSWTombstoneDeletionMaxPerCycle,
