...
func (m *Migrator) AddClass(ctx context.Context, class *models.Class,
	...
	idx, err := NewIndex(ctx,
		IndexConfig{
			...
			FullReplicasSearchDebounceFactor:     m.db.config.FullReplicasSearchDebounceFactor,
			FullReplicasSearchDebounceMinTimeout: m.db.config.FullReplicasSearchDebounceMinTimeout,
