...
func (m *Migrator) AddClass(ctx context.Context, class *models.Class) error {
	...
	idx, err = NewIndex(ctx,
		IndexConfig{
			...
			SegmentIndexPinThreshold:       m.db.config.SegmentIndexPinThreshold,
			SegmentIndexPinTotalLimit:      m.db.config.SegmentIndexPinTotalLimit,
			SegmentIndexPinScope:           m.db.config.SegmentIndexPinScope,
