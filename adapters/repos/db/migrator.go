...
func (m *Migrator) ReindexerV2(tasksNames []string, args map[string]any, schemaManager *schemaUC.Manager) (*ReindexerV2, error) {
	reindexer := NewReindexerV2(m.logger, m.db.indices, &m.db.indexLock, schemaManager)
