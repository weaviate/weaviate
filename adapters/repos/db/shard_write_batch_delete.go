...
func (s *RealShard) DeleteObjectBatch(ctx context.Context,docIDs []uint64, dryRun bool) objects.BatchSimpleObjects {
	if s.isReadOnly() {
...
func (s *RealShard) FindDocIDs(ctx context.Context,filters *filters.LocalFilter) ([]uint64, error) {
