...
func (s *lazySegment) initCountNetAdditions(exists existsOnLowerSegmentsFn, overwrite bool, precomputedCNA bool, precomputedCNAValue int) error {
	s.mustLoad()
	return s.segment.initCountNetAdditions(exists, overwrite, precomputedCNA, precomputedCNAValue)
}
