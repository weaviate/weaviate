...
func isCommitLogCompatibleReplace(wal io.ReadSeeker) (compatible bool, err error) {
	...
	memtable, err := newMemtable("", StrategyReplace, 0, &noopMemtableCommitLogger{}, nil, nil, false, nil, false, nil, false)
	if err != nil {
		return false, err
	}
...
func isCommitLogCompatibleCollection(wal io.ReadSeeker, collectionStrategy string) (compatible bool, err error) {
	...
	memtable, err := newMemtable("", collectionStrategy, 0, &noopMemtableCommitLogger{}, nil, nil, false, nil, false, nil, false)
	if err != nil {
		return false, err
	}
