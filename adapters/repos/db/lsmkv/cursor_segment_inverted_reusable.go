...
func (s *segmentCursorInvertedReusable) seek(key []byte) ([]byte, []value, error) {
...
func (s *segmentCursorInvertedReusable) next() ([]byte, []value, error) {
...
func (s *segmentCursorInvertedReusable) first() ([]byte, []value, error) {
...
func (s *segmentCursorInvertedReusable) parseInvertedNodeInto(offset nodeOffset) error {
	...
	return ParseInvertedNodeInto(r, &s.nodeBuf)
}
