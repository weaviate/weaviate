...
func (b *Bucket) IterateObjects(ctx context.Context, f func(object *storobj.Object) error) error {
	...
	return b.IterateObjectsWithCursor(ctx, cursor, f)
}

func (b *Bucket) IterateObjectsWithCursor(ctx context.Context, cursor *CursorReplace, f func(object *storobj.Object) error) error {
	i := 0
