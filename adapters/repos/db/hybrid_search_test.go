...
func TestHybrid(t *testing.T) {
	...
	}, &fakeRemoteClient{}, &fakeNodeResolver{}, &fakeRemoteNodeClient{}, nil, nil, nil, cluster.NewMockNodeSelector(t), types.NewMockSchemaReader(t), types2.NewMockReplicationFSMReader(t))
	require.Nil(t, err)
...
func TestRFJourney(t *testing.T) {
	...
	t.Run("check_secondary_sort", func(t *testing.T) {
		...
		require.Equal(t, doc1.ID, hybridResults[0].ID)
		require.Equal(t, doc2.ID, hybridResults[1].ID)
