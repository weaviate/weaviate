...
func newFilterableRetokenizeTask(t *testing.T, idx *Index, className, propName, targetTokenization string) (*reindex.ShardReindexTaskGeneric, *testFilterableRetokenizeStrategyWrapper) {
	t.Helper()
