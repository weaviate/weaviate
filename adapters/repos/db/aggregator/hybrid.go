...
func (a *Aggregator) bm25Objects(ctx context.Context, kw *searchparams.KeywordRanking) ([]*storobj.Object, []float32, error) {
	...
	objs, dists, err := inverted.NewBM25Searcher(cfg.BM25, a.store, s, propertyspecific.Indices{}, a.classSearcher, nil, a.GetPropertyLengthTracker(), a.logger, a.shardVersion, a.propertyIds).BM25F(ctx, nil, a.params.ClassName, *a.params.ObjectLimit, *kw)
	if err != nil {
