...
func (a *Aggregator) vectorSearch(ctx context.Context, allow helpers.AllowList, vec types.Vector) ([]uint64, []float32, error) {
...
func (a *Aggregator) searchByVector(ctx context.Context, searchVector types.Vector, limit *int, ids helpers.AllowList) ([]uint64, []float32, error) {
...
func (a *Aggregator) searchByVectorDistance(ctx context.Context, searchVector types.Vector, ids helpers.AllowList) ([]uint64, []float32, error) {
	if a.params.Certainty <= 0 {
...
func (a *Aggregator) performVectorSearch(ctx context.Context,
	searchVector types.Vector, limit int, ids helpers.AllowList,
...
func (a *Aggregator) performVectorDistanceSearch(ctx context.Context,
	searchVector types.Vector, targetDist float32, maxLimit int64, ids helpers.AllowList,
) ([]uint64, []float32, error) {
	switch vec := searchVector.(type) {
	case []float32:
