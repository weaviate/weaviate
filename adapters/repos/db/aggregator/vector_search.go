...
func (a *Aggregator) buildAllowList(ctx context.Context) (helpers.AllowList, error) {
	...
	if a.params.Filters != nil {
		...
		allow, err = inverted.NewSearcher(a.logger, a.store, s, nil, a.propertyIds, a.classSearcher, a.stopwords, a.shardVersion, a.isFallbackToSearchable, a.tenant, a.nestedCrossRefLimit, a.bitmapFactory).DocIDs(ctx, a.params.Filters, additional.Properties{}, a.params.ClassName)
		if err != nil {
