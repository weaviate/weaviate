...
func resolveDoubleWriteBucket(shard ShardLike, sidecarName, swapFallbackName string) *lsmkv.Bucket {
...
func resolveScopedDoubleWriteBucket(shard ShardLike, property *inverted.Property,
