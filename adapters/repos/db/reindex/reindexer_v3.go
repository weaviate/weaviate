...
type ShardReindexerV3 interface {
	RunBeforeLsmInit(ctx context.Context, shard ShardLike) error
	RunAfterLsmInit(ctx context.Context, shard ShardLike) error
	RunAfterLsmInitAsync(ctx context.Context, shard ShardLike) error
...
type ShardReindexTaskV3 interface {
	...
	// TODO alisza:blockmax change to ShardLike?
...
func (r *shardReindexerV3Noop) RunBeforeLsmInit(ctx context.Context, shard ShardLike) error {
	return nil
}

func (r *shardReindexerV3Noop) RunAfterLsmInit(ctx context.Context, shard ShardLike) error {
	return nil
}

func (r *shardReindexerV3Noop) RunAfterLsmInitAsync(ctx context.Context, shard ShardLike) error {
	return nil
}

func (r *shardReindexerV3Noop) Stop(shard ShardLike, cause error) {}

// -----------------------------------------------------------------------------

func NewShardReindexerV3(ctx context.Context, logger logrus.FieldLogger,
	getIndex func(className schema.ClassName) IndexLike, concurrency int,
) *shardReindexerV3 {
...
func (r *shardReindexerV3) RunBeforeLsmInit(_ context.Context, shard ShardLike) (err error) {
...
func (r *shardReindexerV3) RunAfterLsmInit(_ context.Context, shard ShardLike) (err error) {
	// TODO aliszka:blockmax merge contexts (reindex + incoming)?
	mergedCtx := r.ctx
...
func (r *shardReindexerV3) Stop(shard ShardLike, cause error) {
	key := toIndexShardKeyOfShard(shard)
	r.locked(func() {
