...
func (r *shardReindexerV3RecoveryOnly) RunBeforeLsmInit(_ context.Context, _ ShardLike) error {
...
func (r *shardReindexerV3RecoveryOnly) RunAfterLsmInit(ctx context.Context, shard ShardLike) error {
	if len(r.tasks) == 0 {
		return nil
	}
...
func (r *shardReindexerV3RecoveryOnly) RunAfterLsmInitAsync(_ context.Context, _ ShardLike) error {
	// Intentionally a no-op. See type doc.
	return nil
}

func (r *shardReindexerV3RecoveryOnly) Stop(_ ShardLike, _ error) {
