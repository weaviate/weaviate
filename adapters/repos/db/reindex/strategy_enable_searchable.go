...
func (s *EnableSearchableStrategy) PreReindexHook(shard ShardLike, props []string) {
...
// once cluster-wide from [AutoCleanupAfterTerminal.OnTaskCompleted] after every
