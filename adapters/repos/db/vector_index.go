...
type VectorIndex interface {
	...
	SearchByVectorDistance(ctx context.Context, vector []float32, dist float32,
		maxLimit int64, allow helpers.AllowList, selector *selection.Selector) ([]uint64, []float32, error)
...
type VectorIndexMulti interface {
	...
	SearchByMultiVector(ctx context.Context, vector [][]float32, k int, allow helpers.AllowList, selector *selection.Selector) ([]uint64, []float32, error)
