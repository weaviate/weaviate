...
// InnerCursor may yield a nil side, and a non-nil side may still be empty:
// implementations differ. Test a side with [sroar.Bitmap.IsEmpty], which reads
// nil and empty alike, never against nil.
