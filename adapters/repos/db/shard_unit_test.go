...
func TestShardPathDimensionsLSM(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			shardName: "shard1",
			expected:  "/data/index/shard1/lsm/dimensions_v2",
		},
		{
			name:      "empty shard name",
			indexPath: "/data/index",
			shardName: "",
			expected:  "/data/index/lsm/dimensions_v2",
		},
		{
			name:      "empty index path",
			indexPath: "",
			shardName: "shard1",
			expected:  "shard1/lsm/dimensions_v2",
		},
		{
			name:      "both empty",
			indexPath: "",
			shardName: "",
			expected:  "lsm/dimensions_v2",
		},
		{
			name:      "relative paths",
			indexPath: "data/index",
		...
		},
		{
			...
			expected:  "/data/index/shard-1_test/lsm/dimensions_v2",
		},
		{
			name:      "with spaces in shard name",
			indexPath: "/data/index",
			shardName: "shard 1",
			expected:  "/data/index/shard 1/lsm/dimensions_v2",
		},
	}
