...
func (r *sortByScores) Less(i, j int) bool {
	return r.scores[i].Distance > r.scores[j].Distance
}
...
func (s *sortObjectsByScore) sort(objects []*storobj.Object, scores search.Distances) ([]*storobj.Object, search.Distances) {
