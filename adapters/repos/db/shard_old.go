...
func hasTargetVectors_unmerged(cfg schema.VectorIndexConfig, targetCfgs map[string]schema.VectorIndexConfig) bool {
...
func (s *Shard) createPropertyIndex_unmerged(ctx context.Context, prop *models.Property, eg *enterrors.ErrorGroupWrapper) {
...
func (s *Shard) UpdateVectorIndexConfig_unmerged(ctx context.Context, updated schema.VectorIndexConfig) error {
	if s.isReadOnly() {
		return storagestate.ErrStatusReadOnly
	}
...
func (s *Shard) UpdateVectorIndexConfigs_unmerged(ctx context.Context, updated map[string]schema.VectorIndexConfig) error {
	if s.isReadOnly() {
		return storagestate.ErrStatusReadOnly
	}
