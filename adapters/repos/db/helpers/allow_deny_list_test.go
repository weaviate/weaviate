...
func TestAllowDenyList_Iterator(t *testing.T) {
	t.Run("empty bitmap iterator", func(t *testing.T) {
		it := NewAllowDenyList().Iterator()
	...
	t.Run("iterating step by step", func(t *testing.T) {
		it := NewAllowDenyList(3, 1, 2, 3).Iterator()
...
func TestAllowDenyList_LimitedIterator(t *testing.T) {
	t.Run("empty bitmap iterator", func(t *testing.T) {
		it := NewAllowDenyList().LimitedIterator(2)
	...
	t.Run("iterating step by step (higher limit)", func(t *testing.T) {
		it := NewAllowDenyList(3, 2, 1).LimitedIterator(4)
	...
	t.Run("iterating step by step (equal limit)", func(t *testing.T) {
		it := NewAllowDenyList(1, 2, 3).LimitedIterator(3)
	...
	t.Run("iterating step by step (lower limit)", func(t *testing.T) {
		it := NewAllowDenyList(3, 2, 1).LimitedIterator(2)
	...
	t.Run("iterating in loop (equal limit)", func(t *testing.T) {
		it := NewAllowDenyList(3, 2, 1).LimitedIterator(3)
		ids := []uint64{}
