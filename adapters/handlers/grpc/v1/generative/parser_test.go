...
import (
	...
	friendli "github.com/weaviate/weaviate/modules/generative-friendliai/parameters"
		...
		},
		{
			...
			in: &pb.GenerativeSearch{
				Single: &pb.GenerativeSearch_Single{
					...
					Queries: []*pb.GenerativeProvider{
						{
							Kind: &pb.GenerativeProvider_Friendli{},
						},
					},
				},
			},
			...
			in: &pb.GenerativeSearch{
				Single: &pb.GenerativeSearch_Single{
					...
					Queries: []*pb.GenerativeProvider{
						{
							Kind: &pb.GenerativeProvider_Friendli{
								Friendli: &pb.GenerativeFriendli{},
							},
						},
					},
				},
