...
type PutObjectRequest struct {
	...
	// Phase-1 conditional-write precondition flags.  Carried as dedicated proto
	// fields because storobj.MarshalBinary intentionally excludes Conditional
...
func (x *PutObjectRequest) GetOnlyIfNotExists() bool {
	if x != nil {
		return x.OnlyIfNotExists
	}
	return false
}

func (x *PutObjectRequest) GetOnlyIfExists() bool {
	if x != nil {
