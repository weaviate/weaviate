...
const (
	...
	FileReplicationService_WaitForReplicationDrain_FullMethodName = "/clusterapi.FileReplicationService/WaitForReplicationDrain"
)
...
type FileReplicationServiceClient interface {
	...
	WaitForReplicationDrain(ctx context.Context, in *WaitForReplicationDrainRequest, opts ...grpc.CallOption) (*WaitForReplicationDrainResponse, error)
}
...
func (c *fileReplicationServiceClient) WaitForReplicationDrain(ctx context.Context, in *WaitForReplicationDrainRequest, opts ...grpc.CallOption) (*WaitForReplicationDrainResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WaitForReplicationDrainResponse)
	err := c.cc.Invoke(ctx, FileReplicationService_WaitForReplicationDrain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileReplicationServiceServer interface {
	...
	WaitForReplicationDrain(context.Context, *WaitForReplicationDrainRequest) (*WaitForReplicationDrainResponse, error)
}
...
func (UnimplementedFileReplicationServiceServer) WaitForReplicationDrain(context.Context, *WaitForReplicationDrainRequest) (*WaitForReplicationDrainResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WaitForReplicationDrain not implemented")
}
...
func _FileReplicationService_WaitForReplicationDrain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitForReplicationDrainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileReplicationServiceServer).WaitForReplicationDrain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileReplicationService_WaitForReplicationDrain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileReplicationServiceServer).WaitForReplicationDrain(ctx, req.(*WaitForReplicationDrainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileReplicationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WaitForReplicationDrain",
			Handler:    _FileReplicationService_WaitForReplicationDrain_Handler,
		},
	},
