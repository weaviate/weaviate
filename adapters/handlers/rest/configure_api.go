...
func MakeAppState(ctx context.Context, options *swag.CommandLineOptionsGroup) *state.State {
	...
	repo, err := db.New(appState.Logger, db.Config{
		...
		HNSWGeoIndexMaxConnections:                   appState.ServerConfig.Config.HNSWGeoIndexMaxConnections,
		HNSWGeoIndexEFConstruction:                   appState.ServerConfig.Config.HNSWGeoIndexEFConstruction,
