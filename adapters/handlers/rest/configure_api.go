...
func initReindexAndDistributedTasks(
	...
	reindexProvider := reindex.NewReindexProvider(
		repo.ReindexHandle(), appState.SchemaManager, appState.ClusterService.Raft, appState.Logger,
	...
	appState.ReindexService = reindexusecase.New(reindexusecase.Deps{
		...
		DeleteMarkers: appState.ReindexDeleteMarkers,
	}, appState.Logger)

	// Read-repair for the v1.38→v1.39 stamp-migration residual; see
	// [reindex.ReindexProvider.RunSearchableBlockmaxRepair].
	enterrors.GoWrapper(func() {
...
func configureAPI(api *operations.WeaviateAPI) http.Handler {
	...
	setupSchemaHandlers(api, appState.SchemaManager, appState.Authorizer, appState.Metrics, appState.Logger, appState.ReindexService, appState.ReindexSubmitLocks, appState.ReindexDeleteMarkers, appState.ServerConfig.Config.Namespaces.Enabled)
