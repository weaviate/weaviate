...
func MakeAppState(ctx, serverShutdownCtx context.Context, options *swag.CommandLineOptionsGroup) *state.State {
	...
	repo, err := db.New(appState.Logger, appState.Cluster.LocalName(), db.Config{
		...
		SegmentIndexPinThreshold:            appState.ServerConfig.Config.Persistence.LSMSegmentIndexPinThreshold,
		SegmentIndexPinTotalLimit:           appState.ServerConfig.Config.Persistence.LSMSegmentIndexPinTotalLimit,
		SegmentIndexPinScope:                appState.ServerConfig.Config.Persistence.LSMSegmentIndexPinScope,
