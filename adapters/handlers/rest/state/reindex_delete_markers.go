...
// is derived from the window's own ceiling rather than independently encoded —
// raising the window can't silently let a post-DELETE phantom outlive its
// marker.
const reindexDeleteMarkerTTL = 3 * reindexusecase.FinalizeWindowMax
