...
// DeactivateUserServiceUnavailableCode is the HTTP code returned for type DeactivateUserServiceUnavailable
const DeactivateUserServiceUnavailableCode int = 503

/*
DeactivateUserServiceUnavailable The operational mode of the server does not allow users operations at this time.

swagger:response deactivateUserServiceUnavailable
*/
...
// NewDeactivateUserServiceUnavailable creates DeactivateUserServiceUnavailable with default headers values
func NewDeactivateUserServiceUnavailable() *DeactivateUserServiceUnavailable {

	return &DeactivateUserServiceUnavailable{}
}

// WithPayload adds the payload to the deactivate user service unavailable response
func (o *DeactivateUserServiceUnavailable) WithPayload(payload *models.ErrorResponse) *DeactivateUserServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the deactivate user service unavailable response
func (o *DeactivateUserServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeactivateUserServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
