...
// ListAllUsersServiceUnavailableCode is the HTTP code returned for type ListAllUsersServiceUnavailable
const ListAllUsersServiceUnavailableCode int = 503

/*
ListAllUsersServiceUnavailable The operational mode of the server does not allow users operations at this time.

swagger:response listAllUsersServiceUnavailable
*/
...
// NewListAllUsersServiceUnavailable creates ListAllUsersServiceUnavailable with default headers values
func NewListAllUsersServiceUnavailable() *ListAllUsersServiceUnavailable {

	return &ListAllUsersServiceUnavailable{}
}

// WithPayload adds the payload to the list all users service unavailable response
func (o *ListAllUsersServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ListAllUsersServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list all users service unavailable response
func (o *ListAllUsersServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ListAllUsersServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
