...
// AliasesGetAliasServiceUnavailableCode is the HTTP code returned for type AliasesGetAliasServiceUnavailable
const AliasesGetAliasServiceUnavailableCode int = 503

/*
AliasesGetAliasServiceUnavailable The operational mode of the server does not allow aliases operations at this time.

swagger:response aliasesGetAliasServiceUnavailable
*/
...
// NewAliasesGetAliasServiceUnavailable creates AliasesGetAliasServiceUnavailable with default headers values
func NewAliasesGetAliasServiceUnavailable() *AliasesGetAliasServiceUnavailable {

	return &AliasesGetAliasServiceUnavailable{}
}

// WithPayload adds the payload to the aliases get alias service unavailable response
func (o *AliasesGetAliasServiceUnavailable) WithPayload(payload *models.ErrorResponse) *AliasesGetAliasServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the aliases get alias service unavailable response
func (o *AliasesGetAliasServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *AliasesGetAliasServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
