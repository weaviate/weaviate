...
// TenantsGetOneParams contains all the bound params for the tenants get one operation
...
func (o *TenantsGetOneParams) bindClassName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *TenantsGetOneParams) bindConsistency(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewTenantsGetOneParams()
		return nil
	}
...
func (o *TenantsGetOneParams) bindTenantName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
