...
// TenantsUpdateServiceUnavailableCode is the HTTP code returned for type TenantsUpdateServiceUnavailable
const TenantsUpdateServiceUnavailableCode int = 503

/*
TenantsUpdateServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response tenantsUpdateServiceUnavailable
*/
...
// NewTenantsUpdateServiceUnavailable creates TenantsUpdateServiceUnavailable with default headers values
func NewTenantsUpdateServiceUnavailable() *TenantsUpdateServiceUnavailable {

	return &TenantsUpdateServiceUnavailable{}
}

// WithPayload adds the payload to the tenants update service unavailable response
func (o *TenantsUpdateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *TenantsUpdateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the tenants update service unavailable response
func (o *TenantsUpdateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *TenantsUpdateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
