...
// SchemaClusterStatusParams contains all the bound params for the schema cluster status operation
...
func (o *SchemaClusterStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
