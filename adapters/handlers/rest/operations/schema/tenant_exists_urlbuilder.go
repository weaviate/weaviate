...
func (o *TenantExistsURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on TenantExistsURL")
	}
	...
	if tenantName != "" {
		...
		return nil, errors.New("tenantName is required on TenantExistsURL")
	}
...
func (o *TenantExistsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on TenantExistsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on TenantExistsURL")
	}
