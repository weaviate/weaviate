...
// SchemaObjectsDeleteServiceUnavailableCode is the HTTP code returned for type SchemaObjectsDeleteServiceUnavailable
const SchemaObjectsDeleteServiceUnavailableCode int = 503

/*
SchemaObjectsDeleteServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response schemaObjectsDeleteServiceUnavailable
*/
...
// NewSchemaObjectsDeleteServiceUnavailable creates SchemaObjectsDeleteServiceUnavailable with default headers values
...
// WithPayload adds the payload to the schema objects delete service unavailable response
func (o *SchemaObjectsDeleteServiceUnavailable) WithPayload(payload *models.ErrorResponse) *SchemaObjectsDeleteServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the schema objects delete service unavailable response
func (o *SchemaObjectsDeleteServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *SchemaObjectsDeleteServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
