...
// SchemaObjectsSnapshotsCreateParams contains all the bound params for the schema objects snapshots create operation
// typically these are obtained from a http.Request
//
// swagger:parameters schema.objects.snapshots.create
...
//
// To ensure default values, the struct must have been initialized with NewSchemaObjectsSnapshotsCreateParams() beforehand.
func (o *SchemaObjectsSnapshotsCreateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SchemaObjectsSnapshotsCreateParams) bindClassName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
