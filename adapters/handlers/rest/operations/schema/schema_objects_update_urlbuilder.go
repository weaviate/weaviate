...
func (o *SchemaObjectsUpdateURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on SchemaObjectsUpdateURL")
	}
...
func (o *SchemaObjectsUpdateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SchemaObjectsUpdateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SchemaObjectsUpdateURL")
	}
