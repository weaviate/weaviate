...
// SchemaDumpServiceUnavailableCode is the HTTP code returned for type SchemaDumpServiceUnavailable
const SchemaDumpServiceUnavailableCode int = 503

/*
SchemaDumpServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response schemaDumpServiceUnavailable
*/
...
// NewSchemaDumpServiceUnavailable creates SchemaDumpServiceUnavailable with default headers values
func NewSchemaDumpServiceUnavailable() *SchemaDumpServiceUnavailable {

	return &SchemaDumpServiceUnavailable{}
}

// WithPayload adds the payload to the schema dump service unavailable response
func (o *SchemaDumpServiceUnavailable) WithPayload(payload *models.ErrorResponse) *SchemaDumpServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the schema dump service unavailable response
func (o *SchemaDumpServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *SchemaDumpServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
