...
// SchemaObjectsGetServiceUnavailableCode is the HTTP code returned for type SchemaObjectsGetServiceUnavailable
const SchemaObjectsGetServiceUnavailableCode int = 503

/*
SchemaObjectsGetServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response schemaObjectsGetServiceUnavailable
*/
...
// NewSchemaObjectsGetServiceUnavailable creates SchemaObjectsGetServiceUnavailable with default headers values
func NewSchemaObjectsGetServiceUnavailable() *SchemaObjectsGetServiceUnavailable {

	return &SchemaObjectsGetServiceUnavailable{}
}

// WithPayload adds the payload to the schema objects get service unavailable response
func (o *SchemaObjectsGetServiceUnavailable) WithPayload(payload *models.ErrorResponse) *SchemaObjectsGetServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the schema objects get service unavailable response
func (o *SchemaObjectsGetServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *SchemaObjectsGetServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
