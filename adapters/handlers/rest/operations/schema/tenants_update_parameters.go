...
// TenantsUpdateParams contains all the bound params for the tenants update operation
...
func (o *TenantsUpdateParams) bindClassName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
