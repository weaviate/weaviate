...
// SchemaObjectsSnapshotsCreateStatusParams contains all the bound params for the schema objects snapshots create status operation
// typically these are obtained from a http.Request
//
// swagger:parameters schema.objects.snapshots.create.status
...
//
// To ensure default values, the struct must have been initialized with NewSchemaObjectsSnapshotsCreateStatusParams() beforehand.
func (o *SchemaObjectsSnapshotsCreateStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SchemaObjectsSnapshotsCreateStatusParams) bindClassName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SchemaObjectsSnapshotsCreateStatusParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SchemaObjectsSnapshotsCreateStatusParams) bindStorageName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
