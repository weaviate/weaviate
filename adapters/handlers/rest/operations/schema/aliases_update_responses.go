...
// AliasesUpdateServiceUnavailableCode is the HTTP code returned for type AliasesUpdateServiceUnavailable
const AliasesUpdateServiceUnavailableCode int = 503

/*
AliasesUpdateServiceUnavailable The operational mode of the server does not allow aliases operations at this time.

swagger:response aliasesUpdateServiceUnavailable
*/
...
// NewAliasesUpdateServiceUnavailable creates AliasesUpdateServiceUnavailable with default headers values
func NewAliasesUpdateServiceUnavailable() *AliasesUpdateServiceUnavailable {

	return &AliasesUpdateServiceUnavailable{}
}

// WithPayload adds the payload to the aliases update service unavailable response
func (o *AliasesUpdateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *AliasesUpdateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the aliases update service unavailable response
func (o *AliasesUpdateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *AliasesUpdateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
