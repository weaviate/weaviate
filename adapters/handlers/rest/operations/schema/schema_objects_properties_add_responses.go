...
// SchemaObjectsPropertiesAddServiceUnavailableCode is the HTTP code returned for type SchemaObjectsPropertiesAddServiceUnavailable
const SchemaObjectsPropertiesAddServiceUnavailableCode int = 503

/*
SchemaObjectsPropertiesAddServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response schemaObjectsPropertiesAddServiceUnavailable
*/
...
// NewSchemaObjectsPropertiesAddServiceUnavailable creates SchemaObjectsPropertiesAddServiceUnavailable with default headers values
...
// WithPayload adds the payload to the schema objects properties add service unavailable response
func (o *SchemaObjectsPropertiesAddServiceUnavailable) WithPayload(payload *models.ErrorResponse) *SchemaObjectsPropertiesAddServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the schema objects properties add service unavailable response
func (o *SchemaObjectsPropertiesAddServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *SchemaObjectsPropertiesAddServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
