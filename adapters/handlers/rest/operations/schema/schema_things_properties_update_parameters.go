...
// SchemaThingsPropertiesUpdateParams contains all the bound params for the schema things properties update operation
// typically these are obtained from a http.Request
//
// swagger:parameters schema.things.properties.update
...
//
// To ensure default values, the struct must have been initialized with NewSchemaThingsPropertiesUpdateParams() beforehand.
func (o *SchemaThingsPropertiesUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SchemaThingsPropertiesUpdateParams) bindClassName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SchemaThingsPropertiesUpdateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
