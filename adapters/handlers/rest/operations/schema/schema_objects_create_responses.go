...
// SchemaObjectsCreateServiceUnavailableCode is the HTTP code returned for type SchemaObjectsCreateServiceUnavailable
const SchemaObjectsCreateServiceUnavailableCode int = 503

/*
SchemaObjectsCreateServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response schemaObjectsCreateServiceUnavailable
*/
type SchemaObjectsCreateServiceUnavailable struct {
...
// NewSchemaObjectsCreateServiceUnavailable creates SchemaObjectsCreateServiceUnavailable with default headers values
func NewSchemaObjectsCreateServiceUnavailable() *SchemaObjectsCreateServiceUnavailable {

	return &SchemaObjectsCreateServiceUnavailable{}
}

// WithPayload adds the payload to the schema objects create service unavailable response
func (o *SchemaObjectsCreateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *SchemaObjectsCreateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the schema objects create service unavailable response
func (o *SchemaObjectsCreateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *SchemaObjectsCreateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
