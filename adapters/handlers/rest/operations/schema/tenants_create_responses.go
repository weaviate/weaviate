...
// TenantsCreateServiceUnavailableCode is the HTTP code returned for type TenantsCreateServiceUnavailable
const TenantsCreateServiceUnavailableCode int = 503

/*
TenantsCreateServiceUnavailable The operational mode of the server does not allow schema operations at this time.

swagger:response tenantsCreateServiceUnavailable
*/
type TenantsCreateServiceUnavailable struct {
...
// NewTenantsCreateServiceUnavailable creates TenantsCreateServiceUnavailable with default headers values
func NewTenantsCreateServiceUnavailable() *TenantsCreateServiceUnavailable {

	return &TenantsCreateServiceUnavailable{}
}

// WithPayload adds the payload to the tenants create service unavailable response
func (o *TenantsCreateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *TenantsCreateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the tenants create service unavailable response
func (o *TenantsCreateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *TenantsCreateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
