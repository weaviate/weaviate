...
func (o *SchemaClusterStatusURL) WithBasePath(bp string) *SchemaClusterStatusURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *SchemaClusterStatusURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SchemaClusterStatusURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SchemaClusterStatusURL")
	}
