...
// ExportStatusParams contains all the bound params for the export status operation
// typically these are obtained from a http.Request
//
// swagger:parameters export.status
...
//
// To ensure default values, the struct must have been initialized with NewExportStatusParams() beforehand.
func (o *ExportStatusParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ExportStatusParams) bindBackend(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
