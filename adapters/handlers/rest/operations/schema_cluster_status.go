...
func (fn SchemaClusterStatusHandlerFunc) Handle(params SchemaClusterStatusParams, principal *models.Principal) middleware.Responder {
...
func NewSchemaClusterStatus(ctx *middleware.Context, handler SchemaClusterStatusHandler) *SchemaClusterStatus {
	return &SchemaClusterStatus{Context: ctx, Handler: handler}
}

/*
	SchemaClusterStatus swagger:route GET /schema/cluster-status schemaClusterStatus
...
func (o *SchemaClusterStatus) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewSchemaClusterStatusParams()
