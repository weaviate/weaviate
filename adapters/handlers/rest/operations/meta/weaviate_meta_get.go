...
type WeaviateMetaGetHandlerFunc func(WeaviateMetaGetParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateMetaGetHandlerFunc) Handle(params WeaviateMetaGetParams, principal *models.Principal) middleware.Responder {
...
type WeaviateMetaGetHandler interface {
	Handle(WeaviateMetaGetParams, *models.Principal) middleware.Responder
}
