...
// WeaviateActionsReferencesCreateParams contains all the bound params for the weaviate actions references create operation
// typically these are obtained from a http.Request
//
// swagger:parameters weaviate.actions.references.create
...
//
// To ensure default values, the struct must have been initialized with NewWeaviateActionsReferencesCreateParams() beforehand.
func (o *WeaviateActionsReferencesCreateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WeaviateActionsReferencesCreateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
