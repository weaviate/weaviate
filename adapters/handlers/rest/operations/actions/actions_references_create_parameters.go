...
// ActionsReferencesCreateParams contains all the bound params for the actions references create operation
// typically these are obtained from a http.Request
//
// swagger:parameters actions.references.create
...
//
// To ensure default values, the struct must have been initialized with NewActionsReferencesCreateParams() beforehand.
func (o *ActionsReferencesCreateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ActionsReferencesCreateParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ActionsReferencesCreateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
