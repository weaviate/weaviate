...
// ActionsReferencesDeleteParams contains all the bound params for the actions references delete operation
// typically these are obtained from a http.Request
//
// swagger:parameters actions.references.delete
...
//
// To ensure default values, the struct must have been initialized with NewActionsReferencesDeleteParams() beforehand.
func (o *ActionsReferencesDeleteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ActionsReferencesDeleteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ActionsReferencesDeleteParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
