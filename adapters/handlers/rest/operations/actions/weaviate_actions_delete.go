...
type WeaviateActionsDeleteHandlerFunc func(WeaviateActionsDeleteParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateActionsDeleteHandlerFunc) Handle(params WeaviateActionsDeleteParams, principal *models.Principal) middleware.Responder {
...
type WeaviateActionsDeleteHandler interface {
	Handle(WeaviateActionsDeleteParams, *models.Principal) middleware.Responder
}
