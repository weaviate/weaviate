...
// ActionsDeleteHandlerFunc turns a function with the right signature into a actions delete handler
...
// ActionsDeleteHandler interface for that can handle valid actions delete params
type ActionsDeleteHandler interface {
	Handle(ActionsDeleteParams, *models.Principal) middleware.Responder
}

// NewActionsDelete creates a new http.Handler for the actions delete operation
...
/*ActionsDelete swagger:route DELETE /actions/{id} actions actionsDelete
