...
// GetRolesForUserDeprecatedServiceUnavailableCode is the HTTP code returned for type GetRolesForUserDeprecatedServiceUnavailable
const GetRolesForUserDeprecatedServiceUnavailableCode int = 503

/*
GetRolesForUserDeprecatedServiceUnavailable The operational mode of the server does not allow users operations at this time.

swagger:response getRolesForUserDeprecatedServiceUnavailable
*/
type GetRolesForUserDeprecatedServiceUnavailable struct {
...
// NewGetRolesForUserDeprecatedServiceUnavailable creates GetRolesForUserDeprecatedServiceUnavailable with default headers values
func NewGetRolesForUserDeprecatedServiceUnavailable() *GetRolesForUserDeprecatedServiceUnavailable {

	return &GetRolesForUserDeprecatedServiceUnavailable{}
}

// WithPayload adds the payload to the get roles for user deprecated service unavailable response
func (o *GetRolesForUserDeprecatedServiceUnavailable) WithPayload(payload *models.ErrorResponse) *GetRolesForUserDeprecatedServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get roles for user deprecated service unavailable response
func (o *GetRolesForUserDeprecatedServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetRolesForUserDeprecatedServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
