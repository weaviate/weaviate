...
// AssignRoleToUserServiceUnavailableCode is the HTTP code returned for type AssignRoleToUserServiceUnavailable
const AssignRoleToUserServiceUnavailableCode int = 503

/*
AssignRoleToUserServiceUnavailable The operational mode of the server does not allow users operations at this time.

swagger:response assignRoleToUserServiceUnavailable
*/
...
// NewAssignRoleToUserServiceUnavailable creates AssignRoleToUserServiceUnavailable with default headers values
func NewAssignRoleToUserServiceUnavailable() *AssignRoleToUserServiceUnavailable {

	return &AssignRoleToUserServiceUnavailable{}
}

// WithPayload adds the payload to the assign role to user service unavailable response
func (o *AssignRoleToUserServiceUnavailable) WithPayload(payload *models.ErrorResponse) *AssignRoleToUserServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the assign role to user service unavailable response
func (o *AssignRoleToUserServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *AssignRoleToUserServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
