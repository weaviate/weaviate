...
/*
GetGroupsOK Role assigned to group
...
// GetGroupsNotFoundCode is the HTTP code returned for type GetGroupsNotFound
const GetGroupsNotFoundCode int = 404

/*
GetGroupsNotFound no group not found

swagger:response getGroupsNotFound
*/
type GetGroupsNotFound struct {
}

// NewGetGroupsNotFound creates GetGroupsNotFound with default headers values
...
// WriteResponse to the client
func (o *GetGroupsNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*
GetGroupsUnprocessableEntity Request body is well-formed (i.e., syntactically correct), but semantically erroneous. Are you sure the class is defined in the configuration file?
