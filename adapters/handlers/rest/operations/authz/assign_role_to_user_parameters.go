...
// AssignRoleToUserParams contains all the bound params for the assign role to user operation
...
func (o *AssignRoleToUserParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
