...
// GetRolesForGroupServiceUnavailableCode is the HTTP code returned for type GetRolesForGroupServiceUnavailable
const GetRolesForGroupServiceUnavailableCode int = 503

/*
GetRolesForGroupServiceUnavailable The operational mode of the server does not allow users operations at this time.

swagger:response getRolesForGroupServiceUnavailable
*/
...
// NewGetRolesForGroupServiceUnavailable creates GetRolesForGroupServiceUnavailable with default headers values
func NewGetRolesForGroupServiceUnavailable() *GetRolesForGroupServiceUnavailable {

	return &GetRolesForGroupServiceUnavailable{}
}

// WithPayload adds the payload to the get roles for group service unavailable response
func (o *GetRolesForGroupServiceUnavailable) WithPayload(payload *models.ErrorResponse) *GetRolesForGroupServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get roles for group service unavailable response
func (o *GetRolesForGroupServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetRolesForGroupServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
