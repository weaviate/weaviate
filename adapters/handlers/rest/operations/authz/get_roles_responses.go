...
// GetRolesServiceUnavailableCode is the HTTP code returned for type GetRolesServiceUnavailable
const GetRolesServiceUnavailableCode int = 503

/*
GetRolesServiceUnavailable The operational mode of the server does not allow authz operations at this time.

swagger:response getRolesServiceUnavailable
*/
...
// NewGetRolesServiceUnavailable creates GetRolesServiceUnavailable with default headers values
func NewGetRolesServiceUnavailable() *GetRolesServiceUnavailable {

	return &GetRolesServiceUnavailable{}
}

// WithPayload adds the payload to the get roles service unavailable response
func (o *GetRolesServiceUnavailable) WithPayload(payload *models.ErrorResponse) *GetRolesServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get roles service unavailable response
func (o *GetRolesServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetRolesServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
