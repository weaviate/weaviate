...
// RevokeRoleFromGroupParams contains all the bound params for the revoke role from group operation
...
func (o *RevokeRoleFromGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body RevokeRoleFromGroupBody
...
func (o *RevokeRoleFromGroupParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
