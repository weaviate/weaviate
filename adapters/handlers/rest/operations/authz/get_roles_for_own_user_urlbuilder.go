...
func (o *GetRolesForOwnUserURL) Build() (*url.URL, error) {
	...
	var _path = "/authz/users/own-roles"
...
func (o *GetRolesForOwnUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRolesForOwnUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRolesForOwnUserURL")
	}
