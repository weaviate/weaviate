...
// GetGroupsForRoleServiceUnavailableCode is the HTTP code returned for type GetGroupsForRoleServiceUnavailable
const GetGroupsForRoleServiceUnavailableCode int = 503

/*
GetGroupsForRoleServiceUnavailable The operational mode of the server does not allow users operations at this time.

swagger:response getGroupsForRoleServiceUnavailable
*/
...
// NewGetGroupsForRoleServiceUnavailable creates GetGroupsForRoleServiceUnavailable with default headers values
func NewGetGroupsForRoleServiceUnavailable() *GetGroupsForRoleServiceUnavailable {

	return &GetGroupsForRoleServiceUnavailable{}
}

// WithPayload adds the payload to the get groups for role service unavailable response
func (o *GetGroupsForRoleServiceUnavailable) WithPayload(payload *models.ErrorResponse) *GetGroupsForRoleServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get groups for role service unavailable response
func (o *GetGroupsForRoleServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *GetGroupsForRoleServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
