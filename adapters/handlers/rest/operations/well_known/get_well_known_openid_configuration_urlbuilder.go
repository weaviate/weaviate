...
func (o *GetWellKnownOpenidConfigurationURL) Build() (*url.URL, error) {
	...
	var _path = "/.well-known/openid-configuration"
...
func (o *GetWellKnownOpenidConfigurationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetWellKnownOpenidConfigurationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetWellKnownOpenidConfigurationURL")
	}
