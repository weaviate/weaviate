...
func (o *ClassificationsPostURL) WithBasePath(bp string) *ClassificationsPostURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ClassificationsPostURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ClassificationsPostURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ClassificationsPostURL")
	}
