...
// ClassificationsPostServiceUnavailableCode is the HTTP code returned for type ClassificationsPostServiceUnavailable
const ClassificationsPostServiceUnavailableCode int = 503

/*
ClassificationsPostServiceUnavailable The operational mode of the server does not allow classifications operations at this time.

swagger:response classificationsPostServiceUnavailable
*/
...
// NewClassificationsPostServiceUnavailable creates ClassificationsPostServiceUnavailable with default headers values
...
// WithPayload adds the payload to the classifications post service unavailable response
func (o *ClassificationsPostServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ClassificationsPostServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the classifications post service unavailable response
func (o *ClassificationsPostServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ClassificationsPostServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
