...
// ReplicateServiceUnavailableCode is the HTTP code returned for type ReplicateServiceUnavailable
const ReplicateServiceUnavailableCode int = 503

/*
ReplicateServiceUnavailable The operational mode of the server does not allow replica movement operations at this time.

swagger:response replicateServiceUnavailable
*/
...
// NewReplicateServiceUnavailable creates ReplicateServiceUnavailable with default headers values
func NewReplicateServiceUnavailable() *ReplicateServiceUnavailable {

	return &ReplicateServiceUnavailable{}
}

// WithPayload adds the payload to the replicate service unavailable response
func (o *ReplicateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ReplicateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the replicate service unavailable response
func (o *ReplicateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ReplicateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
