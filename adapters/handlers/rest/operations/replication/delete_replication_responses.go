...
// DeleteReplicationServiceUnavailableCode is the HTTP code returned for type DeleteReplicationServiceUnavailable
const DeleteReplicationServiceUnavailableCode int = 503

/*
DeleteReplicationServiceUnavailable The operational mode of the server does not allow replica movement operations at this time.

swagger:response deleteReplicationServiceUnavailable
*/
...
// NewDeleteReplicationServiceUnavailable creates DeleteReplicationServiceUnavailable with default headers values
...
// WithPayload adds the payload to the delete replication service unavailable response
func (o *DeleteReplicationServiceUnavailable) WithPayload(payload *models.ErrorResponse) *DeleteReplicationServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete replication service unavailable response
func (o *DeleteReplicationServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteReplicationServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
