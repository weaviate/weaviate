...
// ApplyReplicationScalePlanParams contains all the bound params for the apply replication scale plan operation
// typically these are obtained from a http.Request
//
// swagger:parameters applyReplicationScalePlan
...
//
// To ensure default values, the struct must have been initialized with NewApplyReplicationScalePlanParams() beforehand.
func (o *ApplyReplicationScalePlanParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
