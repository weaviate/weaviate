...
// ReplicationDetailsServiceUnavailableCode is the HTTP code returned for type ReplicationDetailsServiceUnavailable
const ReplicationDetailsServiceUnavailableCode int = 503

/*
ReplicationDetailsServiceUnavailable The operational mode of the server does not allow replica movement operations at this time.

swagger:response replicationDetailsServiceUnavailable
*/
type ReplicationDetailsServiceUnavailable struct {
...
// NewReplicationDetailsServiceUnavailable creates ReplicationDetailsServiceUnavailable with default headers values
func NewReplicationDetailsServiceUnavailable() *ReplicationDetailsServiceUnavailable {

	return &ReplicationDetailsServiceUnavailable{}
}

// WithPayload adds the payload to the replication details service unavailable response
func (o *ReplicationDetailsServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ReplicationDetailsServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the replication details service unavailable response
func (o *ReplicationDetailsServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ReplicationDetailsServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
