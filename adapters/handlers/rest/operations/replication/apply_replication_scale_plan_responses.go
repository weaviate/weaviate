...
// ApplyReplicationScalePlanServiceUnavailableCode is the HTTP code returned for type ApplyReplicationScalePlanServiceUnavailable
const ApplyReplicationScalePlanServiceUnavailableCode int = 503

/*
ApplyReplicationScalePlanServiceUnavailable The operational mode of the server does not allow replica movement operations at this time.

swagger:response applyReplicationScalePlanServiceUnavailable
*/
...
// NewApplyReplicationScalePlanServiceUnavailable creates ApplyReplicationScalePlanServiceUnavailable with default headers values
...
// WithPayload adds the payload to the apply replication scale plan service unavailable response
func (o *ApplyReplicationScalePlanServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ApplyReplicationScalePlanServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the apply replication scale plan service unavailable response
func (o *ApplyReplicationScalePlanServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ApplyReplicationScalePlanServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
