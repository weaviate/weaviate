...
/*
DeleteAllReplicationsUnprocessableEntity The request syntax is correct, but the server couldn't process it due to semantic issues. Please check the values in your request.
...
// DeleteAllReplicationsServiceUnavailableCode is the HTTP code returned for type DeleteAllReplicationsServiceUnavailable
const DeleteAllReplicationsServiceUnavailableCode int = 503

/*
DeleteAllReplicationsServiceUnavailable The operational mode of the server does not allow replica movement operations at this time.

swagger:response deleteAllReplicationsServiceUnavailable
*/
...
// NewDeleteAllReplicationsServiceUnavailable creates DeleteAllReplicationsServiceUnavailable with default headers values
...
// WithPayload adds the payload to the delete all replications service unavailable response
func (o *DeleteAllReplicationsServiceUnavailable) WithPayload(payload *models.ErrorResponse) *DeleteAllReplicationsServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete all replications service unavailable response
func (o *DeleteAllReplicationsServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteAllReplicationsServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
