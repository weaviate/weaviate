...
// ReplicationDetailsParams contains all the bound params for the replication details operation
// typically these are obtained from a http.Request
//
// swagger:parameters replicationDetails
...
//
// To ensure default values, the struct must have been initialized with NewReplicationDetailsParams() beforehand.
func (o *ReplicationDetailsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplicationDetailsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
