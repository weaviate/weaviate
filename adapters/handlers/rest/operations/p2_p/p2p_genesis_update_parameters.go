...
// P2pGenesisUpdateParams contains all the bound params for the p2p genesis update operation
// typically these are obtained from a http.Request
//
// swagger:parameters p2p.genesis_update
...
//
// To ensure default values, the struct must have been initialized with NewP2pGenesisUpdateParams() beforehand.
func (o *P2pGenesisUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
