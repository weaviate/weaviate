...
// WeaviateThingsReferencesUpdateParams contains all the bound params for the weaviate things references update operation
// typically these are obtained from a http.Request
//
// swagger:parameters weaviate.things.references.update
...
//
// To ensure default values, the struct must have been initialized with NewWeaviateThingsReferencesUpdateParams() beforehand.
func (o *WeaviateThingsReferencesUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *WeaviateThingsReferencesUpdateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
