...
// ThingsReferencesDeleteParams contains all the bound params for the things references delete operation
// typically these are obtained from a http.Request
//
// swagger:parameters things.references.delete
...
//
// To ensure default values, the struct must have been initialized with NewThingsReferencesDeleteParams() beforehand.
func (o *ThingsReferencesDeleteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThingsReferencesDeleteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ThingsReferencesDeleteParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
