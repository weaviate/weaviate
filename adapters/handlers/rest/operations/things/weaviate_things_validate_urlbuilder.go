...
func (o *WeaviateThingsValidateURL) WithBasePath(bp string) *WeaviateThingsValidateURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *WeaviateThingsValidateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on WeaviateThingsValidateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on WeaviateThingsValidateURL")
	}
