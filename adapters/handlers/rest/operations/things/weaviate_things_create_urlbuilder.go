...
func (o *WeaviateThingsCreateURL) WithBasePath(bp string) *WeaviateThingsCreateURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *WeaviateThingsCreateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on WeaviateThingsCreateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on WeaviateThingsCreateURL")
	}
