...
// ThingsReferencesUpdateParams contains all the bound params for the things references update operation
// typically these are obtained from a http.Request
//
// swagger:parameters things.references.update
...
//
// To ensure default values, the struct must have been initialized with NewThingsReferencesUpdateParams() beforehand.
func (o *ThingsReferencesUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThingsReferencesUpdateParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ThingsReferencesUpdateParams) validateID(formats strfmt.Registry) error {
...
func (o *ThingsReferencesUpdateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
