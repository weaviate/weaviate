...
// ThingsListParams contains all the bound params for the things list operation
// typically these are obtained from a http.Request
//
// swagger:parameters things.list
...
//
// To ensure default values, the struct must have been initialized with NewThingsListParams() beforehand.
func (o *ThingsListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThingsListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
