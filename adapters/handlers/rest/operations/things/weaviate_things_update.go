...
type WeaviateThingsUpdateHandlerFunc func(WeaviateThingsUpdateParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn WeaviateThingsUpdateHandlerFunc) Handle(params WeaviateThingsUpdateParams, principal *models.Principal) middleware.Responder {
...
type WeaviateThingsUpdateHandler interface {
	Handle(WeaviateThingsUpdateParams, *models.Principal) middleware.Responder
}
