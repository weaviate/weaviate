...
// ThingsPatchParams contains all the bound params for the things patch operation
// typically these are obtained from a http.Request
//
// swagger:parameters things.patch
...
//
// To ensure default values, the struct must have been initialized with NewThingsPatchParams() beforehand.
func (o *ThingsPatchParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThingsPatchParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
