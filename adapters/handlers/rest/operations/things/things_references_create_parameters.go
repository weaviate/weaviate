...
// ThingsReferencesCreateParams contains all the bound params for the things references create operation
// typically these are obtained from a http.Request
//
// swagger:parameters things.references.create
...
//
// To ensure default values, the struct must have been initialized with NewThingsReferencesCreateParams() beforehand.
func (o *ThingsReferencesCreateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ThingsReferencesCreateParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ThingsReferencesCreateParams) bindPropertyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
