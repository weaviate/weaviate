...
// BatchReferencesCreateServiceUnavailableCode is the HTTP code returned for type BatchReferencesCreateServiceUnavailable
const BatchReferencesCreateServiceUnavailableCode int = 503

/*
BatchReferencesCreateServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response batchReferencesCreateServiceUnavailable
*/
...
// NewBatchReferencesCreateServiceUnavailable creates BatchReferencesCreateServiceUnavailable with default headers values
...
// WithPayload adds the payload to the batch references create service unavailable response
func (o *BatchReferencesCreateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *BatchReferencesCreateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the batch references create service unavailable response
func (o *BatchReferencesCreateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *BatchReferencesCreateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
