...
// BatchObjectsCreateServiceUnavailableCode is the HTTP code returned for type BatchObjectsCreateServiceUnavailable
const BatchObjectsCreateServiceUnavailableCode int = 503

/*
BatchObjectsCreateServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response batchObjectsCreateServiceUnavailable
*/
...
// NewBatchObjectsCreateServiceUnavailable creates BatchObjectsCreateServiceUnavailable with default headers values
...
// WithPayload adds the payload to the batch objects create service unavailable response
func (o *BatchObjectsCreateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *BatchObjectsCreateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the batch objects create service unavailable response
func (o *BatchObjectsCreateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *BatchObjectsCreateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
