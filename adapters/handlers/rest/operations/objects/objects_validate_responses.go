...
// ObjectsValidateServiceUnavailableCode is the HTTP code returned for type ObjectsValidateServiceUnavailable
const ObjectsValidateServiceUnavailableCode int = 503

/*
ObjectsValidateServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsValidateServiceUnavailable
*/
...
// NewObjectsValidateServiceUnavailable creates ObjectsValidateServiceUnavailable with default headers values
func NewObjectsValidateServiceUnavailable() *ObjectsValidateServiceUnavailable {

	return &ObjectsValidateServiceUnavailable{}
}

// WithPayload adds the payload to the objects validate service unavailable response
func (o *ObjectsValidateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsValidateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects validate service unavailable response
func (o *ObjectsValidateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsValidateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
