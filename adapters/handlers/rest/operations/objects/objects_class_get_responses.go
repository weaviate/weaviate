...
// ObjectsClassGetServiceUnavailableCode is the HTTP code returned for type ObjectsClassGetServiceUnavailable
const ObjectsClassGetServiceUnavailableCode int = 503

/*
ObjectsClassGetServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassGetServiceUnavailable
*/
...
// NewObjectsClassGetServiceUnavailable creates ObjectsClassGetServiceUnavailable with default headers values
func NewObjectsClassGetServiceUnavailable() *ObjectsClassGetServiceUnavailable {

	return &ObjectsClassGetServiceUnavailable{}
}

// WithPayload adds the payload to the objects class get service unavailable response
func (o *ObjectsClassGetServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassGetServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class get service unavailable response
func (o *ObjectsClassGetServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassGetServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
