...
func (o *ObjectsReferencesDeleteURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on ObjectsReferencesDeleteURL")
	}
	...
	if propertyName != "" {
		...
		return nil, errors.New("propertyName is required on ObjectsReferencesDeleteURL")
	}
...
func (o *ObjectsReferencesDeleteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsReferencesDeleteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsReferencesDeleteURL")
	}
