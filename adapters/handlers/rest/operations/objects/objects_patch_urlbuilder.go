...
func (o *ObjectsPatchURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/objects/{id}"

	id := o.ID.String()
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on ObjectsPatchURL")
	}
...
func (o *ObjectsPatchURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsPatchURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsPatchURL")
	}
