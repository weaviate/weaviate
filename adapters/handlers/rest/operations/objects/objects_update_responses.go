...
// ObjectsUpdateServiceUnavailableCode is the HTTP code returned for type ObjectsUpdateServiceUnavailable
const ObjectsUpdateServiceUnavailableCode int = 503

/*
ObjectsUpdateServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsUpdateServiceUnavailable
*/
...
// NewObjectsUpdateServiceUnavailable creates ObjectsUpdateServiceUnavailable with default headers values
func NewObjectsUpdateServiceUnavailable() *ObjectsUpdateServiceUnavailable {

	return &ObjectsUpdateServiceUnavailable{}
}

// WithPayload adds the payload to the objects update service unavailable response
func (o *ObjectsUpdateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsUpdateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects update service unavailable response
func (o *ObjectsUpdateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsUpdateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
