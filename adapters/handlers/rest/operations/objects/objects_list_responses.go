...
// ObjectsListServiceUnavailableCode is the HTTP code returned for type ObjectsListServiceUnavailable
const ObjectsListServiceUnavailableCode int = 503

/*
ObjectsListServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsListServiceUnavailable
*/
...
// NewObjectsListServiceUnavailable creates ObjectsListServiceUnavailable with default headers values
func NewObjectsListServiceUnavailable() *ObjectsListServiceUnavailable {

	return &ObjectsListServiceUnavailable{}
}

// WithPayload adds the payload to the objects list service unavailable response
func (o *ObjectsListServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsListServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects list service unavailable response
func (o *ObjectsListServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsListServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
