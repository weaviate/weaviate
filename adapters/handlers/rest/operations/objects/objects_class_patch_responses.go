...
// ObjectsClassPatchServiceUnavailableCode is the HTTP code returned for type ObjectsClassPatchServiceUnavailable
const ObjectsClassPatchServiceUnavailableCode int = 503

/*
ObjectsClassPatchServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassPatchServiceUnavailable
*/
...
// NewObjectsClassPatchServiceUnavailable creates ObjectsClassPatchServiceUnavailable with default headers values
...
// WithPayload adds the payload to the objects class patch service unavailable response
func (o *ObjectsClassPatchServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassPatchServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class patch service unavailable response
func (o *ObjectsClassPatchServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassPatchServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
