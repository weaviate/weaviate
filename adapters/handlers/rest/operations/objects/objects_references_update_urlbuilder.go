...
func (o *ObjectsReferencesUpdateURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on ObjectsReferencesUpdateURL")
	}
	...
	if propertyName != "" {
		...
		return nil, errors.New("propertyName is required on ObjectsReferencesUpdateURL")
	}
...
func (o *ObjectsReferencesUpdateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsReferencesUpdateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsReferencesUpdateURL")
	}
