...
/*
ObjectsClassPutOK Object replaced successfully.
...
/*
ObjectsClassPutNotFound Object not found.
...
/*
ObjectsClassPutUnprocessableEntity The request syntax is correct, but the server couldn't process it due to semantic issues. Please check the values in your request. Ensure the collection exists and the object properties are valid.
...
/*
ObjectsClassPutInternalServerError An error occurred while trying to fulfill the request. Check the ErrorResponse for details.
...
// ObjectsClassPutServiceUnavailableCode is the HTTP code returned for type ObjectsClassPutServiceUnavailable
const ObjectsClassPutServiceUnavailableCode int = 503

/*
ObjectsClassPutServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassPutServiceUnavailable
*/
...
// NewObjectsClassPutServiceUnavailable creates ObjectsClassPutServiceUnavailable with default headers values
func NewObjectsClassPutServiceUnavailable() *ObjectsClassPutServiceUnavailable {

	return &ObjectsClassPutServiceUnavailable{}
}

// WithPayload adds the payload to the objects class put service unavailable response
func (o *ObjectsClassPutServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassPutServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class put service unavailable response
func (o *ObjectsClassPutServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassPutServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
