...
// ObjectsGetServiceUnavailableCode is the HTTP code returned for type ObjectsGetServiceUnavailable
const ObjectsGetServiceUnavailableCode int = 503

/*
ObjectsGetServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsGetServiceUnavailable
*/
type ObjectsGetServiceUnavailable struct {
...
// NewObjectsGetServiceUnavailable creates ObjectsGetServiceUnavailable with default headers values
func NewObjectsGetServiceUnavailable() *ObjectsGetServiceUnavailable {

	return &ObjectsGetServiceUnavailable{}
}

// WithPayload adds the payload to the objects get service unavailable response
func (o *ObjectsGetServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsGetServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects get service unavailable response
func (o *ObjectsGetServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsGetServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
