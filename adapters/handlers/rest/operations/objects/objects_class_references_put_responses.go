...
// ObjectsClassReferencesPutServiceUnavailableCode is the HTTP code returned for type ObjectsClassReferencesPutServiceUnavailable
const ObjectsClassReferencesPutServiceUnavailableCode int = 503

/*
ObjectsClassReferencesPutServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassReferencesPutServiceUnavailable
*/
...
// NewObjectsClassReferencesPutServiceUnavailable creates ObjectsClassReferencesPutServiceUnavailable with default headers values
...
// WithPayload adds the payload to the objects class references put service unavailable response
func (o *ObjectsClassReferencesPutServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassReferencesPutServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class references put service unavailable response
func (o *ObjectsClassReferencesPutServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassReferencesPutServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
