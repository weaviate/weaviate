...
// ObjectsClassReferencesCreateServiceUnavailableCode is the HTTP code returned for type ObjectsClassReferencesCreateServiceUnavailable
const ObjectsClassReferencesCreateServiceUnavailableCode int = 503

/*
ObjectsClassReferencesCreateServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassReferencesCreateServiceUnavailable
*/
...
// NewObjectsClassReferencesCreateServiceUnavailable creates ObjectsClassReferencesCreateServiceUnavailable with default headers values
...
// WithPayload adds the payload to the objects class references create service unavailable response
func (o *ObjectsClassReferencesCreateServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassReferencesCreateServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class references create service unavailable response
func (o *ObjectsClassReferencesCreateServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassReferencesCreateServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
