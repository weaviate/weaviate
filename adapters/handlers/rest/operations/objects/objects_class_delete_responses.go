...
// ObjectsClassDeleteServiceUnavailableCode is the HTTP code returned for type ObjectsClassDeleteServiceUnavailable
const ObjectsClassDeleteServiceUnavailableCode int = 503

/*
ObjectsClassDeleteServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassDeleteServiceUnavailable
*/
...
// NewObjectsClassDeleteServiceUnavailable creates ObjectsClassDeleteServiceUnavailable with default headers values
...
// WithPayload adds the payload to the objects class delete service unavailable response
func (o *ObjectsClassDeleteServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassDeleteServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class delete service unavailable response
func (o *ObjectsClassDeleteServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassDeleteServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
