...
// ObjectsReferencesDeleteServiceUnavailableCode is the HTTP code returned for type ObjectsReferencesDeleteServiceUnavailable
const ObjectsReferencesDeleteServiceUnavailableCode int = 503

/*
ObjectsReferencesDeleteServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsReferencesDeleteServiceUnavailable
*/
type ObjectsReferencesDeleteServiceUnavailable struct {
...
// NewObjectsReferencesDeleteServiceUnavailable creates ObjectsReferencesDeleteServiceUnavailable with default headers values
func NewObjectsReferencesDeleteServiceUnavailable() *ObjectsReferencesDeleteServiceUnavailable {

	return &ObjectsReferencesDeleteServiceUnavailable{}
}

// WithPayload adds the payload to the objects references delete service unavailable response
func (o *ObjectsReferencesDeleteServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsReferencesDeleteServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects references delete service unavailable response
func (o *ObjectsReferencesDeleteServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsReferencesDeleteServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
