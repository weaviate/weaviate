...
func (o *ObjectsClassPatchURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on ObjectsClassPatchURL")
	}
	...
	if id != "" {
		...
		return nil, errors.New("id is required on ObjectsClassPatchURL")
	}
...
func (o *ObjectsClassPatchURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsClassPatchURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsClassPatchURL")
	}
