...
func (o *ObjectsClassGetURL) Build() (*url.URL, error) {
	...
	if className != "" {
		...
		return nil, errors.New("className is required on ObjectsClassGetURL")
	}
	...
	if id != "" {
		...
		return nil, errors.New("id is required on ObjectsClassGetURL")
	}
...
func (o *ObjectsClassGetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ObjectsClassGetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ObjectsClassGetURL")
	}
