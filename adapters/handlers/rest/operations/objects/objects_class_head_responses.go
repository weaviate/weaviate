...
// ObjectsClassHeadServiceUnavailableCode is the HTTP code returned for type ObjectsClassHeadServiceUnavailable
const ObjectsClassHeadServiceUnavailableCode int = 503

/*
ObjectsClassHeadServiceUnavailable The operational mode of the server does not allow objects operations at this time.

swagger:response objectsClassHeadServiceUnavailable
*/
...
// NewObjectsClassHeadServiceUnavailable creates ObjectsClassHeadServiceUnavailable with default headers values
func NewObjectsClassHeadServiceUnavailable() *ObjectsClassHeadServiceUnavailable {

	return &ObjectsClassHeadServiceUnavailable{}
}

// WithPayload adds the payload to the objects class head service unavailable response
func (o *ObjectsClassHeadServiceUnavailable) WithPayload(payload *models.ErrorResponse) *ObjectsClassHeadServiceUnavailable {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the objects class head service unavailable response
func (o *ObjectsClassHeadServiceUnavailable) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *ObjectsClassHeadServiceUnavailable) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
