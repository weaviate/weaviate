...
func (_m *MockControllerAndGetUsers) GetRolesForUserOrGroup(user string, userType models.UserTypeInput, isGroup bool) (map[string][]authorization.Policy, error) {
	...
	var r0 map[string][]authorization.Policy
	var r1 error
	if rf, ok := ret.Get(0).(func(string, models.UserTypeInput, bool) (map[string][]authorization.Policy, error)); ok {
		return rf(user, userType, isGroup)
	}
	if rf, ok := ret.Get(0).(func(string, models.UserTypeInput, bool) map[string][]authorization.Policy); ok {
...
func (_c *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call) Run(run func(user string, userType models.UserTypeInput, isGroup bool)) *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call) RunAndReturn(run func(string, models.UserTypeInput, bool) (map[string][]authorization.Policy, error)) *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call {
	_c.Call.Return(run)
	return _c
}
