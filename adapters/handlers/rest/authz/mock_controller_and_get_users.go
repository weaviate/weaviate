...
func (_m *MockControllerAndGetUsers) GetRolesForUserOrGroup(user string, userType models.UserAndGroupTypeInput, isGroup bool) (map[string][]authorization.Policy, error) {
...
//   - isGroup bool
func (_e *MockControllerAndGetUsers_Expecter) GetRolesForUserOrGroup(user interface{}, userType interface{}, isGroup interface{}) *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call {
	return &MockControllerAndGetUsers_GetRolesForUserOrGroup_Call{Call: _e.mock.On("GetRolesForUserOrGroup", user, userType, isGroup)}
}

func (_c *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call) Run(run func(user string, userType models.UserAndGroupTypeInput, isGroup bool)) *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call) RunAndReturn(run func(string, models.UserAndGroupTypeInput, bool) (map[string][]authorization.Policy, error)) *MockControllerAndGetUsers_GetRolesForUserOrGroup_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockControllerAndGetUsers) GetUsersOrGroupForRole(role string, userType models.UserAndGroupTypeInput, IsGroup bool) ([]string, error) {
...
//   - userType models.UserAndGroupTypeInput
//   - IsGroup bool
func (_e *MockControllerAndGetUsers_Expecter) GetUsersOrGroupForRole(role interface{}, userType interface{}, IsGroup interface{}) *MockControllerAndGetUsers_GetUsersOrGroupForRole_Call {
	return &MockControllerAndGetUsers_GetUsersOrGroupForRole_Call{Call: _e.mock.On("GetUsersOrGroupForRole", role, userType, IsGroup)}
}

func (_c *MockControllerAndGetUsers_GetUsersOrGroupForRole_Call) Run(run func(role string, userType models.UserAndGroupTypeInput, IsGroup bool)) *MockControllerAndGetUsers_GetUsersOrGroupForRole_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(models.UserAndGroupTypeInput), args[2].(bool))
	})
	return _c
...
func (_c *MockControllerAndGetUsers_GetUsersOrGroupForRole_Call) RunAndReturn(run func(string, models.UserAndGroupTypeInput, bool) ([]string, error)) *MockControllerAndGetUsers_GetUsersOrGroupForRole_Call {
	_c.Call.Return(run)
	return _c
}

// GetUsersOrGroupsWithRoles provides a mock function with given fields: isGroup, authType
func (_m *MockControllerAndGetUsers) GetUsersOrGroupsWithRoles(isGroup bool, authType models.UserAndGroupTypeInput) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if rf, ok := ret.Get(0).(func(bool, models.UserAndGroupTypeInput) ([]string, error)); ok {
		return rf(isGroup, authType)
	}
	if rf, ok := ret.Get(0).(func(bool, models.UserAndGroupTypeInput) []string); ok {
	...
	if rf, ok := ret.Get(1).(func(bool, models.UserAndGroupTypeInput) error); ok {
...
func (_c *MockControllerAndGetUsers_GetUsersOrGroupsWithRoles_Call) Run(run func(isGroup bool, authType models.UserAndGroupTypeInput)) *MockControllerAndGetUsers_GetUsersOrGroupsWithRoles_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(bool), args[1].(models.UserAndGroupTypeInput))
	})
	return _c
}
...
func (_c *MockControllerAndGetUsers_GetUsersOrGroupsWithRoles_Call) RunAndReturn(run func(bool, models.UserAndGroupTypeInput) ([]string, error)) *MockControllerAndGetUsers_GetUsersOrGroupsWithRoles_Call {
	_c.Call.Return(run)
	return _c
}
