...
func (_m *MockControllerAndGetUsers) GetRolesForSubjects(subjects []authorization.Subject) (map[string]map[string][]authorization.Policy, error) {
...
// MockControllerAndGetUsers_GetRolesForSubjects_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRolesForSubjects'
type MockControllerAndGetUsers_GetRolesForSubjects_Call struct {
	*mock.Call
}

// GetRolesForSubjects is a helper method to define mock.On call
//   - subjects []authorization.Subject
func (_e *MockControllerAndGetUsers_Expecter) GetRolesForSubjects(subjects interface{}) *MockControllerAndGetUsers_GetRolesForSubjects_Call {
	return &MockControllerAndGetUsers_GetRolesForSubjects_Call{Call: _e.mock.On("GetRolesForSubjects", subjects)}
}

func (_c *MockControllerAndGetUsers_GetRolesForSubjects_Call) Run(run func(subjects []authorization.Subject)) *MockControllerAndGetUsers_GetRolesForSubjects_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockControllerAndGetUsers_GetRolesForSubjects_Call) Return(_a0 map[string]map[string][]authorization.Policy, _a1 error) *MockControllerAndGetUsers_GetRolesForSubjects_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockControllerAndGetUsers_GetRolesForSubjects_Call) RunAndReturn(run func([]authorization.Subject) (map[string]map[string][]authorization.Policy, error)) *MockControllerAndGetUsers_GetRolesForSubjects_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockControllerAndGetUsers) GetUsers(userIds ...string) (map[string]dbuser.View, error) {
...
func (_c *MockControllerAndGetUsers_GetUsers_Call) Return(_a0 map[string]dbuser.View, _a1 error) *MockControllerAndGetUsers_GetUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockControllerAndGetUsers_GetUsers_Call) RunAndReturn(run func(...string) (map[string]dbuser.View, error)) *MockControllerAndGetUsers_GetUsers_Call {
	_c.Call.Return(run)
	return _c
}
