...
func TestAssignRoleToUserSuccess(t *testing.T) {
	...
	authorizer.On("Authorize", principal, authorization.READ, authorization.Roles(params.Body.Roles...)[0]).Return(nil)
	authorizer.On("Authorize", principal, authorization.ASSIGN_AND_REVOKE, authorization.Users(params.ID)[0]).Return(nil)
...
func TestAssignRoleToUserOrUserNotFound(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			authorizer.On("Authorize", tt.principal, authorization.READ, mock.Anything, mock.Anything).Return(nil)
			authorizer.On("Authorize", tt.principal, authorization.ASSIGN_AND_REVOKE, mock.Anything, mock.Anything).Return(nil)
