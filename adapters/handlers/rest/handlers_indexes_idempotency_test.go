...
func TestResolveFilterableUpsert_Idempotency(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			body:     &models.IndexUpsertRequest{},
			tasks:    []*distributedtask.Task{activeReindexTask("T1", "C", dbreindex.ReindexTypeEnableFilterable, "", distributedtask.TaskStatusStarted, "t")},
			wantNoop: true,
			wantJoin: "T1",
		},
		{
		...
		},
		{
			...
			tasks:    []*distributedtask.Task{activeReindexTask("T1", "C", dbreindex.ReindexTypeChangeTokenizationFilterable, "field", distributedtask.TaskStatusStarted, "t")},
			wantNoop: true,
			wantJoin: "T1",
		},
		{
		...
		},
		{
			...
			prop:   textProp("t", "word", on, off),
			body:   &models.IndexUpsertRequest{},
			tasks:  []*distributedtask.Task{activeReindexTask("T1", "C", dbreindex.ReindexTypeEnableFilterable, "", distributedtask.TaskStatusStarted, "other")},
...
func TestResolveRangeableUpsert_Idempotency(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			prop:     numProp(off),
			tasks:    []*distributedtask.Task{activeReindexTask("T1", "C", dbreindex.ReindexTypeEnableRangeable, "", distributedtask.TaskStatusStarted, "n")},
			wantNoop: true,
			wantJoin: "T1",
		},
		{
			...
			prop:     numProp(off),
			tasks:    []*distributedtask.Task{activeReindexTask("T1", "C", dbreindex.ReindexTypeRepairRangeable, "", distributedtask.TaskStatusStarted, "n")},
			wantNoop: true,
			wantJoin: "T1",
		},
		{
			...
			prop:   numProp(off),
			tasks:  []*distributedtask.Task{activeReindexTask("T1", "C", dbreindex.ReindexTypeEnableRangeable, "", distributedtask.TaskStatusStarted, "other")},
