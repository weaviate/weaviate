...
// GraphQL parity), fusionType maps onto the fusion algorithms (omitted
// defaults to the shared relativeScore), maxVectorDistance becomes the
// distance cutoff, and queryProperties get the same first-letter
