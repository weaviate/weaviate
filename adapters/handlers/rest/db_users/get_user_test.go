...
func TestSuccessGetUser(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			dynUser.On("GetRolesForUserOrGroup", test.userId, models.UserAndGroupTypeInputDb, false).Return(
...
func TestSuccessGetUserMultiNode(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			dynUser.On("GetRolesForUserOrGroup", userId, models.UserAndGroupTypeInputDb, false).Return(map[string][]authorization.Policy{"role": {}}, nil)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.GetUserReturnErr == nil {
				dynUser.On("GetRolesForUserOrGroup", "user", models.UserAndGroupTypeInputDb, false).Return(nil, tt.GetRolesReturn)
			}
