...
type QueryHybridArgs struct {
	...
	Filters          *Filter  `json:"filters,omitempty" jsonschema_description:"Optional filter restricting which objects are searched. Use And/Or/Not to nest sub-filters."`
}
