...
func NewWeaviateSearcher(auth *auth.Auth, traverser traverser, schemaReader clusterSchema.SchemaReader, schemaManager local.AliasReader, namespacesEnabled bool, logger logrus.FieldLogger) *WeaviateSearcher {
