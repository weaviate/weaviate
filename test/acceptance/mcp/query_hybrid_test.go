...
// Helper function to create a test collection with various properties
func createTestArticlesCollection(t *testing.T, apiKey string) *models.Class {
	t.Helper()
	...
	helper.DeleteClassAuth(t, className, apiKey)
	helper.CreateClassAuth(t, class, apiKey)
	return class
}

// Helper function to create a multi-tenant test collection
func createMultiTenantCollection(t *testing.T, apiKey string) *models.Class {
	t.Helper()
	className := "TestMultiTenantArticle"
...
// Helper function to insert test articles
func insertTestArticles(t *testing.T, className string, apiKey string) {
	t.Helper()
...
func TestQueryHybrid_PureBM25Search(t *testing.T) {
	...
	cls := createTestArticlesCollection(t, apiKey)
	defer helper.DeleteClassAuth(t, cls.Class, apiKey)

	insertTestArticles(t, cls.Class, apiKey)
...
func TestQueryHybrid_WithTenant(t *testing.T) {
	...
	cls := createMultiTenantCollection(t, apiKey)
	defer helper.DeleteClassAuth(t, cls.Class, apiKey)
