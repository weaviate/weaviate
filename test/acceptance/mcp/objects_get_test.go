...
// Helper function to create test collection for get tests
func createGetTestCollection(t *testing.T, apiKey string) *models.Class {
	t.Helper()
...
// Helper function to create multi-tenant collection for get tests
func createGetTestMultiTenantCollection(t *testing.T, apiKey string) *models.Class {
	t.Helper()
...
// Helper function to insert test objects with vectors
func insertGetTestObjects(t *testing.T, className string, apiKey string) []strfmt.UUID {
	t.Helper()
...
func TestGetObjects_GetSingleObjectByUUID(t *testing.T) {
	...
	cls := createGetTestCollection(t, apiKey)
	defer helper.DeleteClassAuth(t, cls.Class, apiKey)

	ids := insertGetTestObjects(t, cls.Class, apiKey)
	...
	err := helper.CallToolOnce(ctx, t, "weaviate-objects-get", &read.GetObjectsArgs{
...
func TestGetObjects_PaginationDefaultLimit(t *testing.T) {
	...
	insertGetTestObjects(t, cls.Class, apiKey)
...
func TestGetObjects_WithTenant(t *testing.T) {
	...
	cls := createGetTestMultiTenantCollection(t, apiKey)
	defer helper.DeleteClassAuth(t, cls.Class, apiKey)
	...
	resp1, err := helper.CreateObjectWithResponseAuth(t, obj1, apiKey)
	require.Nil(t, err)
	...
	resp2, err := helper.CreateObjectWithResponseAuth(t, obj2, apiKey)
	require.Nil(t, err)
	...
	_, err = helper.CreateObjectWithResponseAuth(t, obj3, apiKey)
	require.Nil(t, err)
...
func TestGetObjects_OffsetBeyondEnd(t *testing.T) {
	...
	insertGetTestObjects(t, cls.Class, apiKey) // 5 objects
