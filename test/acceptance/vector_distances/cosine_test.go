...
func testCosine(t *testing.T) {
	...
	t.Run("limiting by certainty", func(t *testing.T) {
		...
		t.Run("with certainty=0 meaning 'match anything'", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with certainty=0.95", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with certainty=0.97", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with certainty=1", func(t *testing.T) {
	...
	t.Run("limiting by distance", func(t *testing.T) {
		t.Run("with distance=2, i.e. max distance, should match all", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with distance=1.99, should exclude the last", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with distance=0.08, it should barely still match element 3", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with distance=0.01, most vectors are excluded", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
		...
		t.Run("with distance=0, only perfect matches are allowed", func(t *testing.T) {
			res := AssertGraphQL(t, nil, `
			{
				Get{
