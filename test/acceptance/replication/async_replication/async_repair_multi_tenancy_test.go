...
func (suite *AsyncReplicationTestSuite) TestAsyncRepairMultiTenancyColdTenantConfigUpdate() {
	...
	t.Run("update async config on class while tenant is cold", func(t *testing.T) {
		...
		class := res.Payload
		if class.ReplicationConfig.AsyncConfig == nil {
			class.ReplicationConfig.AsyncConfig = &models.ReplicationAsyncConfig{}
		}
		class.ReplicationConfig.AsyncConfig.Frequency = swag.Int64(500)
