...
// restSearchServerURI returns the package's Weaviate with the experimental
// REST search endpoint enabled, starting it on first use. The tests share it
// and use distinct class names.
