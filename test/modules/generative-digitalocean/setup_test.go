...
func TestGenerativeDigitalOcean_SingleNode(t *testing.T) {
	...
	t.Run("tests", testGenerativeDigitalOcean(endpointREST, endpointGRPC))
}
...
func composeModules(apiKey string) (composeModules *docker.Compose) {
	composeModules = docker.New().
		...
		WithGenerativeDigitalOcean(apiKey)
