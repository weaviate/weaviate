...
func Test_MultiTenantBackupJourney(t *testing.T) {
	...
	t.Run("single node", func(t *testing.T) {
		...
		t.Run("backup-s3", func(t *testing.T) {
			journey.BackupJourneyTests_SingleNode(t, compose.GetWeaviate().URI(),
				"s3", s3BackupJourneyClassName, s3BackupJourneyBackupIDSingleNode, tenantNames, false)
		})
	})
	...
	t.Run("single node", func(t *testing.T) {
		...
		t.Run("backup-s3", func(t *testing.T) {
			journey.BackupJourneyTests_SingleNode(t, compose.GetWeaviate().URI(),
				"s3", s3BackupJourneyClassName, s3BackupJourneyBackupIDSingleNode, tenantNames, true)
		})
	})
