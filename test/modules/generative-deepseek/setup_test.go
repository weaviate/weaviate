...
func TestGenerativeDeepseek_SingleNode(t *testing.T) {
	apiKey := os.Getenv("DEEPSEEK_APIKEY")
	if apiKey == "" {
		t.Skip("skipping, DEEPSEEK_APIKEY environment variable not present")
	}
	...
	t.Run("generative-deepseek", testGenerativeDeepseek(endpointREST, endpointGRPC, "generative-deepseek"))
}
