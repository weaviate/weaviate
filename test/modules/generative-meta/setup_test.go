...
func TestGenerativeMeta_SingleNode(t *testing.T) {
	apiKey := os.Getenv("META_APIKEY")
	if apiKey == "" {
		t.Skip("skipping, META_APIKEY environment variable not present")
	}
	...
	t.Run("tests", testGenerativeMeta(endpointREST, endpointGRPC))
}
