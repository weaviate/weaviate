	...
	return func(t *testing.T) {
		...
		t.Run("check enabled modules", func(t *testing.T) {
			...
			expectedModuleNames := []string{
				"generative-cohere", "generative-palm", "generative-google", "generative-openai", "generative-aws", "generative-anyscale",
				"text2vec-cohere", "text2vec-contextionary", "text2vec-openai", "text2vec-huggingface",
				"text2vec-palm", "text2vec-google", "text2vec-aws", "text2vec-transformers", "qna-openai", "reranker-cohere",
