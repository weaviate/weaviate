...
func addTestDataManhattan(t *testing.T, client *client.Weaviate) {
	createObject(t, client, &models.Object{
...
func testManhattan(t *testing.T, client *client.Weaviate) {
	t.Run("without any limiting parameters", func(t *testing.T) {
		res := AssertGraphQLWithClient(t, nil, `
		{
			Get{
