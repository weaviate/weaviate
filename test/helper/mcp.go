...
func CallToolOnce[I any, O any](ctx context.Context, t *testing.T, tool string, in I, out *O) error {
	return CallToolOnceAuth(ctx, t, tool, in, out, "admin-key")
}

// CallToolOnceAuth calls an MCP tool once with the specified API key for authentication
func CallToolOnceAuth[I any, O any](ctx context.Context, t *testing.T, tool string, in I, out *O, apiKey string) error {
