...
ListThings() | - | - | Get list of things based on key-uuid, sorted by most recent | * | owner = uuid | multiple where’s for searching | X | timestamp | 1
...
ListAction() | Get list of actions based on key-uuid, sorted by most recent | * | properties.things.object.cref = ‘uuid’ | multiple where’s for searching | X | timestamp | 1
