...
func (o *ClassificationsGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewClassificationsGetServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewClassificationsGetServiceUnavailable creates a ClassificationsGetServiceUnavailable with default headers values
...
/*
ClassificationsGetServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this classifications get service unavailable response has a 2xx status code
func (o *ClassificationsGetServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this classifications get service unavailable response has a 3xx status code
func (o *ClassificationsGetServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this classifications get service unavailable response has a 4xx status code
func (o *ClassificationsGetServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this classifications get service unavailable response has a 5xx status code
func (o *ClassificationsGetServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this classifications get service unavailable response a status code equal to that given
func (o *ClassificationsGetServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the classifications get service unavailable response
func (o *ClassificationsGetServiceUnavailable) Code() int {
	return 503
}

func (o *ClassificationsGetServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /classifications/{id}][%d] classificationsGetServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ClassificationsGetServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /classifications/{id}][%d] classificationsGetServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ClassificationsGetServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ClassificationsGetServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
