...
func (o *ClassificationsPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewClassificationsPostServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewClassificationsPostServiceUnavailable creates a ClassificationsPostServiceUnavailable with default headers values
func NewClassificationsPostServiceUnavailable() *ClassificationsPostServiceUnavailable {
	return &ClassificationsPostServiceUnavailable{}
}

/*
ClassificationsPostServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow classifications operations at this time.
*/
type ClassificationsPostServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this classifications post service unavailable response has a 2xx status code
func (o *ClassificationsPostServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this classifications post service unavailable response has a 3xx status code
func (o *ClassificationsPostServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this classifications post service unavailable response has a 4xx status code
func (o *ClassificationsPostServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this classifications post service unavailable response has a 5xx status code
func (o *ClassificationsPostServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this classifications post service unavailable response a status code equal to that given
func (o *ClassificationsPostServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the classifications post service unavailable response
func (o *ClassificationsPostServiceUnavailable) Code() int {
	return 503
}

func (o *ClassificationsPostServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /classifications/][%d] classificationsPostServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ClassificationsPostServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /classifications/][%d] classificationsPostServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ClassificationsPostServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ClassificationsPostServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
