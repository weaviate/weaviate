...
// NewSearchNearObjectParamsWithTimeout creates a new SearchNearObjectParams object
...
// NewSearchNearObjectParamsWithContext creates a new SearchNearObjectParams object
...
// NewSearchNearObjectParamsWithHTTPClient creates a new SearchNearObjectParams object
...
func (o *SearchNearObjectParams) WithDefaults() *SearchNearObjectParams {
	o.SetDefaults()
	return o
}
...
func (o *SearchNearObjectParams) WithTimeout(timeout time.Duration) *SearchNearObjectParams {
...
func (o *SearchNearObjectParams) WithContext(ctx context.Context) *SearchNearObjectParams {
	o.SetContext(ctx)
	return o
}
...
func (o *SearchNearObjectParams) WithBody(body *models.SearchNearObjectRequest) *SearchNearObjectParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the search near object params
func (o *SearchNearObjectParams) SetBody(body *models.SearchNearObjectRequest) {
	o.Body = body
}
...
func (o *SearchNearObjectParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
