...
func (o *SearchNearObjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 413:
		result := NewSearchNearObjectRequestEntityTooLarge()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchNearObjectRequestEntityTooLarge creates a SearchNearObjectRequestEntityTooLarge with default headers values
...
/*
SearchNearObjectRequestEntityTooLarge describes a response with status code 413, with default header values.
...
// IsSuccess returns true when this search near object request entity too large response has a 2xx status code
func (o *SearchNearObjectRequestEntityTooLarge) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this search near object request entity too large response has a 3xx status code
func (o *SearchNearObjectRequestEntityTooLarge) IsRedirect() bool {
	return false
}

// IsClientError returns true when this search near object request entity too large response has a 4xx status code
func (o *SearchNearObjectRequestEntityTooLarge) IsClientError() bool {
	return true
}

// IsServerError returns true when this search near object request entity too large response has a 5xx status code
func (o *SearchNearObjectRequestEntityTooLarge) IsServerError() bool {
	return false
}

// IsCode returns true when this search near object request entity too large response a status code equal to that given
func (o *SearchNearObjectRequestEntityTooLarge) IsCode(code int) bool {
	return code == 413
}

// Code gets the status code for the search near object request entity too large response
func (o *SearchNearObjectRequestEntityTooLarge) Code() int {
	return 413
}

func (o *SearchNearObjectRequestEntityTooLarge) Error() string {
	return fmt.Sprintf("[POST /search/{collection}/near-object][%d] searchNearObjectRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *SearchNearObjectRequestEntityTooLarge) String() string {
	return fmt.Sprintf("[POST /search/{collection}/near-object][%d] searchNearObjectRequestEntityTooLarge  %+v", 413, o.Payload)
}

func (o *SearchNearObjectRequestEntityTooLarge) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *SearchNearObjectRequestEntityTooLarge) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
