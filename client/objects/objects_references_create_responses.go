...
func (o *ObjectsReferencesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewObjectsReferencesCreateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewObjectsReferencesCreateServiceUnavailable creates a ObjectsReferencesCreateServiceUnavailable with default headers values
...
/*
ObjectsReferencesCreateServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this objects references create service unavailable response has a 2xx status code
func (o *ObjectsReferencesCreateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this objects references create service unavailable response has a 3xx status code
func (o *ObjectsReferencesCreateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this objects references create service unavailable response has a 4xx status code
func (o *ObjectsReferencesCreateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this objects references create service unavailable response has a 5xx status code
func (o *ObjectsReferencesCreateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this objects references create service unavailable response a status code equal to that given
func (o *ObjectsReferencesCreateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the objects references create service unavailable response
func (o *ObjectsReferencesCreateServiceUnavailable) Code() int {
	return 503
}

func (o *ObjectsReferencesCreateServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /objects/{id}/references/{propertyName}][%d] objectsReferencesCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsReferencesCreateServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /objects/{id}/references/{propertyName}][%d] objectsReferencesCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsReferencesCreateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ObjectsReferencesCreateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
