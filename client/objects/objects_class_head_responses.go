...
func (o *ObjectsClassHeadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewObjectsClassHeadServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewObjectsClassHeadServiceUnavailable creates a ObjectsClassHeadServiceUnavailable with default headers values
func NewObjectsClassHeadServiceUnavailable() *ObjectsClassHeadServiceUnavailable {
	return &ObjectsClassHeadServiceUnavailable{}
}

/*
ObjectsClassHeadServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow objects operations at this time.
*/
type ObjectsClassHeadServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this objects class head service unavailable response has a 2xx status code
func (o *ObjectsClassHeadServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this objects class head service unavailable response has a 3xx status code
func (o *ObjectsClassHeadServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this objects class head service unavailable response has a 4xx status code
func (o *ObjectsClassHeadServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this objects class head service unavailable response has a 5xx status code
func (o *ObjectsClassHeadServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this objects class head service unavailable response a status code equal to that given
func (o *ObjectsClassHeadServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the objects class head service unavailable response
func (o *ObjectsClassHeadServiceUnavailable) Code() int {
	return 503
}

func (o *ObjectsClassHeadServiceUnavailable) Error() string {
	return fmt.Sprintf("[HEAD /objects/{className}/{id}][%d] objectsClassHeadServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsClassHeadServiceUnavailable) String() string {
	return fmt.Sprintf("[HEAD /objects/{className}/{id}][%d] objectsClassHeadServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsClassHeadServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ObjectsClassHeadServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
