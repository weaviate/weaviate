...
func (o *ObjectsClassPutReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewObjectsClassPutServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewObjectsClassPutServiceUnavailable creates a ObjectsClassPutServiceUnavailable with default headers values
func NewObjectsClassPutServiceUnavailable() *ObjectsClassPutServiceUnavailable {
	return &ObjectsClassPutServiceUnavailable{}
}

/*
ObjectsClassPutServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow objects operations at this time.
*/
type ObjectsClassPutServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this objects class put service unavailable response has a 2xx status code
func (o *ObjectsClassPutServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this objects class put service unavailable response has a 3xx status code
func (o *ObjectsClassPutServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this objects class put service unavailable response has a 4xx status code
func (o *ObjectsClassPutServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this objects class put service unavailable response has a 5xx status code
func (o *ObjectsClassPutServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this objects class put service unavailable response a status code equal to that given
func (o *ObjectsClassPutServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the objects class put service unavailable response
func (o *ObjectsClassPutServiceUnavailable) Code() int {
	return 503
}

func (o *ObjectsClassPutServiceUnavailable) Error() string {
	return fmt.Sprintf("[PUT /objects/{className}/{id}][%d] objectsClassPutServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsClassPutServiceUnavailable) String() string {
	return fmt.Sprintf("[PUT /objects/{className}/{id}][%d] objectsClassPutServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsClassPutServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ObjectsClassPutServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
