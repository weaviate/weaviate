...
// WithTenantKey adds the tenantKey to the objects class put params
func (o *ObjectsClassPutParams) WithTenantKey(tenantKey *string) *ObjectsClassPutParams {
	o.SetTenantKey(tenantKey)
	return o
}

// SetTenantKey adds the tenantKey to the objects class put params
func (o *ObjectsClassPutParams) SetTenantKey(tenantKey *string) {
