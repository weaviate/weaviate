...
// WithTenantKey adds the tenantKey to the objects class patch params
func (o *ObjectsClassPatchParams) WithTenantKey(tenantKey *string) *ObjectsClassPatchParams {
	o.SetTenantKey(tenantKey)
	return o
}

// SetTenantKey adds the tenantKey to the objects class patch params
func (o *ObjectsClassPatchParams) SetTenantKey(tenantKey *string) {
