...
func (o *ObjectsClassReferencesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewObjectsClassReferencesDeleteServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewObjectsClassReferencesDeleteServiceUnavailable creates a ObjectsClassReferencesDeleteServiceUnavailable with default headers values
...
/*
ObjectsClassReferencesDeleteServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this objects class references delete service unavailable response has a 2xx status code
func (o *ObjectsClassReferencesDeleteServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this objects class references delete service unavailable response has a 3xx status code
func (o *ObjectsClassReferencesDeleteServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this objects class references delete service unavailable response has a 4xx status code
func (o *ObjectsClassReferencesDeleteServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this objects class references delete service unavailable response has a 5xx status code
func (o *ObjectsClassReferencesDeleteServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this objects class references delete service unavailable response a status code equal to that given
func (o *ObjectsClassReferencesDeleteServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the objects class references delete service unavailable response
func (o *ObjectsClassReferencesDeleteServiceUnavailable) Code() int {
	return 503
}

func (o *ObjectsClassReferencesDeleteServiceUnavailable) Error() string {
	return fmt.Sprintf("[DELETE /objects/{className}/{id}/references/{propertyName}][%d] objectsClassReferencesDeleteServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsClassReferencesDeleteServiceUnavailable) String() string {
	return fmt.Sprintf("[DELETE /objects/{className}/{id}/references/{propertyName}][%d] objectsClassReferencesDeleteServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ObjectsClassReferencesDeleteServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ObjectsClassReferencesDeleteServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
