...
func (o *BatchObjectsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewBatchObjectsCreateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBatchObjectsCreateServiceUnavailable creates a BatchObjectsCreateServiceUnavailable with default headers values
func NewBatchObjectsCreateServiceUnavailable() *BatchObjectsCreateServiceUnavailable {
	return &BatchObjectsCreateServiceUnavailable{}
}

/*
BatchObjectsCreateServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow objects operations at this time.
*/
type BatchObjectsCreateServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this batch objects create service unavailable response has a 2xx status code
func (o *BatchObjectsCreateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this batch objects create service unavailable response has a 3xx status code
func (o *BatchObjectsCreateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this batch objects create service unavailable response has a 4xx status code
func (o *BatchObjectsCreateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this batch objects create service unavailable response has a 5xx status code
func (o *BatchObjectsCreateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this batch objects create service unavailable response a status code equal to that given
func (o *BatchObjectsCreateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the batch objects create service unavailable response
func (o *BatchObjectsCreateServiceUnavailable) Code() int {
	return 503
}

func (o *BatchObjectsCreateServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /batch/objects][%d] batchObjectsCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *BatchObjectsCreateServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /batch/objects][%d] batchObjectsCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *BatchObjectsCreateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *BatchObjectsCreateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
