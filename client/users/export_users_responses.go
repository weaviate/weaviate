...
func (o *ExportUsersOK) Error() string {
	return fmt.Sprintf("[POST /users/db/export][%d] exportUsersOK  %+v", 200, o.Payload)
}
...
func (o *ExportUsersUnauthorized) Error() string {
	return fmt.Sprintf("[POST /users/db/export][%d] exportUsersUnauthorized ", 401)
}
...
func (o *ExportUsersForbidden) Error() string {
	return fmt.Sprintf("[POST /users/db/export][%d] exportUsersForbidden  %+v", 403, o.Payload)
}
...
func (o *ExportUsersUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /users/db/export][%d] exportUsersUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *ExportUsersInternalServerError) Error() string {
	return fmt.Sprintf("[POST /users/db/export][%d] exportUsersInternalServerError  %+v", 500, o.Payload)
}
