...
func (o *DeleteUserServiceUnavailable) Error() string {
	return fmt.Sprintf("[DELETE /users/db/{user_id}][%d] deleteUserServiceUnavailable  %+v", 503, o.Payload)
}
...
func (o *DeleteUserServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}
