...
func (o *DeactivateUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewDeactivateUserServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeactivateUserServiceUnavailable creates a DeactivateUserServiceUnavailable with default headers values
func NewDeactivateUserServiceUnavailable() *DeactivateUserServiceUnavailable {
	return &DeactivateUserServiceUnavailable{}
}

/*
DeactivateUserServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow users operations at this time.
*/
type DeactivateUserServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this deactivate user service unavailable response has a 2xx status code
func (o *DeactivateUserServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this deactivate user service unavailable response has a 3xx status code
func (o *DeactivateUserServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this deactivate user service unavailable response has a 4xx status code
func (o *DeactivateUserServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this deactivate user service unavailable response has a 5xx status code
func (o *DeactivateUserServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this deactivate user service unavailable response a status code equal to that given
func (o *DeactivateUserServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the deactivate user service unavailable response
func (o *DeactivateUserServiceUnavailable) Code() int {
	return 503
}

func (o *DeactivateUserServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /users/db/{user_id}/deactivate][%d] deactivateUserServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DeactivateUserServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /users/db/{user_id}/deactivate][%d] deactivateUserServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DeactivateUserServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *DeactivateUserServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
