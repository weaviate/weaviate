...
func (o *ImportUsersOK) Error() string {
	return fmt.Sprintf("[POST /users/db/import][%d] importUsersOK  %+v", 200, o.Payload)
}
...
func (o *ImportUsersBadRequest) Error() string {
	return fmt.Sprintf("[POST /users/db/import][%d] importUsersBadRequest  %+v", 400, o.Payload)
}
...
func (o *ImportUsersUnauthorized) Error() string {
	return fmt.Sprintf("[POST /users/db/import][%d] importUsersUnauthorized ", 401)
}
...
func (o *ImportUsersForbidden) Error() string {
	return fmt.Sprintf("[POST /users/db/import][%d] importUsersForbidden  %+v", 403, o.Payload)
}
...
func (o *ImportUsersUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /users/db/import][%d] importUsersUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *ImportUsersInternalServerError) Error() string {
	return fmt.Sprintf("[POST /users/db/import][%d] importUsersInternalServerError  %+v", 500, o.Payload)
}
