...
func (o *DeleteReplicationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 501:
		...
		return nil, result
	case 503:
		result := NewDeleteReplicationServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteReplicationServiceUnavailable creates a DeleteReplicationServiceUnavailable with default headers values
func NewDeleteReplicationServiceUnavailable() *DeleteReplicationServiceUnavailable {
	return &DeleteReplicationServiceUnavailable{}
}

/*
DeleteReplicationServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow replica movement operations at this time.
*/
type DeleteReplicationServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this delete replication service unavailable response has a 2xx status code
func (o *DeleteReplicationServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete replication service unavailable response has a 3xx status code
func (o *DeleteReplicationServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete replication service unavailable response has a 4xx status code
func (o *DeleteReplicationServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete replication service unavailable response has a 5xx status code
func (o *DeleteReplicationServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this delete replication service unavailable response a status code equal to that given
func (o *DeleteReplicationServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the delete replication service unavailable response
func (o *DeleteReplicationServiceUnavailable) Code() int {
	return 503
}

func (o *DeleteReplicationServiceUnavailable) Error() string {
	return fmt.Sprintf("[DELETE /replication/replicate/{id}][%d] deleteReplicationServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DeleteReplicationServiceUnavailable) String() string {
	return fmt.Sprintf("[DELETE /replication/replicate/{id}][%d] deleteReplicationServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DeleteReplicationServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *DeleteReplicationServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
