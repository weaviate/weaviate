...
func (o *ReplicationDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 501:
		...
		return nil, result
	case 503:
		result := NewReplicationDetailsServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewReplicationDetailsServiceUnavailable creates a ReplicationDetailsServiceUnavailable with default headers values
...
/*
ReplicationDetailsServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this replication details service unavailable response has a 2xx status code
func (o *ReplicationDetailsServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this replication details service unavailable response has a 3xx status code
func (o *ReplicationDetailsServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this replication details service unavailable response has a 4xx status code
func (o *ReplicationDetailsServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this replication details service unavailable response has a 5xx status code
func (o *ReplicationDetailsServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this replication details service unavailable response a status code equal to that given
func (o *ReplicationDetailsServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the replication details service unavailable response
func (o *ReplicationDetailsServiceUnavailable) Code() int {
	return 503
}

func (o *ReplicationDetailsServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /replication/replicate/{id}][%d] replicationDetailsServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ReplicationDetailsServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /replication/replicate/{id}][%d] replicationDetailsServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ReplicationDetailsServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ReplicationDetailsServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
