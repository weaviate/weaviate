...
func (o *GetCollectionShardingStateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 501:
		...
		return nil, result
	case 503:
		result := NewGetCollectionShardingStateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetCollectionShardingStateServiceUnavailable creates a GetCollectionShardingStateServiceUnavailable with default headers values
...
/*
GetCollectionShardingStateServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this get collection sharding state service unavailable response has a 2xx status code
func (o *GetCollectionShardingStateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get collection sharding state service unavailable response has a 3xx status code
func (o *GetCollectionShardingStateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get collection sharding state service unavailable response has a 4xx status code
func (o *GetCollectionShardingStateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this get collection sharding state service unavailable response has a 5xx status code
func (o *GetCollectionShardingStateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this get collection sharding state service unavailable response a status code equal to that given
func (o *GetCollectionShardingStateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the get collection sharding state service unavailable response
func (o *GetCollectionShardingStateServiceUnavailable) Code() int {
	return 503
}

func (o *GetCollectionShardingStateServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /replication/sharding-state][%d] getCollectionShardingStateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetCollectionShardingStateServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /replication/sharding-state][%d] getCollectionShardingStateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetCollectionShardingStateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *GetCollectionShardingStateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
