...
func (o *ApplyReplicationScalePlanReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 501:
		...
		return nil, result
	case 503:
		result := NewApplyReplicationScalePlanServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewApplyReplicationScalePlanServiceUnavailable creates a ApplyReplicationScalePlanServiceUnavailable with default headers values
func NewApplyReplicationScalePlanServiceUnavailable() *ApplyReplicationScalePlanServiceUnavailable {
	return &ApplyReplicationScalePlanServiceUnavailable{}
}

/*
ApplyReplicationScalePlanServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow replica movement operations at this time.
*/
type ApplyReplicationScalePlanServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this apply replication scale plan service unavailable response has a 2xx status code
func (o *ApplyReplicationScalePlanServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this apply replication scale plan service unavailable response has a 3xx status code
func (o *ApplyReplicationScalePlanServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this apply replication scale plan service unavailable response has a 4xx status code
func (o *ApplyReplicationScalePlanServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this apply replication scale plan service unavailable response has a 5xx status code
func (o *ApplyReplicationScalePlanServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this apply replication scale plan service unavailable response a status code equal to that given
func (o *ApplyReplicationScalePlanServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the apply replication scale plan service unavailable response
func (o *ApplyReplicationScalePlanServiceUnavailable) Code() int {
	return 503
}

func (o *ApplyReplicationScalePlanServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ApplyReplicationScalePlanServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /replication/scale][%d] applyReplicationScalePlanServiceUnavailable  %+v", 503, o.Payload)
}

func (o *ApplyReplicationScalePlanServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *ApplyReplicationScalePlanServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
