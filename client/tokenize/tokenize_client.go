...
func (a *Client) Tokenize(params *TokenizeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*TokenizeOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for tokenize: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
