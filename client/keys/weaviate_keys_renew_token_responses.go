...
func (o *WeaviateKeysRenewTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		result := NewWeaviateKeysRenewTokenInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWeaviateKeysRenewTokenInternalServerError creates a WeaviateKeysRenewTokenInternalServerError with default headers values
...
/*WeaviateKeysRenewTokenInternalServerError handles this case with default header values.
...
func (o *WeaviateKeysRenewTokenInternalServerError) Error() string {
	return fmt.Sprintf("[PUT /keys/{keyId}/renew-token][%d] weaviateKeysRenewTokenInternalServerError  %+v", 500, o.Payload)
}

func (o *WeaviateKeysRenewTokenInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
