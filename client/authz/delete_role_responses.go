...
func (o *DeleteRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewDeleteRoleServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteRoleServiceUnavailable creates a DeleteRoleServiceUnavailable with default headers values
func NewDeleteRoleServiceUnavailable() *DeleteRoleServiceUnavailable {
	return &DeleteRoleServiceUnavailable{}
}

/*
DeleteRoleServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this delete role service unavailable response has a 2xx status code
func (o *DeleteRoleServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete role service unavailable response has a 3xx status code
func (o *DeleteRoleServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete role service unavailable response has a 4xx status code
func (o *DeleteRoleServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete role service unavailable response has a 5xx status code
func (o *DeleteRoleServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this delete role service unavailable response a status code equal to that given
func (o *DeleteRoleServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the delete role service unavailable response
func (o *DeleteRoleServiceUnavailable) Code() int {
	return 503
}

func (o *DeleteRoleServiceUnavailable) Error() string {
	return fmt.Sprintf("[DELETE /authz/roles/{id}][%d] deleteRoleServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DeleteRoleServiceUnavailable) String() string {
	return fmt.Sprintf("[DELETE /authz/roles/{id}][%d] deleteRoleServiceUnavailable  %+v", 503, o.Payload)
}

func (o *DeleteRoleServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *DeleteRoleServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
