...
func (o *HasPermissionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewHasPermissionServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewHasPermissionServiceUnavailable creates a HasPermissionServiceUnavailable with default headers values
func NewHasPermissionServiceUnavailable() *HasPermissionServiceUnavailable {
	return &HasPermissionServiceUnavailable{}
}

/*
HasPermissionServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this has permission service unavailable response has a 2xx status code
func (o *HasPermissionServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this has permission service unavailable response has a 3xx status code
func (o *HasPermissionServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this has permission service unavailable response has a 4xx status code
func (o *HasPermissionServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this has permission service unavailable response has a 5xx status code
func (o *HasPermissionServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this has permission service unavailable response a status code equal to that given
func (o *HasPermissionServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the has permission service unavailable response
func (o *HasPermissionServiceUnavailable) Code() int {
	return 503
}

func (o *HasPermissionServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /authz/roles/{id}/has-permission][%d] hasPermissionServiceUnavailable  %+v", 503, o.Payload)
}

func (o *HasPermissionServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /authz/roles/{id}/has-permission][%d] hasPermissionServiceUnavailable  %+v", 503, o.Payload)
}

func (o *HasPermissionServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *HasPermissionServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
