...
func (o *GetGroupsForRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewGetGroupsForRoleServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetGroupsForRoleServiceUnavailable creates a GetGroupsForRoleServiceUnavailable with default headers values
func NewGetGroupsForRoleServiceUnavailable() *GetGroupsForRoleServiceUnavailable {
	return &GetGroupsForRoleServiceUnavailable{}
}

/*
GetGroupsForRoleServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow users operations at this time.
*/
type GetGroupsForRoleServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this get groups for role service unavailable response has a 2xx status code
func (o *GetGroupsForRoleServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get groups for role service unavailable response has a 3xx status code
func (o *GetGroupsForRoleServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get groups for role service unavailable response has a 4xx status code
func (o *GetGroupsForRoleServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this get groups for role service unavailable response has a 5xx status code
func (o *GetGroupsForRoleServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this get groups for role service unavailable response a status code equal to that given
func (o *GetGroupsForRoleServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the get groups for role service unavailable response
func (o *GetGroupsForRoleServiceUnavailable) Code() int {
	return 503
}

func (o *GetGroupsForRoleServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /authz/roles/{id}/group-assignments][%d] getGroupsForRoleServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetGroupsForRoleServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /authz/roles/{id}/group-assignments][%d] getGroupsForRoleServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetGroupsForRoleServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *GetGroupsForRoleServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
