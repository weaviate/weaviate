...
func (o *GetRolesForUserDeprecatedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewGetRolesForUserDeprecatedServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetRolesForUserDeprecatedServiceUnavailable creates a GetRolesForUserDeprecatedServiceUnavailable with default headers values
...
/*
GetRolesForUserDeprecatedServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this get roles for user deprecated service unavailable response has a 2xx status code
func (o *GetRolesForUserDeprecatedServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get roles for user deprecated service unavailable response has a 3xx status code
func (o *GetRolesForUserDeprecatedServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get roles for user deprecated service unavailable response has a 4xx status code
func (o *GetRolesForUserDeprecatedServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this get roles for user deprecated service unavailable response has a 5xx status code
func (o *GetRolesForUserDeprecatedServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this get roles for user deprecated service unavailable response a status code equal to that given
func (o *GetRolesForUserDeprecatedServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the get roles for user deprecated service unavailable response
func (o *GetRolesForUserDeprecatedServiceUnavailable) Code() int {
	return 503
}

func (o *GetRolesForUserDeprecatedServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /authz/users/{id}/roles][%d] getRolesForUserDeprecatedServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetRolesForUserDeprecatedServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /authz/users/{id}/roles][%d] getRolesForUserDeprecatedServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetRolesForUserDeprecatedServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *GetRolesForUserDeprecatedServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
