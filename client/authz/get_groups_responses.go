...
// Code gets the status code for the get groups not found response
func (o *GetGroupsNotFound) Code() int {
	return 404
}

func (o *GetGroupsNotFound) Error() string {
	return fmt.Sprintf("[GET /authz/groups/{groupType}][%d] getGroupsNotFound ", 404)
}
