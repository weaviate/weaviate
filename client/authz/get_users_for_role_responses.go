...
func (o *GetUsersForRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewGetUsersForRoleServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetUsersForRoleServiceUnavailable creates a GetUsersForRoleServiceUnavailable with default headers values
func NewGetUsersForRoleServiceUnavailable() *GetUsersForRoleServiceUnavailable {
	return &GetUsersForRoleServiceUnavailable{}
}

/*
GetUsersForRoleServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow users operations at this time.
*/
type GetUsersForRoleServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this get users for role service unavailable response has a 2xx status code
func (o *GetUsersForRoleServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get users for role service unavailable response has a 3xx status code
func (o *GetUsersForRoleServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get users for role service unavailable response has a 4xx status code
func (o *GetUsersForRoleServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this get users for role service unavailable response has a 5xx status code
func (o *GetUsersForRoleServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this get users for role service unavailable response a status code equal to that given
func (o *GetUsersForRoleServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the get users for role service unavailable response
func (o *GetUsersForRoleServiceUnavailable) Code() int {
	return 503
}

func (o *GetUsersForRoleServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /authz/roles/{id}/user-assignments][%d] getUsersForRoleServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetUsersForRoleServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /authz/roles/{id}/user-assignments][%d] getUsersForRoleServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetUsersForRoleServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *GetUsersForRoleServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
