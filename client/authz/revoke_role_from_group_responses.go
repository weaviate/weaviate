...
func (o *RevokeRoleFromGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewRevokeRoleFromGroupServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRevokeRoleFromGroupServiceUnavailable creates a RevokeRoleFromGroupServiceUnavailable with default headers values
...
/*
RevokeRoleFromGroupServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this revoke role from group service unavailable response has a 2xx status code
func (o *RevokeRoleFromGroupServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this revoke role from group service unavailable response has a 3xx status code
func (o *RevokeRoleFromGroupServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this revoke role from group service unavailable response has a 4xx status code
func (o *RevokeRoleFromGroupServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this revoke role from group service unavailable response has a 5xx status code
func (o *RevokeRoleFromGroupServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this revoke role from group service unavailable response a status code equal to that given
func (o *RevokeRoleFromGroupServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the revoke role from group service unavailable response
func (o *RevokeRoleFromGroupServiceUnavailable) Code() int {
	return 503
}

func (o *RevokeRoleFromGroupServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /authz/groups/{id}/revoke][%d] revokeRoleFromGroupServiceUnavailable  %+v", 503, o.Payload)
}

func (o *RevokeRoleFromGroupServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /authz/groups/{id}/revoke][%d] revokeRoleFromGroupServiceUnavailable  %+v", 503, o.Payload)
}

func (o *RevokeRoleFromGroupServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *RevokeRoleFromGroupServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
