...
The operational mode of the server does not allow authz operations at this time.
*/
type GetRolesServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this get roles service unavailable response has a 2xx status code
func (o *GetRolesServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get roles service unavailable response has a 3xx status code
func (o *GetRolesServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get roles service unavailable response has a 4xx status code
func (o *GetRolesServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this get roles service unavailable response has a 5xx status code
func (o *GetRolesServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this get roles service unavailable response a status code equal to that given
func (o *GetRolesServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the get roles service unavailable response
func (o *GetRolesServiceUnavailable) Code() int {
	return 503
}

func (o *GetRolesServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /authz/roles][%d] getRolesServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetRolesServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /authz/roles][%d] getRolesServiceUnavailable  %+v", 503, o.Payload)
}

func (o *GetRolesServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}
