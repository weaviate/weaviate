...
func (o *AliasesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewAliasesCreateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAliasesCreateServiceUnavailable creates a AliasesCreateServiceUnavailable with default headers values
func NewAliasesCreateServiceUnavailable() *AliasesCreateServiceUnavailable {
	return &AliasesCreateServiceUnavailable{}
}

/*
AliasesCreateServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this aliases create service unavailable response has a 2xx status code
func (o *AliasesCreateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this aliases create service unavailable response has a 3xx status code
func (o *AliasesCreateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this aliases create service unavailable response has a 4xx status code
func (o *AliasesCreateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this aliases create service unavailable response has a 5xx status code
func (o *AliasesCreateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this aliases create service unavailable response a status code equal to that given
func (o *AliasesCreateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the aliases create service unavailable response
func (o *AliasesCreateServiceUnavailable) Code() int {
	return 503
}

func (o *AliasesCreateServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /aliases][%d] aliasesCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *AliasesCreateServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /aliases][%d] aliasesCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *AliasesCreateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *AliasesCreateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
