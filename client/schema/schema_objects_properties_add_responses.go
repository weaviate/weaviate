...
func (o *SchemaObjectsPropertiesAddReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewSchemaObjectsPropertiesAddServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSchemaObjectsPropertiesAddServiceUnavailable creates a SchemaObjectsPropertiesAddServiceUnavailable with default headers values
func NewSchemaObjectsPropertiesAddServiceUnavailable() *SchemaObjectsPropertiesAddServiceUnavailable {
	return &SchemaObjectsPropertiesAddServiceUnavailable{}
}

/*
SchemaObjectsPropertiesAddServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow schema operations at this time.
*/
type SchemaObjectsPropertiesAddServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this schema objects properties add service unavailable response has a 2xx status code
func (o *SchemaObjectsPropertiesAddServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this schema objects properties add service unavailable response has a 3xx status code
func (o *SchemaObjectsPropertiesAddServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this schema objects properties add service unavailable response has a 4xx status code
func (o *SchemaObjectsPropertiesAddServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this schema objects properties add service unavailable response has a 5xx status code
func (o *SchemaObjectsPropertiesAddServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this schema objects properties add service unavailable response a status code equal to that given
func (o *SchemaObjectsPropertiesAddServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the schema objects properties add service unavailable response
func (o *SchemaObjectsPropertiesAddServiceUnavailable) Code() int {
	return 503
}

func (o *SchemaObjectsPropertiesAddServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /schema/{className}/properties][%d] schemaObjectsPropertiesAddServiceUnavailable  %+v", 503, o.Payload)
}

func (o *SchemaObjectsPropertiesAddServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /schema/{className}/properties][%d] schemaObjectsPropertiesAddServiceUnavailable  %+v", 503, o.Payload)
}

func (o *SchemaObjectsPropertiesAddServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *SchemaObjectsPropertiesAddServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
