...
func (o *TenantsGetOneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewTenantsGetOneServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenantsGetOneServiceUnavailable creates a TenantsGetOneServiceUnavailable with default headers values
func NewTenantsGetOneServiceUnavailable() *TenantsGetOneServiceUnavailable {
	return &TenantsGetOneServiceUnavailable{}
}

/*
TenantsGetOneServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this tenants get one service unavailable response has a 2xx status code
func (o *TenantsGetOneServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenants get one service unavailable response has a 3xx status code
func (o *TenantsGetOneServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenants get one service unavailable response has a 4xx status code
func (o *TenantsGetOneServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this tenants get one service unavailable response has a 5xx status code
func (o *TenantsGetOneServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this tenants get one service unavailable response a status code equal to that given
func (o *TenantsGetOneServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the tenants get one service unavailable response
func (o *TenantsGetOneServiceUnavailable) Code() int {
	return 503
}

func (o *TenantsGetOneServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /schema/{className}/tenants/{tenantName}][%d] tenantsGetOneServiceUnavailable  %+v", 503, o.Payload)
}

func (o *TenantsGetOneServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /schema/{className}/tenants/{tenantName}][%d] tenantsGetOneServiceUnavailable  %+v", 503, o.Payload)
}

func (o *TenantsGetOneServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *TenantsGetOneServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
