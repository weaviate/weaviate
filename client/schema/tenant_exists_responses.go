...
func (o *TenantExistsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewTenantExistsServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenantExistsServiceUnavailable creates a TenantExistsServiceUnavailable with default headers values
func NewTenantExistsServiceUnavailable() *TenantExistsServiceUnavailable {
	return &TenantExistsServiceUnavailable{}
}

/*
TenantExistsServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this tenant exists service unavailable response has a 2xx status code
func (o *TenantExistsServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenant exists service unavailable response has a 3xx status code
func (o *TenantExistsServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenant exists service unavailable response has a 4xx status code
func (o *TenantExistsServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this tenant exists service unavailable response has a 5xx status code
func (o *TenantExistsServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this tenant exists service unavailable response a status code equal to that given
func (o *TenantExistsServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the tenant exists service unavailable response
func (o *TenantExistsServiceUnavailable) Code() int {
	return 503
}

func (o *TenantExistsServiceUnavailable) Error() string {
	return fmt.Sprintf("[HEAD /schema/{className}/tenants/{tenantName}][%d] tenantExistsServiceUnavailable  %+v", 503, o.Payload)
}

func (o *TenantExistsServiceUnavailable) String() string {
	return fmt.Sprintf("[HEAD /schema/{className}/tenants/{tenantName}][%d] tenantExistsServiceUnavailable  %+v", 503, o.Payload)
}

func (o *TenantExistsServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *TenantExistsServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
