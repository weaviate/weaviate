...
func (o *SchemaObjectsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewSchemaObjectsCreateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSchemaObjectsCreateServiceUnavailable creates a SchemaObjectsCreateServiceUnavailable with default headers values
...
/*
SchemaObjectsCreateServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this schema objects create service unavailable response has a 2xx status code
func (o *SchemaObjectsCreateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this schema objects create service unavailable response has a 3xx status code
func (o *SchemaObjectsCreateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this schema objects create service unavailable response has a 4xx status code
func (o *SchemaObjectsCreateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this schema objects create service unavailable response has a 5xx status code
func (o *SchemaObjectsCreateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this schema objects create service unavailable response a status code equal to that given
func (o *SchemaObjectsCreateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the schema objects create service unavailable response
func (o *SchemaObjectsCreateServiceUnavailable) Code() int {
	return 503
}

func (o *SchemaObjectsCreateServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /schema][%d] schemaObjectsCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *SchemaObjectsCreateServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /schema][%d] schemaObjectsCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *SchemaObjectsCreateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *SchemaObjectsCreateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
