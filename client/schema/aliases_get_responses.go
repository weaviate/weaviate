...
func (o *AliasesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewAliasesGetServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAliasesGetServiceUnavailable creates a AliasesGetServiceUnavailable with default headers values
func NewAliasesGetServiceUnavailable() *AliasesGetServiceUnavailable {
	return &AliasesGetServiceUnavailable{}
}

/*
AliasesGetServiceUnavailable describes a response with status code 503, with default header values.

The operational mode of the server does not allow aliases operations at this time.
*/
type AliasesGetServiceUnavailable struct {
	Payload *models.ErrorResponse
}

// IsSuccess returns true when this aliases get service unavailable response has a 2xx status code
func (o *AliasesGetServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this aliases get service unavailable response has a 3xx status code
func (o *AliasesGetServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this aliases get service unavailable response has a 4xx status code
func (o *AliasesGetServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this aliases get service unavailable response has a 5xx status code
func (o *AliasesGetServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this aliases get service unavailable response a status code equal to that given
func (o *AliasesGetServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the aliases get service unavailable response
func (o *AliasesGetServiceUnavailable) Code() int {
	return 503
}

func (o *AliasesGetServiceUnavailable) Error() string {
	return fmt.Sprintf("[GET /aliases][%d] aliasesGetServiceUnavailable  %+v", 503, o.Payload)
}

func (o *AliasesGetServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /aliases][%d] aliasesGetServiceUnavailable  %+v", 503, o.Payload)
}

func (o *AliasesGetServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *AliasesGetServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
