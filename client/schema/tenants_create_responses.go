...
func (o *TenantsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewTenantsCreateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenantsCreateServiceUnavailable creates a TenantsCreateServiceUnavailable with default headers values
func NewTenantsCreateServiceUnavailable() *TenantsCreateServiceUnavailable {
	return &TenantsCreateServiceUnavailable{}
}

/*
TenantsCreateServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this tenants create service unavailable response has a 2xx status code
func (o *TenantsCreateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenants create service unavailable response has a 3xx status code
func (o *TenantsCreateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenants create service unavailable response has a 4xx status code
func (o *TenantsCreateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this tenants create service unavailable response has a 5xx status code
func (o *TenantsCreateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this tenants create service unavailable response a status code equal to that given
func (o *TenantsCreateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the tenants create service unavailable response
func (o *TenantsCreateServiceUnavailable) Code() int {
	return 503
}

func (o *TenantsCreateServiceUnavailable) Error() string {
	return fmt.Sprintf("[POST /schema/{className}/tenants][%d] tenantsCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *TenantsCreateServiceUnavailable) String() string {
	return fmt.Sprintf("[POST /schema/{className}/tenants][%d] tenantsCreateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *TenantsCreateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *TenantsCreateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
