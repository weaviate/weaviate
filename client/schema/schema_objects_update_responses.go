...
func (o *SchemaObjectsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	case 503:
		result := NewSchemaObjectsUpdateServiceUnavailable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSchemaObjectsUpdateServiceUnavailable creates a SchemaObjectsUpdateServiceUnavailable with default headers values
...
/*
SchemaObjectsUpdateServiceUnavailable describes a response with status code 503, with default header values.
...
// IsSuccess returns true when this schema objects update service unavailable response has a 2xx status code
func (o *SchemaObjectsUpdateServiceUnavailable) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this schema objects update service unavailable response has a 3xx status code
func (o *SchemaObjectsUpdateServiceUnavailable) IsRedirect() bool {
	return false
}

// IsClientError returns true when this schema objects update service unavailable response has a 4xx status code
func (o *SchemaObjectsUpdateServiceUnavailable) IsClientError() bool {
	return false
}

// IsServerError returns true when this schema objects update service unavailable response has a 5xx status code
func (o *SchemaObjectsUpdateServiceUnavailable) IsServerError() bool {
	return true
}

// IsCode returns true when this schema objects update service unavailable response a status code equal to that given
func (o *SchemaObjectsUpdateServiceUnavailable) IsCode(code int) bool {
	return code == 503
}

// Code gets the status code for the schema objects update service unavailable response
func (o *SchemaObjectsUpdateServiceUnavailable) Code() int {
	return 503
}

func (o *SchemaObjectsUpdateServiceUnavailable) Error() string {
	return fmt.Sprintf("[PUT /schema/{className}][%d] schemaObjectsUpdateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *SchemaObjectsUpdateServiceUnavailable) String() string {
	return fmt.Sprintf("[PUT /schema/{className}][%d] schemaObjectsUpdateServiceUnavailable  %+v", 503, o.Payload)
}

func (o *SchemaObjectsUpdateServiceUnavailable) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *SchemaObjectsUpdateServiceUnavailable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
