...
const (
	TenantActivityStatus_ACTIVITY_STATUS_UNSPECIFIED TenantActivityStatus = 0
	TenantActivityStatus_ACTIVITY_STATUS_HOT         TenantActivityStatus = 1
	TenantActivityStatus_ACTIVITY_STATUS_COLD        TenantActivityStatus = 2
	TenantActivityStatus_ACTIVITY_STATUS_WARM        TenantActivityStatus = 3
	TenantActivityStatus_ACTIVITY_STATUS_FROZEN      TenantActivityStatus = 4
)
...
var (
	TenantActivityStatus_name = map[int32]string{
		...
		1: "ACTIVITY_STATUS_HOT",
		2: "ACTIVITY_STATUS_COLD",
		3: "ACTIVITY_STATUS_WARM",
		4: "ACTIVITY_STATUS_FROZEN",
	}
	TenantActivityStatus_value = map[string]int32{
		"ACTIVITY_STATUS_UNSPECIFIED": 0,
		"ACTIVITY_STATUS_HOT":         1,
		"ACTIVITY_STATUS_COLD":        2,
		"ACTIVITY_STATUS_WARM":        3,
		"ACTIVITY_STATUS_FROZEN":      4,
	}
)
...
type TenantsGetRequest struct {
	...
	// we will probably need to add a tenant-cursor api at some point, so make this easily extendable
	//
	// Types that are assignable to TenantParameters:
	//
	//	*TenantsGetRequest_Name
	TenantParameters isTenantsGetRequest_TenantParameters `protobuf_oneof:"tenant_parameters"`
}
...
func (m *TenantsGetRequest) GetTenantParameters() isTenantsGetRequest_TenantParameters {
	if m != nil {
		return m.TenantParameters
	}
	return nil
}

func (x *TenantsGetRequest) GetName() string {
	if x, ok := x.GetTenantParameters().(*TenantsGetRequest_Name); ok {
		return x.Name
	}
	return ""
}

type isTenantsGetRequest_TenantParameters interface {
	isTenantsGetRequest_TenantParameters()
}

type TenantsGetRequest_Name struct {
	Name string `protobuf:"bytes,2,opt,name=name,proto3,oneof"`
}

func (*TenantsGetRequest_Name) isTenantsGetRequest_TenantParameters() {}
...
type TenantsGetReply struct {
	...
	Tenants []*Tenants `protobuf:"bytes,2,rep,name=tenants,proto3" json:"tenants,omitempty"`
}
...
func (x *TenantsGetReply) GetTenants() []*Tenants {
	if x != nil {
		return x.Tenants
	}
	return nil
...
func (x *Tenants) GetActivityStatus() TenantActivityStatus {
	if x != nil {
		return x.ActivityStatus
	}
	return TenantActivityStatus_ACTIVITY_STATUS_UNSPECIFIED
}
...
var file_v1_tenants_proto_rawDesc = []byte{
	...
	0x5e, 0x0a, 0x11, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x73, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71,
	...
	,
	...
	0x43, 0x54, 0x49, 0x56, 0x49, 0x54, 0x59, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x48,
	0x4f, 0x54, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x41, 0x43, 0x54, 0x49, 0x56, 0x49, 0x54, 0x59,
	0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x43, 0x4f, 0x4c, 0x44, 0x10, 0x02, 0x12, 0x18,
	0x0a, 0x14, 0x41, 0x43, 0x54, 0x49, 0x56, 0x49, 0x54, 0x59, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55,
	0x53, 0x5f, 0x57, 0x41, 0x52, 0x4d, 0x10, 0x03, 0x12, 0x1a, 0x0a, 0x16, 0x41, 0x43, 0x54, 0x49,
...
var (
	...
	file_v1_tenants_proto_msgTypes  = make([]protoimpl.MessageInfo, 3)
	file_v1_tenants_proto_goTypes   = []interface{}{
		...
		(*TenantsGetReply)(nil),   // 2: weaviate.v1.TenantsGetReply
		(*Tenants)(nil),           // 3: weaviate.v1.Tenants
	}
)

var file_v1_tenants_proto_depIdxs = []int32{
	3, // 0: weaviate.v1.TenantsGetReply.tenants:type_name -> weaviate.v1.Tenants
	0, // 1: weaviate.v1.Tenants.activity_status:type_name -> weaviate.v1.TenantActivityStatus
