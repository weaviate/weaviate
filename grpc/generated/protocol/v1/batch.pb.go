...
type BatchObjectsReply_BatchError struct {
	...
	//
	//	*BatchObjectsReply_BatchError_ThirdPartyError
	Errors isBatchObjectsReply_BatchError_Errors `protobuf_oneof:"errors"`
}
...
func (m *BatchObjectsReply_BatchError) GetErrors() isBatchObjectsReply_BatchError_Errors {
	if m != nil {
		return m.Errors
	}
	return nil
...
func (x *BatchObjectsReply_BatchError) GetThirdPartyError() *ThirdPartyError {
	if x, ok := x.GetErrors().(*BatchObjectsReply_BatchError_ThirdPartyError); ok {
		return x.ThirdPartyError
	}
	return nil
}

type isBatchObjectsReply_BatchError_Errors interface {
	isBatchObjectsReply_BatchError_Errors()
}

type BatchObjectsReply_BatchError_ThirdPartyError struct {
	ThirdPartyError *ThirdPartyError `protobuf:"bytes,3,opt,name=third_party_error,json=thirdPartyError,proto3,oneof"`
}

func (*BatchObjectsReply_BatchError_ThirdPartyError) isBatchObjectsReply_BatchError_Errors() {}
...
var file_v1_batch_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xfb, 0x01, 0x0a, 0x11, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x62,
	...
	0x73, 0x1a, 0x8e, 0x01, 0x0a, 0x0a, 0x42, 0x61, 0x74, 0x63, 0x68, 0x45, 0x72, 0x72, 0x6f, 0x72,
	...
	,
...
var (
	...
	file_v1_batch_proto_goTypes  = []interface{}{
		...
		(*ThirdPartyError)(nil),                  // 16: weaviate.v1.ThirdPartyError
	}
)
...
var file_v1_batch_proto_depIdxs = []int32{
	...
	16, // 14: weaviate.v1.BatchObjectsReply.BatchError.third_party_error:type_name -> weaviate.v1.ThirdPartyError
...
func file_v1_batch_proto_init() {
	...
	file_v1_batch_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*BatchObjectsReply_BatchError_ThirdPartyError)(nil),
	}
	type x struct{}
