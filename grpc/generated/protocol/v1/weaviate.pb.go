...
var file_v1_weaviate_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0x9e, 0x04, 0x0a, 0x08, 0x57, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x12,
	...
	,
...
var file_v1_weaviate_proto_goTypes = []interface{}{
	...
	(*BatchReadRequest)(nil),    // 6: weaviate.v1.BatchReadRequest
	(*SearchReply)(nil),         // 7: weaviate.v1.SearchReply
	(*BatchObjectsReply)(nil),   // 8: weaviate.v1.BatchObjectsReply
	(*BatchDeleteReply)(nil),    // 9: weaviate.v1.BatchDeleteReply
	(*TenantsGetReply)(nil),     // 10: weaviate.v1.TenantsGetReply
	(*AggregateReply)(nil),      // 11: weaviate.v1.AggregateReply
	(*BatchWriteReply)(nil),     // 12: weaviate.v1.BatchWriteReply
...
var file_v1_weaviate_proto_depIdxs = []int32{
	...
	5,  // 5: weaviate.v1.Weaviate.BatchWrite:input_type -> weaviate.v1.BatchMessage
	6,  // 6: weaviate.v1.Weaviate.BatchRead:input_type -> weaviate.v1.BatchReadRequest
	...
	9,  // 9: weaviate.v1.Weaviate.BatchDelete:output_type -> weaviate.v1.BatchDeleteReply
	10, // 10: weaviate.v1.Weaviate.TenantsGet:output_type -> weaviate.v1.TenantsGetReply
	11, // 11: weaviate.v1.Weaviate.Aggregate:output_type -> weaviate.v1.AggregateReply
	12, // 12: weaviate.v1.Weaviate.BatchWrite:output_type -> weaviate.v1.BatchWriteReply
	13, // 13: weaviate.v1.Weaviate.BatchRead:output_type -> weaviate.v1.BatchError
