...
func (x *NumberValues) GetValues() []float64 {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *IntValues) GetValues() []int64 {
	if x != nil {
		return x.Values
	}
	return nil
...
var file_v1_properties_proto_depIdxs = []int32{
	...
	4,  // 8: weaviate.v1.ListValue.text_values:type_name -> weaviate.v1.TextValues
	5,  // 9: weaviate.v1.ListValue.bool_values:type_name -> weaviate.v1.BoolValues
	6,  // 10: weaviate.v1.ListValue.object_values:type_name -> weaviate.v1.ObjectValues
	7,  // 11: weaviate.v1.ListValue.date_values:type_name -> weaviate.v1.DateValues
	8,  // 12: weaviate.v1.ListValue.uuid_values:type_name -> weaviate.v1.UuidValues
	9,  // 13: weaviate.v1.ListValue.int_values:type_name -> weaviate.v1.IntValues
