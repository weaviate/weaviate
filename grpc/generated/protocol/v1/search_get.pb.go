...
type TargetVectorJoinMethod int32

const (
	TargetVectorJoinMethod_TARGET_VECTOR_JOIN_METHOD_UNSPECIFIED         TargetVectorJoinMethod = 0
	TargetVectorJoinMethod_TARGET_VECTOR_JOIN_METHOD_TYPE_SUM            TargetVectorJoinMethod = 1
	TargetVectorJoinMethod_TARGET_VECTOR_JOIN_METHOD_TYPE_MIN            TargetVectorJoinMethod = 2
	TargetVectorJoinMethod_TARGET_VECTOR_JOIN_METHOD_TYPE_AVERAGE        TargetVectorJoinMethod = 3
	TargetVectorJoinMethod_TARGET_VECTOR_JOIN_METHOD_TYPE_RELATIVE_SCORE TargetVectorJoinMethod = 4
)

// Enum value maps for TargetVectorJoinMethod.
var (
	TargetVectorJoinMethod_name = map[int32]string{
		0: "TARGET_VECTOR_JOIN_METHOD_UNSPECIFIED",
		1: "TARGET_VECTOR_JOIN_METHOD_TYPE_SUM",
		2: "TARGET_VECTOR_JOIN_METHOD_TYPE_MIN",
		3: "TARGET_VECTOR_JOIN_METHOD_TYPE_AVERAGE",
		4: "TARGET_VECTOR_JOIN_METHOD_TYPE_RELATIVE_SCORE",
	}
	TargetVectorJoinMethod_value = map[string]int32{
		"TARGET_VECTOR_JOIN_METHOD_UNSPECIFIED":         0,
		"TARGET_VECTOR_JOIN_METHOD_TYPE_SUM":            1,
		"TARGET_VECTOR_JOIN_METHOD_TYPE_MIN":            2,
		"TARGET_VECTOR_JOIN_METHOD_TYPE_AVERAGE":        3,
		"TARGET_VECTOR_JOIN_METHOD_TYPE_RELATIVE_SCORE": 4,
	}
)

func (x TargetVectorJoinMethod) Enum() *TargetVectorJoinMethod {
	p := new(TargetVectorJoinMethod)
	*p = x
	return p
}

func (x TargetVectorJoinMethod) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TargetVectorJoinMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_search_get_proto_enumTypes[0].Descriptor()
}

func (TargetVectorJoinMethod) Type() protoreflect.EnumType {
	return &file_v1_search_get_proto_enumTypes[0]
}

func (x TargetVectorJoinMethod) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TargetVectorJoinMethod.Descriptor instead.
func (TargetVectorJoinMethod) EnumDescriptor() ([]byte, []int) {
...
type SearchRequest struct {
	...
	TargetVectorJoin *TargetVectorJoin `protobuf:"bytes,12,opt,name=target_vector_join,json=targetVectorJoin,proto3" json:"target_vector_join,omitempty"`
	// what is returned
...
func (x *SearchRequest) GetTargetVectorJoin() *TargetVectorJoin {
	if x != nil {
		return x.TargetVectorJoin
	}
	return nil
}
...
type TargetVectorJoin struct {
	...
	// Types that are assignable to TargetJoin:
	//
	//	*TargetVectorJoin_Join
	//	*TargetVectorJoin_ManualWeights_
	TargetJoin isTargetVectorJoin_TargetJoin `protobuf_oneof:"target_join"`
}

func (x *TargetVectorJoin) Reset() {
	*x = TargetVectorJoin{}
	if protoimpl.UnsafeEnabled {
...
func (x *TargetVectorJoin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetVectorJoin) ProtoMessage() {}

func (x *TargetVectorJoin) ProtoReflect() protoreflect.Message {
	mi := &file_v1_search_get_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetVectorJoin.ProtoReflect.Descriptor instead.
func (*TargetVectorJoin) Descriptor() ([]byte, []int) {
	return file_v1_search_get_proto_rawDescGZIP(), []int{7}
}

func (m *TargetVectorJoin) GetTargetJoin() isTargetVectorJoin_TargetJoin {
	if m != nil {
		return m.TargetJoin
	}
	return nil
...
func (x *TargetVectorJoin) GetJoin() TargetVectorJoinMethod {
	if x, ok := x.GetTargetJoin().(*TargetVectorJoin_Join); ok {
		return x.Join
	}
	return TargetVectorJoinMethod_TARGET_VECTOR_JOIN_METHOD_UNSPECIFIED
}

func (x *TargetVectorJoin) GetManualWeights() *TargetVectorJoin_ManualWeightsArrays {
	if x, ok := x.GetTargetJoin().(*TargetVectorJoin_ManualWeights_); ok {
		return x.ManualWeights
	}
	return nil
}

type isTargetVectorJoin_TargetJoin interface {
	isTargetVectorJoin_TargetJoin()
}

type TargetVectorJoin_Join struct {
	Join TargetVectorJoinMethod `protobuf:"varint,1,opt,name=join,proto3,enum=weaviate.v1.TargetVectorJoinMethod,oneof"`
}

type TargetVectorJoin_ManualWeights_ struct {
	ManualWeights *TargetVectorJoin_ManualWeightsArrays `protobuf:"bytes,2,opt,name=manual_weights,json=manualWeights,proto3,oneof"` // no maps in oneof allowed
}

func (*TargetVectorJoin_Join) isTargetVectorJoin_TargetJoin() {}

func (*TargetVectorJoin_ManualWeights_) isTargetVectorJoin_TargetJoin() {}
...
type TargetVectorJoin_ManualWeights struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TargetVectorJoin_ManualWeights) Reset() {
	*x = TargetVectorJoin_ManualWeights{}
	if protoimpl.UnsafeEnabled {
...
func (x *TargetVectorJoin_ManualWeights) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetVectorJoin_ManualWeights) ProtoMessage() {}

func (x *TargetVectorJoin_ManualWeights) ProtoReflect() protoreflect.Message {
	mi := &file_v1_search_get_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetVectorJoin_ManualWeights.ProtoReflect.Descriptor instead.
func (*TargetVectorJoin_ManualWeights) Descriptor() ([]byte, []int) {
	return file_v1_search_get_proto_rawDescGZIP(), []int{7, 0}
}

func (x *TargetVectorJoin_ManualWeights) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *TargetVectorJoin_ManualWeights) GetValue() float32 {
	if x != nil {
		return x.Value
	}
	return 0
...
type TargetVectorJoin_ManualWeightsArrays struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Vals []*TargetVectorJoin_ManualWeights `protobuf:"bytes,1,rep,name=vals,proto3" json:"vals,omitempty"`
}

func (x *TargetVectorJoin_ManualWeightsArrays) Reset() {
	*x = TargetVectorJoin_ManualWeightsArrays{}
	if protoimpl.UnsafeEnabled {
...
func (x *TargetVectorJoin_ManualWeightsArrays) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetVectorJoin_ManualWeightsArrays) ProtoMessage() {}

func (x *TargetVectorJoin_ManualWeightsArrays) ProtoReflect() protoreflect.Message {
	mi := &file_v1_search_get_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetVectorJoin_ManualWeightsArrays.ProtoReflect.Descriptor instead.
func (*TargetVectorJoin_ManualWeightsArrays) Descriptor() ([]byte, []int) {
	return file_v1_search_get_proto_rawDescGZIP(), []int{7, 1}
}

func (x *TargetVectorJoin_ManualWeightsArrays) GetVals() []*TargetVectorJoin_ManualWeights {
	if x != nil {
		return x.Vals
	}
	return nil
...
var file_v1_search_get_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xee, 0x0d, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x65, 0x73, 0x22, 0xd2, 0x02, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x76, 0x65, 0x5f, 0x61, 0x77, 0x61, 0x79, 0x22, 0xad, 0x01, 0x0a, 0x0f, 0x4e, 0x65, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x42, 0x0c, 0x0a,
	0x0a, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x61, 0x69, 0x6e, 0x74, 0x79, 0x42, 0x0b, 0x0a, 0x09, 0x5f,
	0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xb3, 0x01, 0x0a, 0x11, 0x4e, 0x65, 0x61,
	...
	0x08, 0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x88, 0x01, 0x01, 0x12, 0x25, 0x0a, 0x0e,
	...
	0x79, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xa7,
	...
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x42, 0x0c, 0x0a,
	0x0a, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x61, 0x69, 0x6e, 0x74, 0x79, 0x42, 0x0b, 0x0a, 0x09, 0x5f,
	0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x3c, 0x0a, 0x04, 0x42, 0x4d, 0x32, 0x35,
	...
	0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x22, 0xec, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x66, 0x50, 0x72,
	0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x2d, 0x0a, 0x12, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x6f,
	0x70, 0x65, 0x72, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x72, 0x65, 0x66,
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x12, 0x3e,
	...
	0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x38,
	0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1c, 0x2e, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xd1, 0x01, 0x0a, 0x0a, 0x4e, 0x65, 0x61, 0x72, 0x56, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x12, 0x1a, 0x0a, 0x06, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x02, 0x42, 0x02, 0x18, 0x01, 0x52, 0x06, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72,
	...
	0x65, 0x88, 0x01, 0x01, 0x12, 0x21, 0x0a, 0x0c, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x62,
	0x79, 0x74, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x76, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x5f, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52,
	...
	0x5f, 0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xa2, 0x01, 0x0a, 0x0a, 0x4e, 0x65,
	0x61, 0x72, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x21, 0x0a, 0x09, 0x63, 0x65, 0x72, 0x74,
	0x61, 0x69, 0x6e, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x09, 0x63,
	0x65, 0x72, 0x74, 0x61, 0x69, 0x6e, 0x74, 0x79, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x08, 0x64,
	0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x48, 0x01, 0x52,
	0x08, 0x64, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x88, 0x01, 0x01, 0x12, 0x25, 0x0a, 0x0e,
	...
	0x08, 0x0a, 0x06, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0xfb, 0x01, 0x0a, 0x0b, 0x53, 0x65,
	...
	,
	...
	,
	...
	,
...
var (
	...
	file_v1_search_get_proto_msgTypes  = make([]protoimpl.MessageInfo, 32)
	file_v1_search_get_proto_goTypes   = []interface{}{
		(TargetVectorJoinMethod)(0),                  // 0: weaviate.v1.TargetVectorJoinMethod
		...
		(*TargetVectorJoin)(nil),                     // 9: weaviate.v1.TargetVectorJoin
		...
		(*TargetVectorJoin_ManualWeights)(nil),       // 31: weaviate.v1.TargetVectorJoin.ManualWeights
		(*TargetVectorJoin_ManualWeightsArrays)(nil), // 32: weaviate.v1.TargetVectorJoin.ManualWeightsArrays
		(*NearTextSearch_Move)(nil),                  // 33: weaviate.v1.NearTextSearch.Move
		(ConsistencyLevel)(0),                        // 34: weaviate.v1.ConsistencyLevel
		(*Filters)(nil),                              // 35: weaviate.v1.Filters
		(*Vectors)(nil),                              // 36: weaviate.v1.Vectors
		(*structpb.Struct)(nil),                      // 37: google.protobuf.Struct
		(*NumberArrayProperties)(nil),                // 38: weaviate.v1.NumberArrayProperties
		(*IntArrayProperties)(nil),                   // 39: weaviate.v1.IntArrayProperties
		(*TextArrayProperties)(nil),                  // 40: weaviate.v1.TextArrayProperties
		(*BooleanArrayProperties)(nil),               // 41: weaviate.v1.BooleanArrayProperties
		(*ObjectProperties)(nil),                     // 42: weaviate.v1.ObjectProperties
		(*ObjectArrayProperties)(nil),                // 43: weaviate.v1.ObjectArrayProperties
...
var file_v1_search_get_proto_depIdxs = []int32{
	...
	9,  // 1: weaviate.v1.SearchRequest.target_vector_join:type_name -> weaviate.v1.TargetVectorJoin
	7,  // 2: weaviate.v1.SearchRequest.properties:type_name -> weaviate.v1.PropertiesRequest
	6,  // 3: weaviate.v1.SearchRequest.metadata:type_name -> weaviate.v1.MetadataRequest
	3,  // 4: weaviate.v1.SearchRequest.group_by:type_name -> weaviate.v1.GroupBy
	4,  // 5: weaviate.v1.SearchRequest.sort_by:type_name -> weaviate.v1.SortBy
	35, // 6: weaviate.v1.SearchRequest.filters:type_name -> weaviate.v1.Filters
	10, // 7: weaviate.v1.SearchRequest.hybrid_search:type_name -> weaviate.v1.Hybrid
	18, // 8: weaviate.v1.SearchRequest.bm25_search:type_name -> weaviate.v1.BM25
	20, // 9: weaviate.v1.SearchRequest.near_vector:type_name -> weaviate.v1.NearVector
	21, // 10: weaviate.v1.SearchRequest.near_object:type_name -> weaviate.v1.NearObject
	11, // 11: weaviate.v1.SearchRequest.near_text:type_name -> weaviate.v1.NearTextSearch
	12, // 12: weaviate.v1.SearchRequest.near_image:type_name -> weaviate.v1.NearImageSearch
	13, // 13: weaviate.v1.SearchRequest.near_audio:type_name -> weaviate.v1.NearAudioSearch
	14, // 14: weaviate.v1.SearchRequest.near_video:type_name -> weaviate.v1.NearVideoSearch
	15, // 15: weaviate.v1.SearchRequest.near_depth:type_name -> weaviate.v1.NearDepthSearch
	16, // 16: weaviate.v1.SearchRequest.near_thermal:type_name -> weaviate.v1.NearThermalSearch
	17, // 17: weaviate.v1.SearchRequest.near_imu:type_name -> weaviate.v1.NearIMUSearch
	5,  // 18: weaviate.v1.SearchRequest.generative:type_name -> weaviate.v1.GenerativeSearch
	22, // 19: weaviate.v1.SearchRequest.rerank:type_name -> weaviate.v1.Rerank
	19, // 20: weaviate.v1.PropertiesRequest.ref_properties:type_name -> weaviate.v1.RefPropertiesRequest
	8,  // 21: weaviate.v1.PropertiesRequest.object_properties:type_name -> weaviate.v1.ObjectPropertiesRequest
	8,  // 22: weaviate.v1.ObjectPropertiesRequest.object_properties:type_name -> weaviate.v1.ObjectPropertiesRequest
	0,  // 23: weaviate.v1.TargetVectorJoin.join:type_name -> weaviate.v1.TargetVectorJoinMethod
	32, // 24: weaviate.v1.TargetVectorJoin.manual_weights:type_name -> weaviate.v1.TargetVectorJoin.ManualWeightsArrays
	...
	20, // 27: weaviate.v1.Hybrid.near_vector:type_name -> weaviate.v1.NearVector
	33, // 28: weaviate.v1.NearTextSearch.move_to:type_name -> weaviate.v1.NearTextSearch.Move
	33, // 29: weaviate.v1.NearTextSearch.move_away:type_name -> weaviate.v1.NearTextSearch.Move
	7,  // 30: weaviate.v1.RefPropertiesRequest.properties:type_name -> weaviate.v1.PropertiesRequest
	6,  // 31: weaviate.v1.RefPropertiesRequest.metadata:type_name -> weaviate.v1.MetadataRequest
	27, // 32: weaviate.v1.SearchReply.results:type_name -> weaviate.v1.SearchResult
	26, // 33: weaviate.v1.SearchReply.group_by_results:type_name -> weaviate.v1.GroupByResult
	27, // 34: weaviate.v1.GroupByResult.objects:type_name -> weaviate.v1.SearchResult
	24, // 35: weaviate.v1.GroupByResult.rerank:type_name -> weaviate.v1.RerankReply
	25, // 36: weaviate.v1.GroupByResult.generative:type_name -> weaviate.v1.GenerativeReply
	29, // 37: weaviate.v1.SearchResult.properties:type_name -> weaviate.v1.PropertiesResult
	28, // 38: weaviate.v1.SearchResult.metadata:type_name -> weaviate.v1.MetadataResult
	36, // 39: weaviate.v1.MetadataResult.vectors:type_name -> weaviate.v1.Vectors
	37, // 40: weaviate.v1.PropertiesResult.non_ref_properties:type_name -> google.protobuf.Struct
	30, // 41: weaviate.v1.PropertiesResult.ref_props:type_name -> weaviate.v1.RefPropertiesResult
	28, // 42: weaviate.v1.PropertiesResult.metadata:type_name -> weaviate.v1.MetadataResult
	38, // 43: weaviate.v1.PropertiesResult.number_array_properties:type_name -> weaviate.v1.NumberArrayProperties
	39, // 44: weaviate.v1.PropertiesResult.int_array_properties:type_name -> weaviate.v1.IntArrayProperties
	40, // 45: weaviate.v1.PropertiesResult.text_array_properties:type_name -> weaviate.v1.TextArrayProperties
	41, // 46: weaviate.v1.PropertiesResult.boolean_array_properties:type_name -> weaviate.v1.BooleanArrayProperties
	42, // 47: weaviate.v1.PropertiesResult.object_properties:type_name -> weaviate.v1.ObjectProperties
	43, // 48: weaviate.v1.PropertiesResult.object_array_properties:type_name -> weaviate.v1.ObjectArrayProperties
	44, // 49: weaviate.v1.PropertiesResult.non_ref_props:type_name -> weaviate.v1.Properties
	29, // 50: weaviate.v1.RefPropertiesResult.properties:type_name -> weaviate.v1.PropertiesResult
	31, // 51: weaviate.v1.TargetVectorJoin.ManualWeightsArrays.vals:type_name -> weaviate.v1.TargetVectorJoin.ManualWeights
...
func file_v1_search_get_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_search_get_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TargetVectorJoin_ManualWeights); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_search_get_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TargetVectorJoin_ManualWeightsArrays); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_v1_search_get_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*TargetVectorJoin_Join)(nil),
		(*TargetVectorJoin_ManualWeights_)(nil),
	}
