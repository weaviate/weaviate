...
type MetadataRequest struct {
	...
	// query_vector enables returning the vectorized form of the query alongside the
	// results. The vector is returned once at the top level of SearchReply, not per
	// row. For named-vector classes one entry is returned per target vector.
	// Omitted for pure BM25 / hybrid alpha=0 queries (no vector is produced).
	QueryVector   bool `protobuf:"varint,12,opt,name=query_vector,json=queryVector,proto3" json:"query_vector,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetadataRequest) GetQueryVector() bool {
	if x != nil {
...
type SearchReply struct {
	...
	// query_vector contains the vectorized form of the user's query. One entry per
	// target vector (a single-element list for non-named-vector classes; empty when
	// no vector was produced, e.g. BM25-only). Reuses the existing Vectors message
	// for single-fp32 and multi-fp32 (ColBERT-style) shapes.
	QueryVector   []*Vectors `protobuf:"bytes,7,rep,name=query_vector,json=queryVector,proto3" json:"query_vector,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SearchReply) GetQueryVector() []*Vectors {
	if x != nil {
		return x.QueryVector
	}
	return nil
...
const file_v1_search_get_proto_rawDesc = "" +
	...
	"\x04path\x18\x02 \x03(\tR\x04path\"\x9a\x03\n" +
	...
	"\avectors\x18\n" +
	" \x03(\tR\avectors\x12#\n" +
	"\rquery_profile\x18\v \x01(\bR\fqueryProfile\x12!\n" +
	"\fquery_vector\x18\f \x01(\bR\vqueryVector\"\x9f\x02\n" +
	...
	"\rquery_profile\x18\x06 \x01(\v2\x19.weaviate.v1.QueryProfileH\x02R\fqueryProfile\x88\x01\x01\x127\n" +
	"\fquery_vector\x18\a \x03(\v2\x14.weaviate.v1.VectorsR\vqueryVectorB\x1c\n" +
...
var (
	file_v1_search_get_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
...
var file_v1_search_get_proto_depIdxs = []int32{
	...
	35, // 28: weaviate.v1.SearchReply.query_vector:type_name -> weaviate.v1.Vectors
	17, // 29: weaviate.v1.QueryProfile.shards:type_name -> weaviate.v1.QueryProfile.ShardProfile
	...
	36, // 32: weaviate.v1.GroupByResult.generative:type_name -> weaviate.v1.GenerativeReply
	34, // 33: weaviate.v1.GroupByResult.generative_result:type_name -> weaviate.v1.GenerativeResult
	...
	34, // 36: weaviate.v1.SearchResult.generative:type_name -> weaviate.v1.GenerativeResult
	35, // 37: weaviate.v1.MetadataResult.vectors:type_name -> weaviate.v1.Vectors
	...
	18, // 42: weaviate.v1.QueryProfile.SearchProfile.details:type_name -> weaviate.v1.QueryProfile.SearchProfile.DetailsEntry
	19, // 43: weaviate.v1.QueryProfile.ShardProfile.searches:type_name -> weaviate.v1.QueryProfile.ShardProfile.SearchesEntry
	16, // 44: weaviate.v1.QueryProfile.ShardProfile.SearchesEntry.value:type_name -> weaviate.v1.QueryProfile.SearchProfile
