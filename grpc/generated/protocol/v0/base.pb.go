...
var file_v0_base_proto_rawDesc = []byte{
	...
	0x0b, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30, 0x22, 0x4c, 0x0a, 0x15,
...
var (
	...
	file_v0_base_proto_goTypes   = []interface{}{
		(ConsistencyLevel)(0),          // 0: weaviate.v0.ConsistencyLevel
		(*NumberArrayProperties)(nil),  // 1: weaviate.v0.NumberArrayProperties
		(*IntArrayProperties)(nil),     // 2: weaviate.v0.IntArrayProperties
		(*TextArrayProperties)(nil),    // 3: weaviate.v0.TextArrayProperties
		(*BooleanArrayProperties)(nil), // 4: weaviate.v0.BooleanArrayProperties
	}
)
