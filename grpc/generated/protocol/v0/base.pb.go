...
func (ConsistencyLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_v0_base_proto_enumTypes[0].Descriptor()
}

func (ConsistencyLevel) Type() protoreflect.EnumType {
	return &file_v0_base_proto_enumTypes[0]
}
...
func (ConsistencyLevel) EnumDescriptor() ([]byte, []int) {
	return file_v0_base_proto_rawDescGZIP(), []int{0}
}
...
func (x *NumberArrayProperties) Reset() {
	*x = NumberArrayProperties{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_base_proto_msgTypes[0]
...
func (x *IntArrayProperties) Reset() {
	*x = IntArrayProperties{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_base_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IntArrayProperties) Descriptor() ([]byte, []int) {
	return file_v0_base_proto_rawDescGZIP(), []int{1}
}
...
func (x *TextArrayProperties) Reset() {
	*x = TextArrayProperties{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_base_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TextArrayProperties) Descriptor() ([]byte, []int) {
	return file_v0_base_proto_rawDescGZIP(), []int{2}
}
...
func (x *BooleanArrayProperties) Reset() {
	*x = BooleanArrayProperties{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_base_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BooleanArrayProperties) Descriptor() ([]byte, []int) {
	return file_v0_base_proto_rawDescGZIP(), []int{3}
}
...
var File_v0_base_proto protoreflect.FileDescriptor

var file_v0_base_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x76, 0x30, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x0c, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x67, 0x72, 0x70, 0x63, 0x22, 0x4c, 0x0a,
	0x15, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x41, 0x72, 0x72, 0x61, 0x79, 0x50, 0x72, 0x6f, 0x70,
	0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x01, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x1b,
	0x0a, 0x09, 0x70, 0x72, 0x6f, 0x70, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x49, 0x0a, 0x12, 0x49,
	...
	0x59, 0x5f, 0x4c, 0x45, 0x56, 0x45, 0x4c, 0x5f, 0x41, 0x4c, 0x4c, 0x10, 0x03, 0x42, 0x67, 0x0a,
	0x1c, 0x69, 0x6f, 0x2e, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x67, 0x72, 0x70,
	0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x30, 0x42, 0x11, 0x57,
...
var (
	file_v0_base_proto_rawDescOnce sync.Once
	file_v0_base_proto_rawDescData = file_v0_base_proto_rawDesc
)

func file_v0_base_proto_rawDescGZIP() []byte {
	file_v0_base_proto_rawDescOnce.Do(func() {
		file_v0_base_proto_rawDescData = protoimpl.X.CompressGZIP(file_v0_base_proto_rawDescData)
	})
	return file_v0_base_proto_rawDescData
}

var (
	file_v0_base_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_v0_base_proto_msgTypes  = make([]protoimpl.MessageInfo, 4)
	file_v0_base_proto_goTypes   = []interface{}{
		(ConsistencyLevel)(0),          // 0: weaviategrpc.ConsistencyLevel
		(*NumberArrayProperties)(nil),  // 1: weaviategrpc.NumberArrayProperties
		(*IntArrayProperties)(nil),     // 2: weaviategrpc.IntArrayProperties
		(*TextArrayProperties)(nil),    // 3: weaviategrpc.TextArrayProperties
		(*BooleanArrayProperties)(nil), // 4: weaviategrpc.BooleanArrayProperties
	}
)

var file_v0_base_proto_depIdxs = []int32{
...
func init() { file_v0_base_proto_init() }
func file_v0_base_proto_init() {
	if File_v0_base_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_v0_base_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_base_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_base_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_base_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_v0_base_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v0_base_proto_goTypes,
		DependencyIndexes: file_v0_base_proto_depIdxs,
		EnumInfos:         file_v0_base_proto_enumTypes,
		MessageInfos:      file_v0_base_proto_msgTypes,
	}.Build()
	File_v0_base_proto = out.File
	file_v0_base_proto_rawDesc = nil
	file_v0_base_proto_goTypes = nil
	file_v0_base_proto_depIdxs = nil
}
