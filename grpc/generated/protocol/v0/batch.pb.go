...
type BatchObjectsRequest struct {
	...
	ConsistencyLevel *ConsistencyLevel `protobuf:"varint,2,opt,name=consistency_level,json=consistencyLevel,proto3,enum=weaviate.v0.ConsistencyLevel,oneof" json:"consistency_level,omitempty"`
}
...
func (x *BatchObjectsReply) Reset() {
	*x = BatchObjectsReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_batch_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchObjectsReply) Descriptor() ([]byte, []int) {
	return file_v0_batch_proto_rawDescGZIP(), []int{2}
}
...
func (x *BatchObject_Properties) Reset() {
	*x = BatchObject_Properties{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_batch_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchObject_Properties) Descriptor() ([]byte, []int) {
	return file_v0_batch_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *BatchObject_SingleTargetRefProps) Reset() {
	*x = BatchObject_SingleTargetRefProps{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_batch_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchObject_SingleTargetRefProps) Descriptor() ([]byte, []int) {
	return file_v0_batch_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *BatchObject_MultiTargetRefProps) Reset() {
	*x = BatchObject_MultiTargetRefProps{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_batch_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchObject_MultiTargetRefProps) Descriptor() ([]byte, []int) {
	return file_v0_batch_proto_rawDescGZIP(), []int{1, 2}
}
...
func (x *BatchObjectsReply_BatchError) Reset() {
	*x = BatchObjectsReply_BatchError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v0_batch_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BatchObjectsReply_BatchError) Descriptor() ([]byte, []int) {
	return file_v0_batch_proto_rawDescGZIP(), []int{2, 0}
}
...
var file_v0_batch_proto_rawDesc = []byte{
	...
	0x12, 0x0b, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30, 0x1a, 0x1c, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x73,
	0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0d, 0x76, 0x30, 0x2f,
	...
	0x30, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x07, 0x6f,
	...
	0x0e, 0x32, 0x1d, 0x2e, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30, 0x2e,
	...
	0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30, 0x2e, 0x42, 0x61, 0x74, 0x63,
	...
	0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30,
	...
	0x65, 0x2e, 0x76, 0x30, 0x2e, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x41, 0x72, 0x72, 0x61, 0x79,
	...
	0x1f, 0x2e, 0x77, 0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30, 0x2e, 0x49, 0x6e,
	...
	0x30, 0x2e, 0x54, 0x65, 0x78, 0x74, 0x41, 0x72, 0x72, 0x61, 0x79, 0x50, 0x72, 0x6f, 0x70, 0x65,
	...
	0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x30, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x65,
	...
	0x2e, 0x76, 0x30, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73,
...
var (
	file_v0_batch_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
	file_v0_batch_proto_goTypes  = []interface{}{
		(*BatchObjectsRequest)(nil),              // 0: weaviate.v0.BatchObjectsRequest
		(*BatchObject)(nil),                      // 1: weaviate.v0.BatchObject
		(*BatchObjectsReply)(nil),                // 2: weaviate.v0.BatchObjectsReply
		(*BatchObject_Properties)(nil),           // 3: weaviate.v0.BatchObject.Properties
		(*BatchObject_SingleTargetRefProps)(nil), // 4: weaviate.v0.BatchObject.SingleTargetRefProps
		(*BatchObject_MultiTargetRefProps)(nil),  // 5: weaviate.v0.BatchObject.MultiTargetRefProps
		(*BatchObjectsReply_BatchError)(nil),     // 6: weaviate.v0.BatchObjectsReply.BatchError
		(ConsistencyLevel)(0),                    // 7: weaviate.v0.ConsistencyLevel
		(*structpb.Struct)(nil),                  // 8: google.protobuf.Struct
		(*NumberArrayProperties)(nil),            // 9: weaviate.v0.NumberArrayProperties
		(*IntArrayProperties)(nil),               // 10: weaviate.v0.IntArrayProperties
		(*TextArrayProperties)(nil),              // 11: weaviate.v0.TextArrayProperties
		(*BooleanArrayProperties)(nil),           // 12: weaviate.v0.BooleanArrayProperties
	}
)

var file_v0_batch_proto_depIdxs = []int32{
	1,  // 0: weaviate.v0.BatchObjectsRequest.objects:type_name -> weaviate.v0.BatchObject
	7,  // 1: weaviate.v0.BatchObjectsRequest.consistency_level:type_name -> weaviate.v0.ConsistencyLevel
	3,  // 2: weaviate.v0.BatchObject.properties:type_name -> weaviate.v0.BatchObject.Properties
	6,  // 3: weaviate.v0.BatchObjectsReply.errors:type_name -> weaviate.v0.BatchObjectsReply.BatchError
	8,  // 4: weaviate.v0.BatchObject.Properties.non_ref_properties:type_name -> google.protobuf.Struct
	4,  // 5: weaviate.v0.BatchObject.Properties.single_target_ref_props:type_name -> weaviate.v0.BatchObject.SingleTargetRefProps
	5,  // 6: weaviate.v0.BatchObject.Properties.multi_target_ref_props:type_name -> weaviate.v0.BatchObject.MultiTargetRefProps
	9,  // 7: weaviate.v0.BatchObject.Properties.number_array_properties:type_name -> weaviate.v0.NumberArrayProperties
	10, // 8: weaviate.v0.BatchObject.Properties.int_array_properties:type_name -> weaviate.v0.IntArrayProperties
	11, // 9: weaviate.v0.BatchObject.Properties.text_array_properties:type_name -> weaviate.v0.TextArrayProperties
	12, // 10: weaviate.v0.BatchObject.Properties.boolean_array_properties:type_name -> weaviate.v0.BooleanArrayProperties
...
func file_v0_batch_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v0_batch_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_batch_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_batch_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_batch_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v0_batch_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_v0_batch_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
