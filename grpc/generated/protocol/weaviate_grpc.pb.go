...
type WeaviateClient interface {
	...
	Search1(ctx context.Context, in *SearchRequestV1, opts ...grpc.CallOption) (*SearchReplyV1, error)
...
func (c *weaviateClient) Search1(ctx context.Context, in *SearchRequestV1, opts ...grpc.CallOption) (*SearchReplyV1, error) {
	out := new(SearchReplyV1)
	err := c.cc.Invoke(ctx, "/weaviate.Weaviate/Search1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeaviateServer interface {
	...
	Search1(context.Context, *SearchRequestV1) (*SearchReplyV1, error)
...
func (UnimplementedWeaviateServer) Search1(context.Context, *SearchRequestV1) (*SearchReplyV1, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Search1 not implemented")
}
...
func _Weaviate_Search1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRequestV1)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeaviateServer).Search1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/weaviate.Weaviate/Search1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeaviateServer).Search1(ctx, req.(*SearchRequestV1))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Weaviate_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Search1",
			Handler:    _Weaviate_Search1_Handler,
		},
		{
