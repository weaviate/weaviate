...
type BatchObject_Properties struct {
	...
	ObjectProperties       []*BatchObject_ObjectProperties      `protobuf:"bytes,8,rep,name=object_properties,json=objectProperties,proto3" json:"object_properties,omitempty"`
	ObjectArrayProperties  []*BatchObject_ObjectArrayProperties `protobuf:"bytes,9,rep,name=object_array_properties,json=objectArrayProperties,proto3" json:"object_array_properties,omitempty"`
}
...
func (x *BatchObject_Properties) GetObjectProperties() []*BatchObject_ObjectProperties {
	if x != nil {
...
func (x *BatchObject_Properties) GetObjectArrayProperties() []*BatchObject_ObjectArrayProperties {
	if x != nil {
...
type BatchObject_ObjectArrayProperties struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Values   []*BatchObject_Properties `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty"`
	PropName string                    `protobuf:"bytes,2,opt,name=prop_name,json=propName,proto3" json:"prop_name,omitempty"`
}

func (x *BatchObject_ObjectArrayProperties) Reset() {
	*x = BatchObject_ObjectArrayProperties{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchObject_ObjectArrayProperties) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchObject_ObjectArrayProperties) ProtoMessage() {}

func (x *BatchObject_ObjectArrayProperties) ProtoReflect() protoreflect.Message {
	mi := &file_batch_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchObject_ObjectArrayProperties.ProtoReflect.Descriptor instead.
func (*BatchObject_ObjectArrayProperties) Descriptor() ([]byte, []int) {
	return file_batch_proto_rawDescGZIP(), []int{1, 3}
}

func (x *BatchObject_ObjectArrayProperties) GetValues() []*BatchObject_Properties {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *BatchObject_ObjectArrayProperties) GetPropName() string {
	if x != nil {
		return x.PropName
	}
	return ""
...
type BatchObject_ObjectProperties struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Value    *BatchObject_Properties `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
	PropName string                  `protobuf:"bytes,2,opt,name=prop_name,json=propName,proto3" json:"prop_name,omitempty"`
}

func (x *BatchObject_ObjectProperties) Reset() {
	*x = BatchObject_ObjectProperties{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchObject_ObjectProperties) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchObject_ObjectProperties) ProtoMessage() {}

func (x *BatchObject_ObjectProperties) ProtoReflect() protoreflect.Message {
	mi := &file_batch_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchObject_ObjectProperties.ProtoReflect.Descriptor instead.
func (*BatchObject_ObjectProperties) Descriptor() ([]byte, []int) {
	return file_batch_proto_rawDescGZIP(), []int{1, 4}
}

func (x *BatchObject_ObjectProperties) GetValue() *BatchObject_Properties {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *BatchObject_ObjectProperties) GetPropName() string {
	if x != nil {
		return x.PropName
	}
	return ""
...
var file_batch_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x63, 0x79, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0xa5, 0x0b, 0x0a, 0x0b, 0x42,
	...
	0x6e, 0x61, 0x6e, 0x74, 0x1a, 0xc8, 0x06, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74,
	...
	,
	...
	0x52, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x75, 0x0a, 0x13, 0x4d, 0x75,
	0x6c, 0x74, 0x69, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x65, 0x66, 0x50, 0x72, 0x6f, 0x70,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2b, 0x0a, 0x11, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x63,
	...
	0x6e, 0x1a, 0x72, 0x0a, 0x15, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x72, 0x72, 0x61, 0x79,
	0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x3c, 0x0a, 0x06, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x77, 0x65, 0x61,
	0x76, 0x69, 0x61, 0x74, 0x65, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x42, 0x65, 0x0a, 0x19, 0x69, 0x6f,
...
var (
	file_batch_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
	file_batch_proto_goTypes  = []interface{}{
		...
		(*BatchObject_ObjectArrayProperties)(nil), // 6: weaviategrpc.BatchObject.ObjectArrayProperties
		(*BatchObject_ObjectProperties)(nil),      // 7: weaviategrpc.BatchObject.ObjectProperties
		(*BatchObjectsReply_BatchError)(nil),      // 8: weaviategrpc.BatchObjectsReply.BatchError
		(ConsistencyLevel)(0),                     // 9: weaviategrpc.ConsistencyLevel
		(*structpb.Struct)(nil),                   // 10: google.protobuf.Struct
		(*NumberArrayProperties)(nil),             // 11: weaviategrpc.NumberArrayProperties
		(*IntArrayProperties)(nil),                // 12: weaviategrpc.IntArrayProperties
		(*TextArrayProperties)(nil),               // 13: weaviategrpc.TextArrayProperties
		(*BooleanArrayProperties)(nil),            // 14: weaviategrpc.BooleanArrayProperties
	}
)

var file_batch_proto_depIdxs = []int32{
	1,  // 0: weaviategrpc.BatchObjectsRequest.objects:type_name -> weaviategrpc.BatchObject
	9,  // 1: weaviategrpc.BatchObjectsRequest.consistency_level:type_name -> weaviategrpc.ConsistencyLevel
	3,  // 2: weaviategrpc.BatchObject.properties:type_name -> weaviategrpc.BatchObject.Properties
	8,  // 3: weaviategrpc.BatchObjectsReply.errors:type_name -> weaviategrpc.BatchObjectsReply.BatchError
	10, // 4: weaviategrpc.BatchObject.Properties.non_ref_properties:type_name -> google.protobuf.Struct
	...
	11, // 7: weaviategrpc.BatchObject.Properties.number_array_properties:type_name -> weaviategrpc.NumberArrayProperties
	12, // 8: weaviategrpc.BatchObject.Properties.int_array_properties:type_name -> weaviategrpc.IntArrayProperties
	13, // 9: weaviategrpc.BatchObject.Properties.text_array_properties:type_name -> weaviategrpc.TextArrayProperties
	14, // 10: weaviategrpc.BatchObject.Properties.boolean_array_properties:type_name -> weaviategrpc.BooleanArrayProperties
	7,  // 11: weaviategrpc.BatchObject.Properties.object_properties:type_name -> weaviategrpc.BatchObject.ObjectProperties
	6,  // 12: weaviategrpc.BatchObject.Properties.object_array_properties:type_name -> weaviategrpc.BatchObject.ObjectArrayProperties
	3,  // 13: weaviategrpc.BatchObject.ObjectArrayProperties.values:type_name -> weaviategrpc.BatchObject.Properties
	3,  // 14: weaviategrpc.BatchObject.ObjectProperties.value:type_name -> weaviategrpc.BatchObject.Properties
...
func file_batch_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_batch_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchObject_ObjectArrayProperties); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_batch_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchObject_ObjectProperties); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
