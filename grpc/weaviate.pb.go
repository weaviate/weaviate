...
var file_weaviate_proto_depIdxs = []int32{
	...
	38, // 16: weaviategrpc.DateArray.values:type_name -> google.protobuf.Timestamp
	...
	37, // 25: weaviategrpc.NearTextSearchParams.move_to:type_name -> weaviategrpc.NearTextSearchParams.Move
	37, // 26: weaviategrpc.NearTextSearchParams.move_away:type_name -> weaviategrpc.NearTextSearchParams.Move
	...
	31, // 30: weaviategrpc.SearchResult.properties:type_name -> weaviategrpc.ResultProperties
	26, // 31: weaviategrpc.SearchResult.additional_properties:type_name -> weaviategrpc.ResultAdditionalProps
	39, // 32: weaviategrpc.ResultProperties.non_ref_properties:type_name -> google.protobuf.Struct
	32, // 33: weaviategrpc.ResultProperties.ref_props:type_name -> weaviategrpc.ReturnRefProperties
	26, // 34: weaviategrpc.ResultProperties.metadata:type_name -> weaviategrpc.ResultAdditionalProps
	27, // 35: weaviategrpc.ResultProperties.number_array_properties:type_name -> weaviategrpc.NumberArrayProperties
	28, // 36: weaviategrpc.ResultProperties.int_array_properties:type_name -> weaviategrpc.IntArrayProperties
	29, // 37: weaviategrpc.ResultProperties.text_array_properties:type_name -> weaviategrpc.TextArrayProperties
	30, // 38: weaviategrpc.ResultProperties.boolean_array_properties:type_name -> weaviategrpc.BooleanArrayProperties
	31, // 39: weaviategrpc.ReturnRefProperties.properties:type_name -> weaviategrpc.ResultProperties
	39, // 40: weaviategrpc.BatchObject.Properties.non_ref_properties:type_name -> google.protobuf.Struct
	34, // 41: weaviategrpc.BatchObject.Properties.ref_props_single:type_name -> weaviategrpc.BatchObject.RefPropertiesSingleTarget
	35, // 42: weaviategrpc.BatchObject.Properties.ref_props_multi:type_name -> weaviategrpc.BatchObject.RefPropertiesMultiTarget
	27, // 43: weaviategrpc.BatchObject.Properties.number_array_properties:type_name -> weaviategrpc.NumberArrayProperties
	28, // 44: weaviategrpc.BatchObject.Properties.int_array_properties:type_name -> weaviategrpc.IntArrayProperties
	29, // 45: weaviategrpc.BatchObject.Properties.text_array_properties:type_name -> weaviategrpc.TextArrayProperties
	30, // 46: weaviategrpc.BatchObject.Properties.boolean_array_properties:type_name -> weaviategrpc.BooleanArrayProperties
