...
var file_weaviate_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x4e, 0x0a, 0x08, 0x57, 0x65, 0x61, 0x76, 0x69, 0x61,
	0x74, 0x65, 0x12, 0x42, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x1b, 0x2e, 0x77,
	0x65, 0x61, 0x76, 0x69, 0x61, 0x74, 0x65, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x77, 0x65, 0x61, 0x76,
...
var (
	...
	file_weaviate_proto_msgTypes  = make([]protoimpl.MessageInfo, 14)
	file_weaviate_proto_goTypes   = []interface{}{
		...
		(*Filters)(nil),                    // 3: weaviategrpc.Filters
		(*AdditionalProperties)(nil),       // 4: weaviategrpc.AdditionalProperties
		(*Properties)(nil),                 // 5: weaviategrpc.Properties
		(*HybridSearchParams)(nil),         // 6: weaviategrpc.HybridSearchParams
		(*BM25SearchParams)(nil),           // 7: weaviategrpc.BM25SearchParams
		(*RefProperties)(nil),              // 8: weaviategrpc.RefProperties
		(*NearVectorParams)(nil),           // 9: weaviategrpc.NearVectorParams
		(*NearObjectParams)(nil),           // 10: weaviategrpc.NearObjectParams
		(*SearchReply)(nil),                // 11: weaviategrpc.SearchReply
		(*SearchResult)(nil),               // 12: weaviategrpc.SearchResult
		(*ResultAdditionalProps)(nil),      // 13: weaviategrpc.ResultAdditionalProps
		(*ResultProperties)(nil),           // 14: weaviategrpc.ResultProperties
		(*ReturnRefProperties)(nil),        // 15: weaviategrpc.ReturnRefProperties
...
var file_weaviate_proto_depIdxs = []int32{
	4,  // 0: weaviategrpc.SearchRequest.additional_properties:type_name -> weaviategrpc.AdditionalProperties
	9,  // 1: weaviategrpc.SearchRequest.near_vector:type_name -> weaviategrpc.NearVectorParams
	10, // 2: weaviategrpc.SearchRequest.near_object:type_name -> weaviategrpc.NearObjectParams
	5,  // 3: weaviategrpc.SearchRequest.properties:type_name -> weaviategrpc.Properties
	6,  // 4: weaviategrpc.SearchRequest.hybrid_search:type_name -> weaviategrpc.HybridSearchParams
	7,  // 5: weaviategrpc.SearchRequest.bm25_search:type_name -> weaviategrpc.BM25SearchParams
	3,  // 6: weaviategrpc.SearchRequest.filters:type_name -> weaviategrpc.Filters
	0,  // 7: weaviategrpc.Filters.operator:type_name -> weaviategrpc.Filters.OperatorType
	3,  // 8: weaviategrpc.Filters.filters:type_name -> weaviategrpc.Filters
	16, // 9: weaviategrpc.Filters.value_date:type_name -> google.protobuf.Timestamp
	8,  // 10: weaviategrpc.Properties.ref_properties:type_name -> weaviategrpc.RefProperties
	1,  // 11: weaviategrpc.HybridSearchParams.fusion_type:type_name -> weaviategrpc.HybridSearchParams.FusionType
	5,  // 12: weaviategrpc.RefProperties.linked_properties:type_name -> weaviategrpc.Properties
	4,  // 13: weaviategrpc.RefProperties.metadata:type_name -> weaviategrpc.AdditionalProperties
	12, // 14: weaviategrpc.SearchReply.results:type_name -> weaviategrpc.SearchResult
	14, // 15: weaviategrpc.SearchResult.properties:type_name -> weaviategrpc.ResultProperties
	13, // 16: weaviategrpc.SearchResult.additional_properties:type_name -> weaviategrpc.ResultAdditionalProps
	17, // 17: weaviategrpc.ResultProperties.non_ref_properties:type_name -> google.protobuf.Struct
	15, // 18: weaviategrpc.ResultProperties.ref_props:type_name -> weaviategrpc.ReturnRefProperties
	13, // 19: weaviategrpc.ResultProperties.metadata:type_name -> weaviategrpc.ResultAdditionalProps
	14, // 20: weaviategrpc.ReturnRefProperties.properties:type_name -> weaviategrpc.ResultProperties
	2,  // 21: weaviategrpc.Weaviate.Search:input_type -> weaviategrpc.SearchRequest
	11, // 22: weaviategrpc.Weaviate.Search:output_type -> weaviategrpc.SearchReply
...
func file_weaviate_proto_init() {
	...
	file_weaviate_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
