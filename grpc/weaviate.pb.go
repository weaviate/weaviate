...
var file_weaviate_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xaf, 0x06,
	...
	0x61, 0x67, 0x65, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x73, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x6e, 0x65, 0x61, 0x72, 0x5f, 0x74, 0x65, 0x78, 0x74,
	0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x6e, 0x65, 0x61, 0x72, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22,
...
var (
	...
	file_weaviate_proto_goTypes   = []interface{}{
		...
		(*BM25SearchParams)(nil),                      // 17: weaviategrpc.BM25SearchParams
		(*RefProperties)(nil),                         // 18: weaviategrpc.RefProperties
		(*NearVectorParams)(nil),                      // 19: weaviategrpc.NearVectorParams
		(*NearObjectParams)(nil),                      // 20: weaviategrpc.NearObjectParams
		(*SearchReply)(nil),                           // 21: weaviategrpc.SearchReply
		(*SearchResult)(nil),                          // 22: weaviategrpc.SearchResult
		(*ResultAdditionalProps)(nil),                 // 23: weaviategrpc.ResultAdditionalProps
		(*NumberArrayProperties)(nil),                 // 24: weaviategrpc.NumberArrayProperties
		(*IntArrayProperties)(nil),                    // 25: weaviategrpc.IntArrayProperties
		(*TextArrayProperties)(nil),                   // 26: weaviategrpc.TextArrayProperties
		(*BooleanArrayProperties)(nil),                // 27: weaviategrpc.BooleanArrayProperties
		(*DateArrayProperties)(nil),                   // 28: weaviategrpc.DateArrayProperties
		(*UuidArrayProperties)(nil),                   // 29: weaviategrpc.UuidArrayProperties
		(*ResultProperties)(nil),                      // 30: weaviategrpc.ResultProperties
		(*ReturnRefProperties)(nil),                   // 31: weaviategrpc.ReturnRefProperties
		(*BatchObject_Properties)(nil),                // 32: weaviategrpc.BatchObject.Properties
		(*BatchObject_RefPropertiesSingleTarget)(nil), // 33: weaviategrpc.BatchObject.RefPropertiesSingleTarget
		(*BatchObject_RefPropertiesMultiTarget)(nil),  // 34: weaviategrpc.BatchObject.RefPropertiesMultiTarget
		(*BatchObjectsReply_BatchResults)(nil),        // 35: weaviategrpc.BatchObjectsReply.BatchResults
		(*NearTextSearchParams_Move)(nil),             // 36: weaviategrpc.NearTextSearchParams.Move
...
var file_weaviate_proto_depIdxs = []int32{
	...
	32, // 1: weaviategrpc.BatchObject.properties:type_name -> weaviategrpc.BatchObject.Properties
	35, // 2: weaviategrpc.BatchObjectsReply.results:type_name -> weaviategrpc.BatchObjectsReply.BatchResults
	12, // 3: weaviategrpc.SearchRequest.additional_properties:type_name -> weaviategrpc.AdditionalProperties
	19, // 4: weaviategrpc.SearchRequest.near_vector:type_name -> weaviategrpc.NearVectorParams
	20, // 5: weaviategrpc.SearchRequest.near_object:type_name -> weaviategrpc.NearObjectParams
	...
	17, // 8: weaviategrpc.SearchRequest.bm25_search:type_name -> weaviategrpc.BM25SearchParams
	...
	37, // 12: weaviategrpc.DateArray.vals:type_name -> google.protobuf.Timestamp
	0,  // 13: weaviategrpc.Filters.operator:type_name -> weaviategrpc.Filters.Operator
	11, // 14: weaviategrpc.Filters.filters:type_name -> weaviategrpc.Filters
	37, // 15: weaviategrpc.Filters.value_date:type_name -> google.protobuf.Timestamp
	6,  // 16: weaviategrpc.Filters.value_text_array:type_name -> weaviategrpc.TextArray
	7,  // 17: weaviategrpc.Filters.value_int_array:type_name -> weaviategrpc.IntArray
	9,  // 18: weaviategrpc.Filters.value_boolean_array:type_name -> weaviategrpc.BooleanArray
	8,  // 19: weaviategrpc.Filters.value_number_array:type_name -> weaviategrpc.NumberArray
	10, // 20: weaviategrpc.Filters.value_date_array:type_name -> weaviategrpc.DateArray
	18, // 21: weaviategrpc.Properties.ref_properties:type_name -> weaviategrpc.RefProperties
	1,  // 22: weaviategrpc.HybridSearchParams.fusion_type:type_name -> weaviategrpc.HybridSearchParams.FusionType
	36, // 23: weaviategrpc.NearTextSearchParams.move_to:type_name -> weaviategrpc.NearTextSearchParams.Move
	36, // 24: weaviategrpc.NearTextSearchParams.move_away:type_name -> weaviategrpc.NearTextSearchParams.Move
	13, // 25: weaviategrpc.RefProperties.linked_properties:type_name -> weaviategrpc.Properties
	12, // 26: weaviategrpc.RefProperties.metadata:type_name -> weaviategrpc.AdditionalProperties
	22, // 27: weaviategrpc.SearchReply.results:type_name -> weaviategrpc.SearchResult
	30, // 28: weaviategrpc.SearchResult.properties:type_name -> weaviategrpc.ResultProperties
	23, // 29: weaviategrpc.SearchResult.additional_properties:type_name -> weaviategrpc.ResultAdditionalProps
	37, // 30: weaviategrpc.DateArrayProperties.vals:type_name -> google.protobuf.Timestamp
	38, // 31: weaviategrpc.ResultProperties.non_ref_properties:type_name -> google.protobuf.Struct
	31, // 32: weaviategrpc.ResultProperties.ref_props:type_name -> weaviategrpc.ReturnRefProperties
	23, // 33: weaviategrpc.ResultProperties.metadata:type_name -> weaviategrpc.ResultAdditionalProps
	24, // 34: weaviategrpc.ResultProperties.number_array_properties:type_name -> weaviategrpc.NumberArrayProperties
	25, // 35: weaviategrpc.ResultProperties.int_array_properties:type_name -> weaviategrpc.IntArrayProperties
	26, // 36: weaviategrpc.ResultProperties.text_array_properties:type_name -> weaviategrpc.TextArrayProperties
	27, // 37: weaviategrpc.ResultProperties.boolean_array_properties:type_name -> weaviategrpc.BooleanArrayProperties
	29, // 38: weaviategrpc.ResultProperties.uuid_array_properties:type_name -> weaviategrpc.UuidArrayProperties
	30, // 39: weaviategrpc.ReturnRefProperties.properties:type_name -> weaviategrpc.ResultProperties
	38, // 40: weaviategrpc.BatchObject.Properties.non_ref_properties:type_name -> google.protobuf.Struct
	33, // 41: weaviategrpc.BatchObject.Properties.ref_props_single:type_name -> weaviategrpc.BatchObject.RefPropertiesSingleTarget
	34, // 42: weaviategrpc.BatchObject.Properties.ref_props_multi:type_name -> weaviategrpc.BatchObject.RefPropertiesMultiTarget
	5,  // 43: weaviategrpc.Weaviate.Search:input_type -> weaviategrpc.SearchRequest
	2,  // 44: weaviategrpc.Weaviate.BatchObjects:input_type -> weaviategrpc.BatchObjectsRequest
	21, // 45: weaviategrpc.Weaviate.Search:output_type -> weaviategrpc.SearchReply
	4,  // 46: weaviategrpc.Weaviate.BatchObjects:output_type -> weaviategrpc.BatchObjectsReply
