...
const GroupByMinDesc string = "Get the minimum occuring value of a property in a group"
const GroupByMaxDesc string = "Get the maximum occuring value of a property in a group"
const GroupByMeanDesc string = "Get the mean value of a property in a group"
